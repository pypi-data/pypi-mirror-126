...
class OWPivot(OWWidget):
    ...
    class Warning(OWWidget.Warning):
        ...
        no_col_feature = Msg(__("msg.no_col_feature"))
        cannot_aggregate = Msg(__("msg.cannot_aggregate"))
        renamed_vars = Msg(__("msg.renamed_vars"))
        too_many_values = Msg(__("msg.too_many_values"))
        no_variables = Msg(__("msg.no_variables"))
