...
class Selected:
	"""Selected commands group definition. 1 total commands, 0 Sub-groups, 1 group commands"""
	...
	def get(self, filter_py: str = None) -> List[str]:
		...
		Snippet: value: List[str] = driver.catalog.selftest.selected.get(filter_py = '1') \n
