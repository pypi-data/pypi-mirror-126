...
class Message:
	"""Message commands group definition. 1 total commands, 0 Sub-groups, 1 group commands"""
	...
	def get(self, test_name: str) -> str:
		...
		Snippet: value: str = driver.configure.selftest.info.message.get(test_name = '1') \n
