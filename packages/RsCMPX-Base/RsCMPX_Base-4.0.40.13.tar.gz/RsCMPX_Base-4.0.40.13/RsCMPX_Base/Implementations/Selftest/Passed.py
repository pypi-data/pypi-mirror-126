...
class Passed:
	"""Passed commands group definition. 2 total commands, 0 Sub-groups, 2 group commands"""
	...
	def fetch(self, filter_py: str = None) -> List[str]:
		...
		Snippet: value: List[str] = driver.selftest.passed.fetch(filter_py = '1') \n
	...
	def read(self, filter_py: str = None) -> List[str]:
		...
		Snippet: value: List[str] = driver.selftest.passed.read(filter_py = '1') \n
		No command help available \n
		Suppressed linked return values: reliability \n
			:param filter_py: No help available
			:return: value: No help available"""
