    ...
    def get(self, files_found, seeker):
        ...
        for file_found in files_found:
            ...
            outputpath = os.path.join(
                report_folder, str(x) + '_' + journalName + '.txt'
            )  # name of file in txt
            ...
            with open(outputpath, 'w') as g:
                with open(file_found, errors="ignore") as f:  # Python 3.x
                    ...
                    for match in ascii_chars_re.finditer(
                        data
        ...
        report.start_artifact_report(
            report_folder, 'Strings - SQLite Journal & WAL', description
        )
        report.add_script()
