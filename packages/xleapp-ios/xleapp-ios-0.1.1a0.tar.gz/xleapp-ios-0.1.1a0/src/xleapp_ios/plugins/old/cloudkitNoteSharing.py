                ...
                if result_number > 0:
                    ...
                    for row in all_rows:
                        ...
                        filename = os.path.join(
                            report_folder,
                            'zserverrecorddata_' + str(row[0]) + '.bplist',
                        )
                        ...
                        for item in deserialized_plist:
                            if 'RecordCtime' in item:
                                ...
                                last_modified_id = item['LastModifiedUserRecordID'][
                                    'RecordName'
                                ]
                    ...
                    description = (
                        'CloudKit Note Sharing - Notes information '
                    ...
                    report.start_artifact_report(
                        report_folder, 'Note Sharing', description
                    )
                    report.add_script()
                    note_headers = (
                        'Record ID',
                    ...
                    report.write_artifact_data_table(
                        note_headers, note_data, file_found
                    )
