    ...
    def get(self, files_found, seeker):
        ...
        for file_found in files_found:
            ...
            if file_found.endswith('iTunesMetadata.plist'):
                ...
                purchasedate = plist.get('com.apple.iTunesStore.downloadInfo', {}).get(
                    'purchaseDate', ''
                )
                ...
                downloadedby = (
                    plist.get('com.apple.iTunesStore.downloadInfo', {})
                    .get('accountInfo', {})
                    .get('AppleID', '')
                )
        ...
        if len(data_list) > 0:
            ...
            report.start_artifact_report(
                report_folder, 'Apps - Itunes Metadata', description
            )
            report.add_script()
            data_headers = (
                'Installed Date',
