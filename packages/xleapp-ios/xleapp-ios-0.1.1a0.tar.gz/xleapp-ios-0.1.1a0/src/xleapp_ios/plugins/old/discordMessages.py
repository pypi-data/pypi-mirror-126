                                    ...
                                    if 'embeds' in jsonfinal[x]:
                                        if len(jsonfinal[x]['embeds']) > 0:
                                            ...
                                            while y < lenembeds:
                                                ...
                                                if (
                                                    'description'
                                                    in jsonfinal[x]['embeds'][y]
                                                ):
                                                    embededdescript = jsonfinal[x][
                                                        'embeds'
                                                    ][y]['description']
                                                else:
                                                    embededdescript = ''
                                                ...
                                                if 'footer' in jsonfinal[x]['embeds']:
                                                    footertext = jsonfinal[x]['embeds'][
                                                        y
                                                    ]['footer']['text']
                                                    footericonurl = jsonfinal[x][
                                                        'embeds'
                                                    ][y]['footer']['icon_url']
                                                else:
                                                    footertext = ''
