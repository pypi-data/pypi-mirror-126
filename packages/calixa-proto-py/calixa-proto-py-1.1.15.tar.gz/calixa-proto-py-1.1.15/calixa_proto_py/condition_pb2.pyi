...
ScoringIntentValue = typing___NewType('ScoringIntentValue', builtin___int)
type___ScoringIntentValue = ScoringIntentValue
ScoringIntent: _ScoringIntent
class _ScoringIntent(google___protobuf___internal___enum_type_wrapper____EnumTypeWrapper[ScoringIntentValue]):
    DESCRIPTOR: google___protobuf___descriptor___EnumDescriptor = ...
    SCORING_INTENT_NONE = typing___cast(ScoringIntentValue, 0)
    SCORING_INTENT_LOW = typing___cast(ScoringIntentValue, 1)
    SCORING_INTENT_MEDIUM = typing___cast(ScoringIntentValue, 2)
    SCORING_INTENT_HIGH = typing___cast(ScoringIntentValue, 3)
SCORING_INTENT_NONE = typing___cast(ScoringIntentValue, 0)
SCORING_INTENT_LOW = typing___cast(ScoringIntentValue, 1)
SCORING_INTENT_MEDIUM = typing___cast(ScoringIntentValue, 2)
SCORING_INTENT_HIGH = typing___cast(ScoringIntentValue, 3)
type___ScoringIntent = ScoringIntent
...
class ScoringLevel(google___protobuf___message___Message):
    ...
    id: typing___Text = ...
    name: typing___Text = ...
    intent: type___ScoringIntentValue = ...
    ...
    def __init__(self,
        *,
        ...
        intent : typing___Optional[type___ScoringIntentValue] = None,
    ...
    def ClearField(self, field_name: typing_extensions___Literal[u"filters",b"filters",u"id",b"id",u"intent",b"intent",u"name",b"name"]) -> None: ...
...
class ScoringFunctionCondition(google___protobuf___message___Message):
    ...
    operator: type___FieldOperatorTypeValue = ...
    values: google___protobuf___internal___containers___RepeatedScalarFieldContainer[type___ScoringIntentValue] = ...

    def __init__(self,
        *,
        scoring_function_id : typing___Optional[typing___Text] = None,
        operator : typing___Optional[type___FieldOperatorTypeValue] = None,
        values : typing___Optional[typing___Iterable[type___ScoringIntentValue]] = None,
        ) -> None: ...
...
class ConditionOrGroup(google___protobuf___message___Message):
    ...
    def HasField(self, field_name: typing_extensions___Literal[u"condition",b"condition",u"conditionOrGroup",b"conditionOrGroup",u"group",b"group",u"metric_change_condition",b"metric_change_condition",u"metric_threshold_condition",b"metric_threshold_condition",u"scoring_function_condition",b"scoring_function_condition"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"condition",b"condition",u"conditionOrGroup",b"conditionOrGroup",u"group",b"group",u"metric_change_condition",b"metric_change_condition",u"metric_threshold_condition",b"metric_threshold_condition",u"scoring_function_condition",b"scoring_function_condition"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions___Literal[u"conditionOrGroup",b"conditionOrGroup"]) -> typing_extensions___Literal["condition","group","metric_threshold_condition","metric_change_condition","scoring_function_condition"]: ...
