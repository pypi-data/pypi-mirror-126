...
<!-- InkSlab allows efficient and flexible parameter-sweeping by storing the unmodified parts of the structure and recalculating only the modified parts. -->
...
(InkSlab, **In**cident $\bm{k}$ on **slab**s.)

## Citing
If you find InkSlab useful for your research, we would apprecite you citing our [paper](https://doi.org/10.1103/PhysRevLett.120.193903). For your convenience, you can use the following BibTex entry:
