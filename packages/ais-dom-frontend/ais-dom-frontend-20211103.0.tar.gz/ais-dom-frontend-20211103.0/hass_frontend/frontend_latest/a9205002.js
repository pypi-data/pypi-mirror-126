        ...
        <div class="card-content">
          ...
          ${null===(e=this._configEntries)||void 0===e?void 0:e.map((e=>{var r;return t.dy`<div class="row" .entry=${e}>
              <img
                ...
                src=${(0,f.X)({domain:"co2signal",type:"icon",darkOptimized:null===(r=this.hass.selectedTheme)||void 0===r?void 0:r.dark})}
              />
          ...
          ${0===(null===(r=this._configEntries)||void 0===r?void 0:r.length)?t.dy`
                <div class="row border-bottom">
                  <img
                    referrerpolicy="no-referrer"
                    src=${(0,f.X)({domain:"co2signal",type:"icon",darkOptimized:null===(i=this.hass.selectedTheme)||void 0===i?void 0:i.dark})}
                  />
