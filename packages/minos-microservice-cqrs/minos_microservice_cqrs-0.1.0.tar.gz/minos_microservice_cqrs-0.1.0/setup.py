...
['dependency-injector>=4.34.0,<5.0.0',
 'minos-microservice-aggregate>=0.1.0,<0.2.0',
 'minos-microservice-common>=0.2.0,<0.3.0',
 'minos-microservice-networks>=0.1.0,<0.2.0',
 'minos-microservice-saga>=0.2.0,<0.3.0']
