...
from gateways.common.cs18_api_classes import AccessLink, TerraformModuleDescriptor, TerraformModuleOutput, \
...
class TerraformModuleDescriptorResponse(TerraformModuleDescriptor):
    def __init__(self, module_name: str = None, module_repo_name: str = None, module_root_path: str = None,
                 ...
                 outputs: List[TerraformModuleInput] = None, compute_services: List[TerraformModuleComputeService] = None,
