...
setuptools.setup(
    ...
    description="GUI routine for Laue neural network training and prediction- v3 depends on ORIX library to get equivalent HKL",
    ...
    install_requires=['matplotlib', 'Keras', 'fast_histogram', 'numpy', 'h5py', 'tensorflow','LaueTools', 'PyQt5', 'scikit_learn', 'fabio', 'networkx', 'orix', 'diffpy.structure'],
    entry_points={
