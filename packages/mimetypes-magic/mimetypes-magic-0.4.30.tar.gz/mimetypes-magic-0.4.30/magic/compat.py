...
FileMagic = namedtuple('FileMagic', ('mime_type', 'encoding', 'name', 'extension'))
...
for (ext, type) in _new_types.items():
    add_type(type, ext, True)
...
def _create_filemagic(mime_detected, type_detected):
    ...
    return FileMagic(name=type_detected, mime_type=mime_type,
                     encoding=mime_encoding.replace('charset=', ''), extension=mimetype_to_extension(mime_type))
