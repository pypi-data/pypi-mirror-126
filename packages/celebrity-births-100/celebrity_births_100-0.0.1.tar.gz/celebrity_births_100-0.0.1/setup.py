...
setup(
    name='celebrity_births_100', ## This will be the name your package will be published with
    version='0.0.1', 
    description='Mock package that allows you to find celebrity by date of birth',
    url='https://github.com/ovidiu100/Celebrities-Births', # Add the URL of your github repo if published 
                                                                   # in GitHub
    author='Ovidiu Popa', # Your name
    license='MIT',
