...
class CodeBuild(o7lib.aws.base.Base):
    ...
    def DisplayProjectDetails(self, details, builds = None):
        ...
        print(f'Modified: {o7lib.util.displays.FormatSince(details.get("lastModified", None))} ago')
    ...
    def DisplayBuildDetails(self, details):
        ...
        print(f'Duration: {o7lib.util.displays.FormatSince(details.get("diffTime", None))}')
