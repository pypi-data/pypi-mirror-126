  ...
  constructor() {
    try {
      ...
      const defaultSections = [
        ...
        {section: "Ethical Considerations", description: "Any form of bias or issues relating to the model's impact."},
        {section: "Caveats and Recommendations", description: "Any shortcomings of the model or prescribed steps while using the model."},
        {section: "Libraries", description: "The libraries that are imported into the notebook."},
        {section: "Datasets", description: "Information about construction of transformation of the datasets used."},
        {section: "References", description: "Any references or citations to external sources."},
        {section: "Data Cleaning", description: "Steps performed to clean the required data."},
        {section: "Preprocessing", description: "Steps performed to change the dataset to a form required by the model."},
        ...
        {section: "Hyperparameters", description: "Hyperparameter tuning for the model."},
        {section: "Plotting", description: "Any plots present in the notebook."},
        {section: "Disaggregated Evaluation Result", description: "A description of the evaluation and the results."},
