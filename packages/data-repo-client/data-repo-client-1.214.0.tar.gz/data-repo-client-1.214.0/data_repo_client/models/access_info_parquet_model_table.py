...
class AccessInfoParquetModelTable(object):
    ...
    def __init__(self, name=None, id=None, signed_url=None, sample_query=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def id(self):
        """Gets the id of this AccessInfoParquetModelTable.  # noqa: E501

        The unique id of the dataset table   # noqa: E501

        :return: The id of this AccessInfoParquetModelTable.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this AccessInfoParquetModelTable.

        The unique id of the dataset table   # noqa: E501

        :param id: The id of this AccessInfoParquetModelTable.  # noqa: E501
        :type: str
        """
    ...
    @property
    def signed_url(self):
        """Gets the signed_url of this AccessInfoParquetModelTable.  # noqa: E501

        The link to access the container that stores parquet files   # noqa: E501

        :return: The signed_url of this AccessInfoParquetModelTable.  # noqa: E501
        :rtype: str
        """
    ...
    def signed_url(self, signed_url):
        """Sets the signed_url of this AccessInfoParquetModelTable.

        The link to access the container that stores parquet files   # noqa: E501

        :param signed_url: The signed_url of this AccessInfoParquetModelTable.  # noqa: E501
        :type: str
        """
    ...
    def sample_query(self):
        """Gets the sample_query of this AccessInfoParquetModelTable.  # noqa: E501

        An example query that can be used to select data from this table   # noqa: E501

        :return: The sample_query of this AccessInfoParquetModelTable.  # noqa: E501
        :rtype: str
        """
    ...
    def sample_query(self, sample_query):
        """Sets the sample_query of this AccessInfoParquetModelTable.

        An example query that can be used to select data from this table   # noqa: E501

        :param sample_query: The sample_query of this AccessInfoParquetModelTable.  # noqa: E501
        :type: str
        """
