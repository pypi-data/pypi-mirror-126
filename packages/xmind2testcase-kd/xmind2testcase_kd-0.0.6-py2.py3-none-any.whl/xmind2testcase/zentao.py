...
def xmind_to_zentao_csv_file(xmind_file):
    ...
    with open(zentao_file, 'w', encoding='gbk', errors='ignore') as f:
        writer = csv.writer(f)
...
def gen_a_testcase_row(testcase_dict):
    ...
    # case_rp_bind = gen_case_apply_phase(testcase_dict[''])
    case_rp_bind = testcase_dict['link']
    row = [case_module, case_title, case_precontion, case_step, case_expected_result, case_keyword, case_priority, case_type, case_apply_phase, case_rp_bind]
    return row
