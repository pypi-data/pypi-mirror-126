...
def get_xmind_testcase_list(xmind_file):
    ...
    for testsuite in testsuites:
        ...
        for suite in testsuite.sub_suites:
            suite.link = link if suite.link == '' or suite.link is None else suite.link
            for case in suite.testcase_list:
                case_data = case.to_dict()
                case_data['product'] = product
                case_data['suite'] = suite.name
                case_data['link'] = suite.link if case_data['link'] == '' or case_data['link'] is None else case_data['link']
