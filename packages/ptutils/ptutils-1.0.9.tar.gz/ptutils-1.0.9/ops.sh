...
function do_action(){
  case "$1" in
    ...
    style)
      ...
      activate_venv
      export PYTHONUNBUFFERED=yes
      run "Check Source code Style Compliance" flake8 --max-line-length=120 --ignore=E201,E202,E401,E221,E241,E251,W504 --exclude '__pending*' ./ptutils
    ;;
    -h|--help|help)
      usage
    ;;
    ...
    clean)
        run "Removing built files but preserving venv" git clean -xdf -e py3venv/ -e op.log
    ;;
