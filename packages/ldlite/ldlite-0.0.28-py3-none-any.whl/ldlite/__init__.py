...
class LDLite:
    ...
    def connect_db(self, filename=None):
        ...
        The optional *filename* is a local file containing the DuckDB database
        or where the database will be created if it does not exist.  If
        *filename* is not specified, the database will be stored in memory and
