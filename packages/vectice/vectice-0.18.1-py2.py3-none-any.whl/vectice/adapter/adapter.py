...
class Adapter(AbstractAdapter):
    ...
    # TODO reimplement adding properties
    def create_dataset_with_connection_id(
        ...
        created_dataset = DatasetCreator(name=dataset_name, connectionId=connection_id, files=files, folders=folders)
    ...
    def create_dataset_with_connection_name(
        ...
        """
        data_resources = DataResource.create_resources(files, folders)
        created_dataset = DatasetCreator(
            name=dataset_name, connectionName=connection_name, files=files, folders=folders
        )
        dataset = self._client.create_dataset(
            {
                "name": created_dataset.name,
