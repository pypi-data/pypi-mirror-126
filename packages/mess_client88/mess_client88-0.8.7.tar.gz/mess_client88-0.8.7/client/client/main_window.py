...
sys.path.append('../../../')
from packets.client.client.main_window_conv import Ui_MainWindow
from packets.client.client.add_contact import AddContactDialog
from packets.client.client.del_contact import DelContactDialog
from packets.client.common.errors import ServerError
...
class ClientMainWindow(QMainWindow):
    def __init__(self, database, transport):
        ...
        self.ui.push_send_message.clicked.connect(self.send_message)

        # "добавить контакт"
        self.ui.push_add_contact.clicked.connect(self.add_contact_window)
        self.ui.menu_add_contact.triggered.connect(self.add_contact_window)

        # Удалить контакт
        self.ui.push_delete_contact.clicked.connect(self.delete_contact_window)
        self.ui.menu_delete_contact.triggered.connect(self.delete_contact_window)
    ...
    def set_disabled_input(self):
        ...
        self.ui.list_new_message.clear()
        if self.history_model:
            self.history_model.clear()

        # Поле ввода и кнопка отправки неактивны до выбора получателя.
        self.ui.push_clean_field.setDisabled(True)
        self.ui.push_send_message.setDisabled(True)
        self.ui.list_new_message.setDisabled(True)
    ...
    def set_active_user(self):
        ...
        self.ui.push_clean_field.setDisabled(False)
        self.ui.push_send_message.setDisabled(False)
        self.ui.list_new_message.setDisabled(False)
    ...
    def send_message(self):
        ...
        message_text = self.ui.list_new_message.toPlainText()
        self.ui.list_new_message.clear()
        if not message_text:
            return
        try:
