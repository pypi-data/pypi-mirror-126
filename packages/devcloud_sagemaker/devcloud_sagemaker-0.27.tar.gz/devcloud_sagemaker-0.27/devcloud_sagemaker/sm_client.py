...
def create_training_job(local_data, source_code, weights, hyper_param):
    ...
    if local_data is not None:
        ...
        print("Please at s3_position input S3 public datasetes url")
...
if __name__ == "__main__":
    ...
    create_training_job(None,
                        "yolov5.tar",
                        "yolov5s.pt",
                        {"instance_type":"ml.m5.xlarge",
                        "s3_position":"s3://code-devcloud/jobs/05ec9d2d-8862-49c1-9d1c-a39125e23fc2/Traindata/datasets_simple/",
                        "instance_count":"1",
    ...
    create_training_job(None,
                        ...
                        None,
                        {"instance_type":"ml.m5.xlarge",
                        "s3_position":"s3://code-devcloud/jobs/090e3c81-804a-4a34-abfb-33d67d77bfa8/Traindata/mnist/",
                        "instance_count":"1",
