...
from recsim_ng.stories import simple_simulation as simulation


@gin.configurable
def create_latent_variable_model_network(num_users=2000,
                                         num_topics=3,
                                         slate_size=4,
  ...
  return simulation.recs_story(config, user_ctor,
