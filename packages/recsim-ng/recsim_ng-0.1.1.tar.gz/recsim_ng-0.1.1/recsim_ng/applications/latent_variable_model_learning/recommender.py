...
@gin.configurable
class SimpleNormalRecommender(tf.Module, recommender.BaseRecommender):
  """A recommender recommends normally distributed documents."""

  def __init__(self, config, slate_doc_means=None, normal_scale=0.5):
    ...
    self._slate_docs_spec = ValueSpec(
        features=Space(
