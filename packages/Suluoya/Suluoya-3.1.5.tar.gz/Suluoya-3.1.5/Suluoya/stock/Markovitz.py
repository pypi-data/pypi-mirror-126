...
class Markovitz(object):
    ...
    def weights_test(self, number=5):
        self.names = random.sample(self.names, number)
    ...
    def weights_tests(self, number=5):
        while 1:
            result = self.weights_test(number)
...
if __name__ == '__main__':
    ...
    # buy = mk.buy()
    # print(buy)
    ow = mk.weights_tests(3)  # .map(lambda x: round(x, 4))
    print(ow)
