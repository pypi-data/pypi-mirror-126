...
class SQLRouter(object):
    ...
    def Explain(self, db: "std::string const &", sql: "std::string const &", status: "Status", performance_sensitive: "bool"=True) -> "std::shared_ptr< openmldb::sdk::ExplainInfo >":
        return _sql_router_sdk.SQLRouter_Explain(self, db, sql, status, performance_sensitive)
    ...
    def ExecuteSQL(self, db: "std::string const &", sql: "std::string const &", status: "Status", performance_sensitive: "bool"=True) -> "std::shared_ptr< hybridse::sdk::ResultSet >":
        return _sql_router_sdk.SQLRouter_ExecuteSQL(self, db, sql, status, performance_sensitive)

    def ExecuteSQLParameterized(self, db: "std::string const &", sql: "std::string const &", parameter: "std::shared_ptr< openmldb::sdk::SQLRequestRow >", status: "Status", performance_sensitive: "bool"=True) -> "std::shared_ptr< hybridse::sdk::ResultSet >":
        return _sql_router_sdk.SQLRouter_ExecuteSQLParameterized(self, db, sql, parameter, status, performance_sensitive)
    ...
    def ExecuteDDLParse(self, sql: "std::string const &", schemas: "TableColumnDescPairVector") -> "std::vector< std::string,std::allocator< std::string > >":
        return _sql_router_sdk.SQLRouter_ExecuteDDLParse(self, sql, schemas)
