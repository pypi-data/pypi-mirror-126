...
from OpenHub.data_tranformers.constants.constant import Constant
from OpenHub.data_tranformers.data_transformer import DataTransformer
from OpenHub.data_tranformers.difference import Difference
from OpenHub.data_tranformers.divide import Divide
from OpenHub.data_tranformers.max import Max
from OpenHub.data_tranformers.min import Min
from OpenHub.data_tranformers.product import Product
from OpenHub.data_tranformers.sum import Sum
...
class HomekitDecoder(json.JSONDecoder):
    ...
    def object_hook(self, dct):
        ...
        if model == 'DataTransformerConstants':
            return Constant(id=dct['id'],index=dct['indx'],value=dct['value'])
