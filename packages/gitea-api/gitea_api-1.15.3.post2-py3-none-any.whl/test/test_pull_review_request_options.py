...
import gitea_api
from gitea_api.models.pull_review_request_options import PullReviewRequestOptions  # noqa: E501
...
class TestPullReviewRequestOptions(unittest.TestCase):
    ...
    def testPullReviewRequestOptions(self):
        ...
        # model = gitea_api.models.pull_review_request_options.PullReviewRequestOptions()  # noqa: E501
        pass
