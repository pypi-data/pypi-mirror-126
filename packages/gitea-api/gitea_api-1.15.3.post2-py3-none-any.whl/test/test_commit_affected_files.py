...
import gitea_api
from gitea_api.models.commit_affected_files import CommitAffectedFiles  # noqa: E501
...
class TestCommitAffectedFiles(unittest.TestCase):
    ...
    def testCommitAffectedFiles(self):
        ...
        # model = gitea_api.models.commit_affected_files.CommitAffectedFiles()  # noqa: E501
        pass
