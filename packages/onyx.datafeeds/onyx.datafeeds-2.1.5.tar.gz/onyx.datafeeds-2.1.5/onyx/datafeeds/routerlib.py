...
class DataRouter(tornado.web.Application):
    ...
    async def process_request(self, req, real_time):
        ...
        try:
            ...
            self.logger.info("cennot get data from memcache", exc_info=1)
            response = None
        ...
        if response is None:
            ...
            try:
                ...
                self.logger.info("cannot lock memcache", exc_info=1)
                pass
            ...
            try:
                ...
                self.logger.info("cannot access memcache", exc_info=1)
                pass
