...
def test():
    ...
    ws_scraper.work({'params': {'worker_driver': 'WebSitesScrapingWorker', 'title': 'Service Bus'}, 'payload': {'scrap_flow': 'scraper_flows/azure_single_action_doc_scraper.yml', 'url_to_scrap': 'https://docs.microsoft.com/en-us/rest/api/servicebus/delete-entity'}})
