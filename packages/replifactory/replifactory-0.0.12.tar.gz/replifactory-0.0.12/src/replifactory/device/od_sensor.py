...
def od_calibration_function(x, a, b, c, d, g):
    ...
    :param x: measured voltage in millivolts
...
class OdSensor:
    ...
    @property
    def calibration_mv_to_od(self):
        return self.device.calibration_mv_to_od[self.vial_number]

    @calibration_mv_to_od.setter
    def calibration_mv_to_od(self, value):
        self.device.calibration_mv_to_od[self.vial_number] = value
        self.fit_calibration_function()
        self.device.save()
    ...
    def calibration_curve(self):
        calibration_mv = list(self.calibration_mv_to_od.keys())
        calibration_od = list(self.calibration_mv_to_od.values())
        if len(calibration_mv) < 4:
