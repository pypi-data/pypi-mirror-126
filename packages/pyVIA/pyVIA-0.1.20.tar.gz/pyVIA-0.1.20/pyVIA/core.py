...
def draw_trajectory_gams(X_dimred, sc_supercluster_nn, cluster_labels, super_cluster_labels, super_edgelist, x_lazy,
                         ...
                         title_str="hitting times", super_root=[0], draw_all_curves=True, arrow_width_scale_factor=15, scatter_size=10, scatter_alpha=0.5,
                         linewidth =1.5):
    ...
    ax2.scatter(X_dimred[:, 0], X_dimred[:, 1], c=projected_sc_pt, cmap='viridis_r', alpha=scatter_alpha, s=scatter_size)  # alpha=0.6, s=10,50
    count_ = 0
...
class VIA:
    def __init__(self, data, true_label=None, anndata=None, dist_std_local=2, jac_std_global='median',
                 ...
                 visual_cluster_graph_pruning=0.15, neighboring_terminal_states_threshold=2, num_mcmc_simulations=1300,piegraph_arrow_head_width =0.4,
    ...
    def run_subPARC(self):
        ...
        if (self.dataset == '2M') | (self.dataset == 'mESC'):
            ...
            visual_global_pruning_std = 0.15#1  # 1 for conn2
            max_outgoing = 2
        else:
...
def main_Toy(ncomps=10, knn=30, random_seed=41, dataset='Toy3', root_user=['M1'],
    ...
    v0 = VIA(adata_counts.obsm['X_pca'][:, 0:ncomps], true_label, jac_std_global=jac_std_global, dist_std_local=1,
             knn=knn,
             too_big_factor=0.3, root_user=root_user, preserve_disconnected=True, dataset='toy',
             random_seed=random_seed, piegraph_arrow_head_width=0.4, piegraph_edgeweight_scalingfactor=1.0)  # *.4 root=2,
    v0.run_VIA()
    super_labels = v0.labels
    df_ids['pt'] = v0.single_cell_pt_markov
    correlation = df_ids['pt'].corr(df_ids['true_time'])
...
def via_wrapper(adata, true_label, embedding, knn=20, jac_std_global=0.15, root=0, dataset='', random_seed=42,
                ...
                cluster_graph_pruning_std=0.15, draw_all_curves=True, piegraph_edgeweight_scalingfactor = 1.5, piegraph_arrow_head_width =0.4):
    v0 = VIA(adata.obsm['X_pca'][:, 0:ncomps], true_label, jac_std_global=jac_std_global, dist_std_local=1, knn=knn,
             ...
             cluster_graph_pruning_std=cluster_graph_pruning_std, piegraph_arrow_head_width=piegraph_arrow_head_width, piegraph_edgeweight_scalingfactor=piegraph_edgeweight_scalingfactor, visual_cluster_graph_pruning= 0.15,max_visual_outgoing_edges=2)  # *.4 root=1,
    v0.run_VIA()
    ...
    v1 = VIA(adata.obsm['X_pca'][:, 0:ncomps], true_label, jac_std_global=jac_std_global, dist_std_local=1, knn=knn,
             ...
             full_neighbor_array=v0.full_neighbor_array, full_distance_array=v0.full_distance_array,
             ig_full_graph=v0.ig_full_graph,
             csr_array_locally_pruned=v0.csr_array_locally_pruned, cluster_graph_pruning_std=cluster_graph_pruning_std,piegraph_edgeweight_scalingfactor=piegraph_edgeweight_scalingfactor)
    v1.run_VIA()
