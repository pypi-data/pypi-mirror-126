...
def main_Toy(ncomps=10, knn=30, random_seed=41, dataset='Toy3', root_user=['M1'],
    ...
    #via_wrapper_disconnected(adata_counts, true_label, embedding=adata_counts.obsm['X_pca'][:, 0:2], root=[1,900], preserve_disconnected=True, knn=10, ncomps=30, cluster_graph_pruning_std=1 ,random_seed=41)
    if dataset == 'Toy4':
