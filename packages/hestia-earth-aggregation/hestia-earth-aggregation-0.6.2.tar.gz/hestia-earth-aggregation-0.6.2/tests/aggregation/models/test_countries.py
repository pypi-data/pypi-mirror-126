...
from tests.utils import PRODUCT, SOURCE, fixtures_path, start_year, end_year, fake_aggregated_version
...
def test_aggregate_impact(*args):
    from hestia_earth.aggregation.impact_assessment.utils import (
        AGGREGATION_KEYS, _update_impact_assessment, _format_country_results
    )
