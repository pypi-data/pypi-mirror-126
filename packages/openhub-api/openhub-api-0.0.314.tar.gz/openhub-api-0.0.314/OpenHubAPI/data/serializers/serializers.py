...
from data.models.models import CalibrationConstants, Calibration, Channel, Accessory, HardwareConfig, PiPico, \
    ...
    PiPicoAnalogIo, PiPicoACAnalogIo, PiGpio, DataTransformer,DataTransformerConstants,DataTransformerTypes
...
class ChannelStatsSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = CalibrationConstants
        fields = ['channel', 'type', 'value','model']
...
class ChannelSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Channel
        fields = ['id', 'type', 'channel_index', 'hardware','channelstats','model']
...
class DataTransformerTypeSerializer(serializers.ModelSerializer):
    type = DataTransformerConstantsSerializer(read_only=True,many=True)
...
class DataTransformerTreeSerializer(serializers.ModelSerializer):
    ...
    type = DataTransformerTypeSerializer(read_only=True)
