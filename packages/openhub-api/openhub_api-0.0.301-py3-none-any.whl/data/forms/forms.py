...
class DataTransform(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.nested_constants_form = DataConstantsTransformerInlineFormset(
            ...
            initial=[{'data_transformer': str(self.instance.id), 'id': str(uuid.uuid4())},{'data_transformer': str(self.instance.id), 'id': str(uuid.uuid4())},{'data_transformer': str(self.instance.id), 'id': str(uuid.uuid4())}]

        )
        self.nested_constants_form.extra = self.instance.data_transformer_constants.count()
...
class DataTransformRoot(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.nested_constants_form = DataConstantsTransformerInlineFormset(
            ...
            files=self.files if self.is_bound else None,
            prefix=nested_constants_form_prefix,
            initial=[{'data_transformer': str(self.instance.id), 'id': str(uuid.uuid4())},{'data_transformer': str(self.instance.id), 'id': str(uuid.uuid4())},{'data_transformer': str(self.instance.id), 'id': str(uuid.uuid4())},{'data_transformer': str(self.instance.id), 'id': str(uuid.uuid4())}]
