...
class DataTransformer(MPTTModel):
    ...
    channel_stats = models.ManyToManyField(ChannelStats, on_delete=models.CASCADE, blank=True, null=True, default=None)
...
class DataTransformerConstants(models.Model):
    ...
    data_transformer = models.ForeignKey(DataTransformer, related_name='data_transformer_constants', on_delete=models.CASCADE, blank=True, null=True)
