...
class ChannelSerializer(serializers.ModelSerializer):
    channelstats_set = ChannelStatsSerializer(read_only=True,many=True)
    model = serializers.SerializerMethodField()

    def restore_object(self, attrs, instance=None):
        instance = super(ChannelSerializer, self).restore_object(attrs, instance)
        instance.channelstats = ChannelStats.objects.get({'channel':instance.id}).all
        return instance
