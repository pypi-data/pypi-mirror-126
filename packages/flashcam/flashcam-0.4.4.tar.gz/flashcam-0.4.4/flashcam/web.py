...
<hr>
  <p>    <button style="width:8%" name="speedx" value="SPEEDX">dXdY</button>
...
<br>
   <p>   <button style="width:8%" name="accum" value="ACCUM">Accum</button>
      accum <input type = "text" name = "accumtxt" size="6" /></p>
  </div>
