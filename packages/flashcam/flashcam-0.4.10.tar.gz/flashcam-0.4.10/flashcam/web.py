...
<hr>
  <div class="btn-group" style="width:100%">
      <button style="width:8%" name="savebg" value="SAVEBG">saveBG</button>
      <button style="width:8%" name="subbg" value="SUBBG">subBG</button>
 <img src="{{url_bg}}" alt="Smiley face"  height="120" width="160" />
<hr>
      <button style="width:8%" name="speedx" value="SPEEDX">dXdY</button>
      <!--button style="width:8%" name="speedy" value="SPEEDY">dY</button-->
dx <input type = "text" name = "inputx"  size="6" />  dy <input type = "text" name = "inputy" size="6" />

      <button style="width:8%" name="restart_translate" value="RESTART_TRANSLATE">restart</button>
      <button style="width:8%" name="zero_translate" value="ZERO_TRANSLATE">zero</button>
<br>
      <button style="width:8%" name="accum" value="ACCUM">Accum</button>
      &nbsp; &nbsp;&nbsp; <input type = "text" name = "accumtxt" size="6" />
<hr>
      <button style="width:8%" name="gamma2" value="GAMMA2">gm x2</button>
      <button style="width:8%" name="gamma05" value="GAMMA05">gm /2</button>
      <button style="width:8%" name="gamma" value="GAMMA">gm def</button>
      <button style="width:8%" name="gain2" value="GAIN2">ga x2</button>
      <button style="width:8%" name="gain05" value="GAIN05">ga /2</button>
      <button style="width:8%" name="gain" value="GAIN">ga def</button>
