...
from packets.server.server.stat_window import StatWindow
from packets.server.server.config_window import ConfigWindow
from packets.server.server.add_user import RegisterUser
from packets.server.server.remove_user import DelUserDialog
