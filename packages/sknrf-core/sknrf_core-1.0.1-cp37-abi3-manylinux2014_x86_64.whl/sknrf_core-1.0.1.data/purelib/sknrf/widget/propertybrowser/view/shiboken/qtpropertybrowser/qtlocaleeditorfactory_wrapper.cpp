...
void QtLocaleEditorFactoryWrapper::connectPropertyManager(QtLocalePropertyManager * manager)
{
    ...
    if (pyOverride.isNull()) {
        gil.release();
        this->::QtLocaleEditorFactory::connectPropertyManager(manager);
        return;
    }

    Shiboken::AutoDecRef pyArgs(Py_BuildValue("(N)",
        Shiboken::Conversions::pointerToPython(reinterpret_cast<SbkObjectType *>(SbkqtpropertybrowserTypes[SBK_QTLOCALEPROPERTYMANAGER_IDX]), manager)
    ));
...
QWidget * QtLocaleEditorFactoryWrapper::createAttributeEditor(QtLocalePropertyManager * manager, QtProperty * property, QWidget * parent, BrowserCol attribute)
{
    ...
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "QtLocaleEditorFactory.createAttributeEditor", reinterpret_cast<PyTypeObject *>(Shiboken::SbkType< QWidget >())->tp_name, Py_TYPE(pyResult)->tp_name);
        return nullptr;
    }
    ::QWidget *cppResult;
...
QWidget * QtLocaleEditorFactoryWrapper::createEditor(QtLocalePropertyManager * manager, QtProperty * property, QWidget * parent)
{
    ...
    PythonToCppFunc pythonToCpp = Shiboken::Conversions::isPythonToCppPointerConvertible(reinterpret_cast<SbkObjectType *>(SbkPySide2_QtWidgetsTypes[SBK_QWIDGET_IDX]), pyResult);
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "QtLocaleEditorFactory.createEditor", reinterpret_cast<PyTypeObject *>(Shiboken::SbkType< QWidget >())->tp_name, Py_TYPE(pyResult)->tp_name);
        return nullptr;
    }
    ::QWidget *cppResult;
    pythonToCpp(pyResult, &cppResult);
...
void QtLocaleEditorFactoryWrapper::disconnectPropertyManager(QtLocalePropertyManager * manager)
{
    ...
    if (pyOverride.isNull()) {
        gil.release();
        this->::QtLocaleEditorFactory::disconnectPropertyManager(manager);
        return;
    }
...
Sbk_QtLocaleEditorFactory_Init(PyObject *self, PyObject *args, PyObject *kwds)
{
    ...
    if (numArgs + numNamedArgs > 1) {
        PyErr_SetString(PyExc_TypeError, "qtpropertybrowser.QtLocaleEditorFactory(): too many arguments");
        return -1;
    }
    ...
    // Call function/method
    {
        if (kwds) {
            ...
            if (value && pyArgs[0]) {
                PyErr_SetString(PyExc_TypeError, "qtpropertybrowser.QtLocaleEditorFactory(): got multiple values for keyword argument 'parent'.");
                return -1;
                        } else if (value) {
                pyArgs[0] = value;
    ...
    Sbk_QtLocaleEditorFactory_Init_TypeError:
        Shiboken::setErrorAboutWrongArguments(args, "qtpropertybrowser.QtLocaleEditorFactory");
        return -1;
}

static PyObject *Sbk_QtLocaleEditorFactoryFunc_connectPropertyManager(PyObject *self, PyObject *pyArg)
{
    QtLocaleEditorFactoryWrapper *cppSelf = nullptr;
    SBK_UNUSED(cppSelf)
    if (!Shiboken::Object::isValid(self))
        return {};
    cppSelf = static_cast<QtLocaleEditorFactoryWrapper *>(reinterpret_cast< ::QtLocaleEditorFactory *>(Shiboken::Conversions::cppPointer(SbkqtpropertybrowserTypes[SBK_QTLOCALEEDITORFACTORY_IDX], reinterpret_cast<SbkObject *>(self))));
    int overloadId = -1;
    ...
    if ((pythonToCpp = Shiboken::Conversions::isPythonToCppPointerConvertible(reinterpret_cast<SbkObjectType *>(SbkqtpropertybrowserTypes[SBK_QTLOCALEPROPERTYMANAGER_IDX]), (pyArg)))) {
    ...
    Sbk_QtLocaleEditorFactoryFunc_connectPropertyManager_TypeError:
        Shiboken::setErrorAboutWrongArguments(pyArg, "qtpropertybrowser.QtLocaleEditorFactory.connectPropertyManager");
        return {};
}
...
static PyObject *Sbk_QtLocaleEditorFactoryFunc_createAttributeEditor(PyObject *self, PyObject *args)
{
    ...
    // Overloaded function decisor
    // 0: QtLocaleEditorFactory::createAttributeEditor(QtLocalePropertyManager*,QtProperty*,QWidget*,BrowserCol)
    if (numArgs == 4
        && (pythonToCpp[0] = Shiboken::Conversions::isPythonToCppPointerConvertible(reinterpret_cast<SbkObjectType *>(SbkqtpropertybrowserTypes[SBK_QTLOCALEPROPERTYMANAGER_IDX]), (pyArgs[0])))
    ...
    Sbk_QtLocaleEditorFactoryFunc_createAttributeEditor_TypeError:
        Shiboken::setErrorAboutWrongArguments(args, "qtpropertybrowser.QtLocaleEditorFactory.createAttributeEditor");
        return {};
}
...
static PyObject *Sbk_QtLocaleEditorFactoryFunc_createEditor(PyObject *self, PyObject *args)
{
    ...
    // Overloaded function decisor
    // 0: QtLocaleEditorFactory::createEditor(QtLocalePropertyManager*,QtProperty*,QWidget*)
    if (numArgs == 3
        && (pythonToCpp[0] = Shiboken::Conversions::isPythonToCppPointerConvertible(reinterpret_cast<SbkObjectType *>(SbkqtpropertybrowserTypes[SBK_QTLOCALEPROPERTYMANAGER_IDX]), (pyArgs[0])))
        && (pythonToCpp[1] = Shiboken::Conversions::isPythonToCppPointerConvertible(reinterpret_cast<SbkObjectType *>(SbkqtpropertybrowserTypes[SBK_QTPROPERTY_IDX]), (pyArgs[1])))
        && (pythonToCpp[2] = Shiboken::Conversions::isPythonToCppPointerConvertible(reinterpret_cast<SbkObjectType *>(SbkPySide2_QtWidgetsTypes[SBK_QWIDGET_IDX]), (pyArgs[2])))) {
    ...
    Sbk_QtLocaleEditorFactoryFunc_createEditor_TypeError:
        Shiboken::setErrorAboutWrongArguments(args, "qtpropertybrowser.QtLocaleEditorFactory.createEditor");
        return {};
}
...
static PyObject *Sbk_QtLocaleEditorFactoryFunc_disconnectPropertyManager(PyObject *self, PyObject *pyArg)
{
    ...
    Sbk_QtLocaleEditorFactoryFunc_disconnectPropertyManager_TypeError:
        Shiboken::setErrorAboutWrongArguments(pyArg, "qtpropertybrowser.QtLocaleEditorFactory.disconnectPropertyManager");
        return {};
}

static PyMethodDef Sbk_QtLocaleEditorFactory_methods[] = {
    {"connectPropertyManager", reinterpret_cast<PyCFunction>(Sbk_QtLocaleEditorFactoryFunc_connectPropertyManager), METH_O},
    {"createAttributeEditor", reinterpret_cast<PyCFunction>(Sbk_QtLocaleEditorFactoryFunc_createAttributeEditor), METH_VARARGS},
    {"createEditor", reinterpret_cast<PyCFunction>(Sbk_QtLocaleEditorFactoryFunc_createEditor), METH_VARARGS},
    {"disconnectPropertyManager", reinterpret_cast<PyCFunction>(Sbk_QtLocaleEditorFactoryFunc_disconnectPropertyManager), METH_O},
...
// Class Definition -----------------------------------------------
extern "C" {
static SbkObjectType *_Sbk_QtLocaleEditorFactory_Type = nullptr;
static SbkObjectType *Sbk_QtLocaleEditorFactory_TypeF(void)
{
...
static PyType_Spec Sbk_QtLocaleEditorFactory_spec = {
    "qtpropertybrowser.QtLocaleEditorFactory",
    sizeof(SbkObject),
    0,
...
static PythonToCppFunc is_QtLocaleEditorFactory_PythonToCpp_QtLocaleEditorFactory_PTR_Convertible(PyObject *pyIn) {
    ...
    if (PyObject_TypeCheck(pyIn, reinterpret_cast<PyTypeObject *>(Sbk_QtLocaleEditorFactory_TypeF())))
...
static const char *QtLocaleEditorFactory_SignatureStrings[] = {
    "qtpropertybrowser.QtLocaleEditorFactory(parent:PySide2.QtCore.QObject=nullptr)",
    "qtpropertybrowser.QtLocaleEditorFactory.connectPropertyManager(manager:qtpropertybrowser.QtLocalePropertyManager)",
    "qtpropertybrowser.QtLocaleEditorFactory.createAttributeEditor(manager:qtpropertybrowser.QtLocalePropertyManager,property:qtpropertybrowser.QtProperty,parent:PySide2.QtWidgets.QWidget,attribute:qtpropertybrowser.BrowserCol)->PySide2.QtWidgets.QWidget",
    "qtpropertybrowser.QtLocaleEditorFactory.createEditor(manager:qtpropertybrowser.QtLocalePropertyManager,property:qtpropertybrowser.QtProperty,parent:PySide2.QtWidgets.QWidget)->PySide2.QtWidgets.QWidget",
    "qtpropertybrowser.QtLocaleEditorFactory.disconnectPropertyManager(manager:qtpropertybrowser.QtLocalePropertyManager)",
    nullptr}; // Sentinel
...
void init_QtLocaleEditorFactory(PyObject *module)
{
    _Sbk_QtLocaleEditorFactory_Type = Shiboken::ObjectType::introduceWrapperType(
        ...
        QtLocaleEditorFactory_SignatureStrings,
        &Shiboken::callCppDestructor< ::QtLocaleEditorFactory >,
        0,
        0,
        0    );
    
    SbkqtpropertybrowserTypes[SBK_QTLOCALEEDITORFACTORY_IDX]
        = reinterpret_cast<PyTypeObject *>(Sbk_QtLocaleEditorFactory_TypeF());

    // Register Converter
    SbkConverter *converter = Shiboken::Conversions::createConverter(Sbk_QtLocaleEditorFactory_TypeF(),
