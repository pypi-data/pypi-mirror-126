...
void QtSizePolicyEditorFactoryWrapper::connectPropertyManager(QtSizePolicyPropertyManager * manager)
{
    ...
    if (pyOverride.isNull()) {
        gil.release();
        this->::QtSizePolicyEditorFactory::connectPropertyManager(manager);
        return;
    }

    Shiboken::AutoDecRef pyArgs(Py_BuildValue("(N)",
        Shiboken::Conversions::pointerToPython(reinterpret_cast<SbkObjectType *>(SbkqtpropertybrowserTypes[SBK_QTSIZEPOLICYPROPERTYMANAGER_IDX]), manager)
    ));
...
QWidget * QtSizePolicyEditorFactoryWrapper::createAttributeEditor(QtSizePolicyPropertyManager * manager, QtProperty * property, QWidget * parent, BrowserCol attribute)
{
    ...
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "QtSizePolicyEditorFactory.createAttributeEditor", reinterpret_cast<PyTypeObject *>(Shiboken::SbkType< QWidget >())->tp_name, Py_TYPE(pyResult)->tp_name);
        return nullptr;
    }
    ::QWidget *cppResult;
...
QWidget * QtSizePolicyEditorFactoryWrapper::createEditor(QtSizePolicyPropertyManager * manager, QtProperty * property, QWidget * parent)
{
    ...
    PythonToCppFunc pythonToCpp = Shiboken::Conversions::isPythonToCppPointerConvertible(reinterpret_cast<SbkObjectType *>(SbkPySide2_QtWidgetsTypes[SBK_QWIDGET_IDX]), pyResult);
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "QtSizePolicyEditorFactory.createEditor", reinterpret_cast<PyTypeObject *>(Shiboken::SbkType< QWidget >())->tp_name, Py_TYPE(pyResult)->tp_name);
        return nullptr;
    }
    ::QWidget *cppResult;
    pythonToCpp(pyResult, &cppResult);
...
void QtSizePolicyEditorFactoryWrapper::disconnectPropertyManager(QtSizePolicyPropertyManager * manager)
{
    ...
    if (pyOverride.isNull()) {
        gil.release();
        this->::QtSizePolicyEditorFactory::disconnectPropertyManager(manager);
        return;
    }
...
Sbk_QtSizePolicyEditorFactory_Init(PyObject *self, PyObject *args, PyObject *kwds)
{
    ...
    if (numArgs + numNamedArgs > 1) {
        PyErr_SetString(PyExc_TypeError, "qtpropertybrowser.QtSizePolicyEditorFactory(): too many arguments");
        return -1;
    }
    ...
    // Call function/method
    {
        if (kwds) {
            ...
            if (value && pyArgs[0]) {
                PyErr_SetString(PyExc_TypeError, "qtpropertybrowser.QtSizePolicyEditorFactory(): got multiple values for keyword argument 'parent'.");
                return -1;
                        } else if (value) {
                pyArgs[0] = value;
    ...
    Sbk_QtSizePolicyEditorFactory_Init_TypeError:
        Shiboken::setErrorAboutWrongArguments(args, "qtpropertybrowser.QtSizePolicyEditorFactory");
        return -1;
}

static PyObject *Sbk_QtSizePolicyEditorFactoryFunc_connectPropertyManager(PyObject *self, PyObject *pyArg)
{
    QtSizePolicyEditorFactoryWrapper *cppSelf = nullptr;
    SBK_UNUSED(cppSelf)
    if (!Shiboken::Object::isValid(self))
        return {};
    cppSelf = static_cast<QtSizePolicyEditorFactoryWrapper *>(reinterpret_cast< ::QtSizePolicyEditorFactory *>(Shiboken::Conversions::cppPointer(SbkqtpropertybrowserTypes[SBK_QTSIZEPOLICYEDITORFACTORY_IDX], reinterpret_cast<SbkObject *>(self))));
    int overloadId = -1;
    ...
    if ((pythonToCpp = Shiboken::Conversions::isPythonToCppPointerConvertible(reinterpret_cast<SbkObjectType *>(SbkqtpropertybrowserTypes[SBK_QTSIZEPOLICYPROPERTYMANAGER_IDX]), (pyArg)))) {
    ...
    Sbk_QtSizePolicyEditorFactoryFunc_connectPropertyManager_TypeError:
        Shiboken::setErrorAboutWrongArguments(pyArg, "qtpropertybrowser.QtSizePolicyEditorFactory.connectPropertyManager");
        return {};
}
...
static PyObject *Sbk_QtSizePolicyEditorFactoryFunc_createAttributeEditor(PyObject *self, PyObject *args)
{
    ...
    // Overloaded function decisor
    // 0: QtSizePolicyEditorFactory::createAttributeEditor(QtSizePolicyPropertyManager*,QtProperty*,QWidget*,BrowserCol)
    if (numArgs == 4
        && (pythonToCpp[0] = Shiboken::Conversions::isPythonToCppPointerConvertible(reinterpret_cast<SbkObjectType *>(SbkqtpropertybrowserTypes[SBK_QTSIZEPOLICYPROPERTYMANAGER_IDX]), (pyArgs[0])))
    ...
    Sbk_QtSizePolicyEditorFactoryFunc_createAttributeEditor_TypeError:
        Shiboken::setErrorAboutWrongArguments(args, "qtpropertybrowser.QtSizePolicyEditorFactory.createAttributeEditor");
        return {};
}
...
static PyObject *Sbk_QtSizePolicyEditorFactoryFunc_createEditor(PyObject *self, PyObject *args)
{
    ...
    // Overloaded function decisor
    // 0: QtSizePolicyEditorFactory::createEditor(QtSizePolicyPropertyManager*,QtProperty*,QWidget*)
    if (numArgs == 3
        && (pythonToCpp[0] = Shiboken::Conversions::isPythonToCppPointerConvertible(reinterpret_cast<SbkObjectType *>(SbkqtpropertybrowserTypes[SBK_QTSIZEPOLICYPROPERTYMANAGER_IDX]), (pyArgs[0])))
        && (pythonToCpp[1] = Shiboken::Conversions::isPythonToCppPointerConvertible(reinterpret_cast<SbkObjectType *>(SbkqtpropertybrowserTypes[SBK_QTPROPERTY_IDX]), (pyArgs[1])))
        && (pythonToCpp[2] = Shiboken::Conversions::isPythonToCppPointerConvertible(reinterpret_cast<SbkObjectType *>(SbkPySide2_QtWidgetsTypes[SBK_QWIDGET_IDX]), (pyArgs[2])))) {
    ...
    Sbk_QtSizePolicyEditorFactoryFunc_createEditor_TypeError:
        Shiboken::setErrorAboutWrongArguments(args, "qtpropertybrowser.QtSizePolicyEditorFactory.createEditor");
        return {};
}
...
static PyObject *Sbk_QtSizePolicyEditorFactoryFunc_disconnectPropertyManager(PyObject *self, PyObject *pyArg)
{
    ...
    Sbk_QtSizePolicyEditorFactoryFunc_disconnectPropertyManager_TypeError:
        Shiboken::setErrorAboutWrongArguments(pyArg, "qtpropertybrowser.QtSizePolicyEditorFactory.disconnectPropertyManager");
        return {};
}

static PyMethodDef Sbk_QtSizePolicyEditorFactory_methods[] = {
    {"connectPropertyManager", reinterpret_cast<PyCFunction>(Sbk_QtSizePolicyEditorFactoryFunc_connectPropertyManager), METH_O},
    {"createAttributeEditor", reinterpret_cast<PyCFunction>(Sbk_QtSizePolicyEditorFactoryFunc_createAttributeEditor), METH_VARARGS},
    {"createEditor", reinterpret_cast<PyCFunction>(Sbk_QtSizePolicyEditorFactoryFunc_createEditor), METH_VARARGS},
    {"disconnectPropertyManager", reinterpret_cast<PyCFunction>(Sbk_QtSizePolicyEditorFactoryFunc_disconnectPropertyManager), METH_O},
...
// Class Definition -----------------------------------------------
extern "C" {
static SbkObjectType *_Sbk_QtSizePolicyEditorFactory_Type = nullptr;
static SbkObjectType *Sbk_QtSizePolicyEditorFactory_TypeF(void)
{
...
static PyType_Spec Sbk_QtSizePolicyEditorFactory_spec = {
    "qtpropertybrowser.QtSizePolicyEditorFactory",
    sizeof(SbkObject),
    0,
...
static PythonToCppFunc is_QtSizePolicyEditorFactory_PythonToCpp_QtSizePolicyEditorFactory_PTR_Convertible(PyObject *pyIn) {
    ...
    if (PyObject_TypeCheck(pyIn, reinterpret_cast<PyTypeObject *>(Sbk_QtSizePolicyEditorFactory_TypeF())))
...
static const char *QtSizePolicyEditorFactory_SignatureStrings[] = {
    "qtpropertybrowser.QtSizePolicyEditorFactory(parent:PySide2.QtCore.QObject=nullptr)",
    "qtpropertybrowser.QtSizePolicyEditorFactory.connectPropertyManager(manager:qtpropertybrowser.QtSizePolicyPropertyManager)",
    "qtpropertybrowser.QtSizePolicyEditorFactory.createAttributeEditor(manager:qtpropertybrowser.QtSizePolicyPropertyManager,property:qtpropertybrowser.QtProperty,parent:PySide2.QtWidgets.QWidget,attribute:qtpropertybrowser.BrowserCol)->PySide2.QtWidgets.QWidget",
    "qtpropertybrowser.QtSizePolicyEditorFactory.createEditor(manager:qtpropertybrowser.QtSizePolicyPropertyManager,property:qtpropertybrowser.QtProperty,parent:PySide2.QtWidgets.QWidget)->PySide2.QtWidgets.QWidget",
    "qtpropertybrowser.QtSizePolicyEditorFactory.disconnectPropertyManager(manager:qtpropertybrowser.QtSizePolicyPropertyManager)",
    nullptr}; // Sentinel
...
void init_QtSizePolicyEditorFactory(PyObject *module)
{
    _Sbk_QtSizePolicyEditorFactory_Type = Shiboken::ObjectType::introduceWrapperType(
        ...
        QtSizePolicyEditorFactory_SignatureStrings,
        &Shiboken::callCppDestructor< ::QtSizePolicyEditorFactory >,
        0,
        0,
        0    );
    
    SbkqtpropertybrowserTypes[SBK_QTSIZEPOLICYEDITORFACTORY_IDX]
        = reinterpret_cast<PyTypeObject *>(Sbk_QtSizePolicyEditorFactory_TypeF());

    // Register Converter
    SbkConverter *converter = Shiboken::Conversions::createConverter(Sbk_QtSizePolicyEditorFactory_TypeF(),
