...
void QtSizeFEditorFactoryWrapper::connectPropertyManager(QtSizeFPropertyManager * manager)
{
    ...
    if (pyOverride.isNull()) {
        gil.release();
        this->::QtSizeFEditorFactory::connectPropertyManager(manager);
        return;
    }

    Shiboken::AutoDecRef pyArgs(Py_BuildValue("(N)",
        Shiboken::Conversions::pointerToPython(reinterpret_cast<SbkObjectType *>(SbkqtpropertybrowserTypes[SBK_QTSIZEFPROPERTYMANAGER_IDX]), manager)
    ));
...
QWidget * QtSizeFEditorFactoryWrapper::createAttributeEditor(QtSizeFPropertyManager * manager, QtProperty * property, QWidget * parent, BrowserCol attribute)
{
    ...
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "QtSizeFEditorFactory.createAttributeEditor", reinterpret_cast<PyTypeObject *>(Shiboken::SbkType< QWidget >())->tp_name, Py_TYPE(pyResult)->tp_name);
        return nullptr;
    }
    ::QWidget *cppResult;
...
QWidget * QtSizeFEditorFactoryWrapper::createEditor(QtSizeFPropertyManager * manager, QtProperty * property, QWidget * parent)
{
    ...
    PythonToCppFunc pythonToCpp = Shiboken::Conversions::isPythonToCppPointerConvertible(reinterpret_cast<SbkObjectType *>(SbkPySide2_QtWidgetsTypes[SBK_QWIDGET_IDX]), pyResult);
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "QtSizeFEditorFactory.createEditor", reinterpret_cast<PyTypeObject *>(Shiboken::SbkType< QWidget >())->tp_name, Py_TYPE(pyResult)->tp_name);
        return nullptr;
    }
    ::QWidget *cppResult;
    pythonToCpp(pyResult, &cppResult);
...
void QtSizeFEditorFactoryWrapper::disconnectPropertyManager(QtSizeFPropertyManager * manager)
{
    ...
    if (pyOverride.isNull()) {
        gil.release();
        this->::QtSizeFEditorFactory::disconnectPropertyManager(manager);
        return;
    }
...
Sbk_QtSizeFEditorFactory_Init(PyObject *self, PyObject *args, PyObject *kwds)
{
    ...
    if (numArgs + numNamedArgs > 1) {
        PyErr_SetString(PyExc_TypeError, "qtpropertybrowser.QtSizeFEditorFactory(): too many arguments");
        return -1;
    }
    ...
    // Call function/method
    {
        if (kwds) {
            ...
            if (value && pyArgs[0]) {
                PyErr_SetString(PyExc_TypeError, "qtpropertybrowser.QtSizeFEditorFactory(): got multiple values for keyword argument 'parent'.");
                return -1;
                        } else if (value) {
                pyArgs[0] = value;
    ...
    Sbk_QtSizeFEditorFactory_Init_TypeError:
        Shiboken::setErrorAboutWrongArguments(args, "qtpropertybrowser.QtSizeFEditorFactory");
        return -1;
}

static PyObject *Sbk_QtSizeFEditorFactoryFunc_connectPropertyManager(PyObject *self, PyObject *pyArg)
{
    QtSizeFEditorFactoryWrapper *cppSelf = nullptr;
    SBK_UNUSED(cppSelf)
    if (!Shiboken::Object::isValid(self))
        return {};
    cppSelf = static_cast<QtSizeFEditorFactoryWrapper *>(reinterpret_cast< ::QtSizeFEditorFactory *>(Shiboken::Conversions::cppPointer(SbkqtpropertybrowserTypes[SBK_QTSIZEFEDITORFACTORY_IDX], reinterpret_cast<SbkObject *>(self))));
    int overloadId = -1;
    ...
    if ((pythonToCpp = Shiboken::Conversions::isPythonToCppPointerConvertible(reinterpret_cast<SbkObjectType *>(SbkqtpropertybrowserTypes[SBK_QTSIZEFPROPERTYMANAGER_IDX]), (pyArg)))) {
    ...
    Sbk_QtSizeFEditorFactoryFunc_connectPropertyManager_TypeError:
        Shiboken::setErrorAboutWrongArguments(pyArg, "qtpropertybrowser.QtSizeFEditorFactory.connectPropertyManager");
        return {};
}
...
static PyObject *Sbk_QtSizeFEditorFactoryFunc_createAttributeEditor(PyObject *self, PyObject *args)
{
    ...
    // Overloaded function decisor
    // 0: QtSizeFEditorFactory::createAttributeEditor(QtSizeFPropertyManager*,QtProperty*,QWidget*,BrowserCol)
    if (numArgs == 4
        && (pythonToCpp[0] = Shiboken::Conversions::isPythonToCppPointerConvertible(reinterpret_cast<SbkObjectType *>(SbkqtpropertybrowserTypes[SBK_QTSIZEFPROPERTYMANAGER_IDX]), (pyArgs[0])))
    ...
    Sbk_QtSizeFEditorFactoryFunc_createAttributeEditor_TypeError:
        Shiboken::setErrorAboutWrongArguments(args, "qtpropertybrowser.QtSizeFEditorFactory.createAttributeEditor");
        return {};
}
...
static PyObject *Sbk_QtSizeFEditorFactoryFunc_createEditor(PyObject *self, PyObject *args)
{
    ...
    // Overloaded function decisor
    // 0: QtSizeFEditorFactory::createEditor(QtSizeFPropertyManager*,QtProperty*,QWidget*)
    if (numArgs == 3
        && (pythonToCpp[0] = Shiboken::Conversions::isPythonToCppPointerConvertible(reinterpret_cast<SbkObjectType *>(SbkqtpropertybrowserTypes[SBK_QTSIZEFPROPERTYMANAGER_IDX]), (pyArgs[0])))
        && (pythonToCpp[1] = Shiboken::Conversions::isPythonToCppPointerConvertible(reinterpret_cast<SbkObjectType *>(SbkqtpropertybrowserTypes[SBK_QTPROPERTY_IDX]), (pyArgs[1])))
        && (pythonToCpp[2] = Shiboken::Conversions::isPythonToCppPointerConvertible(reinterpret_cast<SbkObjectType *>(SbkPySide2_QtWidgetsTypes[SBK_QWIDGET_IDX]), (pyArgs[2])))) {
    ...
    Sbk_QtSizeFEditorFactoryFunc_createEditor_TypeError:
        Shiboken::setErrorAboutWrongArguments(args, "qtpropertybrowser.QtSizeFEditorFactory.createEditor");
        return {};
}
...
static PyObject *Sbk_QtSizeFEditorFactoryFunc_disconnectPropertyManager(PyObject *self, PyObject *pyArg)
{
    ...
    Sbk_QtSizeFEditorFactoryFunc_disconnectPropertyManager_TypeError:
        Shiboken::setErrorAboutWrongArguments(pyArg, "qtpropertybrowser.QtSizeFEditorFactory.disconnectPropertyManager");
        return {};
}

static PyMethodDef Sbk_QtSizeFEditorFactory_methods[] = {
    {"connectPropertyManager", reinterpret_cast<PyCFunction>(Sbk_QtSizeFEditorFactoryFunc_connectPropertyManager), METH_O},
    {"createAttributeEditor", reinterpret_cast<PyCFunction>(Sbk_QtSizeFEditorFactoryFunc_createAttributeEditor), METH_VARARGS},
    {"createEditor", reinterpret_cast<PyCFunction>(Sbk_QtSizeFEditorFactoryFunc_createEditor), METH_VARARGS},
    {"disconnectPropertyManager", reinterpret_cast<PyCFunction>(Sbk_QtSizeFEditorFactoryFunc_disconnectPropertyManager), METH_O},
...
// Class Definition -----------------------------------------------
extern "C" {
static SbkObjectType *_Sbk_QtSizeFEditorFactory_Type = nullptr;
static SbkObjectType *Sbk_QtSizeFEditorFactory_TypeF(void)
{
...
static PyType_Spec Sbk_QtSizeFEditorFactory_spec = {
    "qtpropertybrowser.QtSizeFEditorFactory",
    sizeof(SbkObject),
    0,
...
static PythonToCppFunc is_QtSizeFEditorFactory_PythonToCpp_QtSizeFEditorFactory_PTR_Convertible(PyObject *pyIn) {
    ...
    if (PyObject_TypeCheck(pyIn, reinterpret_cast<PyTypeObject *>(Sbk_QtSizeFEditorFactory_TypeF())))
...
static const char *QtSizeFEditorFactory_SignatureStrings[] = {
    "qtpropertybrowser.QtSizeFEditorFactory(parent:PySide2.QtCore.QObject=nullptr)",
    "qtpropertybrowser.QtSizeFEditorFactory.connectPropertyManager(manager:qtpropertybrowser.QtSizeFPropertyManager)",
    "qtpropertybrowser.QtSizeFEditorFactory.createAttributeEditor(manager:qtpropertybrowser.QtSizeFPropertyManager,property:qtpropertybrowser.QtProperty,parent:PySide2.QtWidgets.QWidget,attribute:qtpropertybrowser.BrowserCol)->PySide2.QtWidgets.QWidget",
    "qtpropertybrowser.QtSizeFEditorFactory.createEditor(manager:qtpropertybrowser.QtSizeFPropertyManager,property:qtpropertybrowser.QtProperty,parent:PySide2.QtWidgets.QWidget)->PySide2.QtWidgets.QWidget",
    "qtpropertybrowser.QtSizeFEditorFactory.disconnectPropertyManager(manager:qtpropertybrowser.QtSizeFPropertyManager)",
    nullptr}; // Sentinel
...
void init_QtSizeFEditorFactory(PyObject *module)
{
    _Sbk_QtSizeFEditorFactory_Type = Shiboken::ObjectType::introduceWrapperType(
        ...
        QtSizeFEditorFactory_SignatureStrings,
        &Shiboken::callCppDestructor< ::QtSizeFEditorFactory >,
        0,
        0,
        0    );
    
    SbkqtpropertybrowserTypes[SBK_QTSIZEFEDITORFACTORY_IDX]
        = reinterpret_cast<PyTypeObject *>(Sbk_QtSizeFEditorFactory_TypeF());

    // Register Converter
    SbkConverter *converter = Shiboken::Conversions::createConverter(Sbk_QtSizeFEditorFactory_TypeF(),
