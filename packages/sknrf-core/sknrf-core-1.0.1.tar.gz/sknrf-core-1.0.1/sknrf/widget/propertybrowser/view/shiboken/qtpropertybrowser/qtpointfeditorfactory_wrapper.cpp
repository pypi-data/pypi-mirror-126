...
void QtPointFEditorFactoryWrapper::connectPropertyManager(QtPointFPropertyManager * manager)
{
    ...
    if (pyOverride.isNull()) {
        gil.release();
        this->::QtPointFEditorFactory::connectPropertyManager(manager);
        return;
    }

    Shiboken::AutoDecRef pyArgs(Py_BuildValue("(N)",
        Shiboken::Conversions::pointerToPython(reinterpret_cast<SbkObjectType *>(SbkqtpropertybrowserTypes[SBK_QTPOINTFPROPERTYMANAGER_IDX]), manager)
    ));
...
QWidget * QtPointFEditorFactoryWrapper::createAttributeEditor(QtPointFPropertyManager * manager, QtProperty * property, QWidget * parent, BrowserCol attribute)
{
    ...
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "QtPointFEditorFactory.createAttributeEditor", reinterpret_cast<PyTypeObject *>(Shiboken::SbkType< QWidget >())->tp_name, Py_TYPE(pyResult)->tp_name);
        return nullptr;
    }
    ::QWidget *cppResult;
...
QWidget * QtPointFEditorFactoryWrapper::createEditor(QtPointFPropertyManager * manager, QtProperty * property, QWidget * parent)
{
    ...
    PythonToCppFunc pythonToCpp = Shiboken::Conversions::isPythonToCppPointerConvertible(reinterpret_cast<SbkObjectType *>(SbkPySide2_QtWidgetsTypes[SBK_QWIDGET_IDX]), pyResult);
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "QtPointFEditorFactory.createEditor", reinterpret_cast<PyTypeObject *>(Shiboken::SbkType< QWidget >())->tp_name, Py_TYPE(pyResult)->tp_name);
        return nullptr;
    }
    ::QWidget *cppResult;
    pythonToCpp(pyResult, &cppResult);
...
void QtPointFEditorFactoryWrapper::disconnectPropertyManager(QtPointFPropertyManager * manager)
{
    ...
    if (pyOverride.isNull()) {
        gil.release();
        this->::QtPointFEditorFactory::disconnectPropertyManager(manager);
        return;
    }
...
Sbk_QtPointFEditorFactory_Init(PyObject *self, PyObject *args, PyObject *kwds)
{
    ...
    if (numArgs + numNamedArgs > 1) {
        PyErr_SetString(PyExc_TypeError, "qtpropertybrowser.QtPointFEditorFactory(): too many arguments");
        return -1;
    }
    ...
    // Call function/method
    {
        if (kwds) {
            ...
            if (value && pyArgs[0]) {
                PyErr_SetString(PyExc_TypeError, "qtpropertybrowser.QtPointFEditorFactory(): got multiple values for keyword argument 'parent'.");
                return -1;
                        } else if (value) {
                pyArgs[0] = value;
    ...
    Sbk_QtPointFEditorFactory_Init_TypeError:
        Shiboken::setErrorAboutWrongArguments(args, "qtpropertybrowser.QtPointFEditorFactory");
        return -1;
}

static PyObject *Sbk_QtPointFEditorFactoryFunc_connectPropertyManager(PyObject *self, PyObject *pyArg)
{
    QtPointFEditorFactoryWrapper *cppSelf = nullptr;
    SBK_UNUSED(cppSelf)
    if (!Shiboken::Object::isValid(self))
        return {};
    cppSelf = static_cast<QtPointFEditorFactoryWrapper *>(reinterpret_cast< ::QtPointFEditorFactory *>(Shiboken::Conversions::cppPointer(SbkqtpropertybrowserTypes[SBK_QTPOINTFEDITORFACTORY_IDX], reinterpret_cast<SbkObject *>(self))));
    int overloadId = -1;
    ...
    if ((pythonToCpp = Shiboken::Conversions::isPythonToCppPointerConvertible(reinterpret_cast<SbkObjectType *>(SbkqtpropertybrowserTypes[SBK_QTPOINTFPROPERTYMANAGER_IDX]), (pyArg)))) {
    ...
    Sbk_QtPointFEditorFactoryFunc_connectPropertyManager_TypeError:
        Shiboken::setErrorAboutWrongArguments(pyArg, "qtpropertybrowser.QtPointFEditorFactory.connectPropertyManager");
        return {};
}
...
static PyObject *Sbk_QtPointFEditorFactoryFunc_createAttributeEditor(PyObject *self, PyObject *args)
{
    ...
    // Overloaded function decisor
    // 0: QtPointFEditorFactory::createAttributeEditor(QtPointFPropertyManager*,QtProperty*,QWidget*,BrowserCol)
    if (numArgs == 4
        && (pythonToCpp[0] = Shiboken::Conversions::isPythonToCppPointerConvertible(reinterpret_cast<SbkObjectType *>(SbkqtpropertybrowserTypes[SBK_QTPOINTFPROPERTYMANAGER_IDX]), (pyArgs[0])))
    ...
    Sbk_QtPointFEditorFactoryFunc_createAttributeEditor_TypeError:
        Shiboken::setErrorAboutWrongArguments(args, "qtpropertybrowser.QtPointFEditorFactory.createAttributeEditor");
        return {};
}
...
static PyObject *Sbk_QtPointFEditorFactoryFunc_createEditor(PyObject *self, PyObject *args)
{
    ...
    // Overloaded function decisor
    // 0: QtPointFEditorFactory::createEditor(QtPointFPropertyManager*,QtProperty*,QWidget*)
    if (numArgs == 3
        && (pythonToCpp[0] = Shiboken::Conversions::isPythonToCppPointerConvertible(reinterpret_cast<SbkObjectType *>(SbkqtpropertybrowserTypes[SBK_QTPOINTFPROPERTYMANAGER_IDX]), (pyArgs[0])))
        && (pythonToCpp[1] = Shiboken::Conversions::isPythonToCppPointerConvertible(reinterpret_cast<SbkObjectType *>(SbkqtpropertybrowserTypes[SBK_QTPROPERTY_IDX]), (pyArgs[1])))
        && (pythonToCpp[2] = Shiboken::Conversions::isPythonToCppPointerConvertible(reinterpret_cast<SbkObjectType *>(SbkPySide2_QtWidgetsTypes[SBK_QWIDGET_IDX]), (pyArgs[2])))) {
    ...
    Sbk_QtPointFEditorFactoryFunc_createEditor_TypeError:
        Shiboken::setErrorAboutWrongArguments(args, "qtpropertybrowser.QtPointFEditorFactory.createEditor");
        return {};
}
...
static PyObject *Sbk_QtPointFEditorFactoryFunc_disconnectPropertyManager(PyObject *self, PyObject *pyArg)
{
    ...
    Sbk_QtPointFEditorFactoryFunc_disconnectPropertyManager_TypeError:
        Shiboken::setErrorAboutWrongArguments(pyArg, "qtpropertybrowser.QtPointFEditorFactory.disconnectPropertyManager");
        return {};
}

static PyMethodDef Sbk_QtPointFEditorFactory_methods[] = {
    {"connectPropertyManager", reinterpret_cast<PyCFunction>(Sbk_QtPointFEditorFactoryFunc_connectPropertyManager), METH_O},
    {"createAttributeEditor", reinterpret_cast<PyCFunction>(Sbk_QtPointFEditorFactoryFunc_createAttributeEditor), METH_VARARGS},
    {"createEditor", reinterpret_cast<PyCFunction>(Sbk_QtPointFEditorFactoryFunc_createEditor), METH_VARARGS},
    {"disconnectPropertyManager", reinterpret_cast<PyCFunction>(Sbk_QtPointFEditorFactoryFunc_disconnectPropertyManager), METH_O},
...
// Class Definition -----------------------------------------------
extern "C" {
static SbkObjectType *_Sbk_QtPointFEditorFactory_Type = nullptr;
static SbkObjectType *Sbk_QtPointFEditorFactory_TypeF(void)
{
...
static PyType_Spec Sbk_QtPointFEditorFactory_spec = {
    "qtpropertybrowser.QtPointFEditorFactory",
    sizeof(SbkObject),
    0,
...
static PythonToCppFunc is_QtPointFEditorFactory_PythonToCpp_QtPointFEditorFactory_PTR_Convertible(PyObject *pyIn) {
    ...
    if (PyObject_TypeCheck(pyIn, reinterpret_cast<PyTypeObject *>(Sbk_QtPointFEditorFactory_TypeF())))
...
static const char *QtPointFEditorFactory_SignatureStrings[] = {
    "qtpropertybrowser.QtPointFEditorFactory(parent:PySide2.QtCore.QObject=nullptr)",
    "qtpropertybrowser.QtPointFEditorFactory.connectPropertyManager(manager:qtpropertybrowser.QtPointFPropertyManager)",
    "qtpropertybrowser.QtPointFEditorFactory.createAttributeEditor(manager:qtpropertybrowser.QtPointFPropertyManager,property:qtpropertybrowser.QtProperty,parent:PySide2.QtWidgets.QWidget,attribute:qtpropertybrowser.BrowserCol)->PySide2.QtWidgets.QWidget",
    "qtpropertybrowser.QtPointFEditorFactory.createEditor(manager:qtpropertybrowser.QtPointFPropertyManager,property:qtpropertybrowser.QtProperty,parent:PySide2.QtWidgets.QWidget)->PySide2.QtWidgets.QWidget",
    "qtpropertybrowser.QtPointFEditorFactory.disconnectPropertyManager(manager:qtpropertybrowser.QtPointFPropertyManager)",
    nullptr}; // Sentinel
...
void init_QtPointFEditorFactory(PyObject *module)
{
    _Sbk_QtPointFEditorFactory_Type = Shiboken::ObjectType::introduceWrapperType(
        ...
        QtPointFEditorFactory_SignatureStrings,
        &Shiboken::callCppDestructor< ::QtPointFEditorFactory >,
        0,
        0,
        0    );
    
    SbkqtpropertybrowserTypes[SBK_QTPOINTFEDITORFACTORY_IDX]
        = reinterpret_cast<PyTypeObject *>(Sbk_QtPointFEditorFactory_TypeF());

    // Register Converter
    SbkConverter *converter = Shiboken::Conversions::createConverter(Sbk_QtPointFEditorFactory_TypeF(),
