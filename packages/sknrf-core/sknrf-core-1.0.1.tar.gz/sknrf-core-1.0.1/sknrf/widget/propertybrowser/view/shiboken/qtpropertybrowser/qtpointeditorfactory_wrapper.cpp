...
void QtPointEditorFactoryWrapper::connectPropertyManager(QtPointPropertyManager * manager)
{
    ...
    if (pyOverride.isNull()) {
        gil.release();
        this->::QtPointEditorFactory::connectPropertyManager(manager);
        return;
    }

    Shiboken::AutoDecRef pyArgs(Py_BuildValue("(N)",
        Shiboken::Conversions::pointerToPython(reinterpret_cast<SbkObjectType *>(SbkqtpropertybrowserTypes[SBK_QTPOINTPROPERTYMANAGER_IDX]), manager)
    ));
...
QWidget * QtPointEditorFactoryWrapper::createAttributeEditor(QtPointPropertyManager * manager, QtProperty * property, QWidget * parent, BrowserCol attribute)
{
    ...
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "QtPointEditorFactory.createAttributeEditor", reinterpret_cast<PyTypeObject *>(Shiboken::SbkType< QWidget >())->tp_name, Py_TYPE(pyResult)->tp_name);
        return nullptr;
    }
    ::QWidget *cppResult;
...
QWidget * QtPointEditorFactoryWrapper::createEditor(QtPointPropertyManager * manager, QtProperty * property, QWidget * parent)
{
    ...
    PythonToCppFunc pythonToCpp = Shiboken::Conversions::isPythonToCppPointerConvertible(reinterpret_cast<SbkObjectType *>(SbkPySide2_QtWidgetsTypes[SBK_QWIDGET_IDX]), pyResult);
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "QtPointEditorFactory.createEditor", reinterpret_cast<PyTypeObject *>(Shiboken::SbkType< QWidget >())->tp_name, Py_TYPE(pyResult)->tp_name);
        return nullptr;
    }
    ::QWidget *cppResult;
    pythonToCpp(pyResult, &cppResult);
...
void QtPointEditorFactoryWrapper::disconnectPropertyManager(QtPointPropertyManager * manager)
{
    ...
    if (pyOverride.isNull()) {
        gil.release();
        this->::QtPointEditorFactory::disconnectPropertyManager(manager);
        return;
    }
...
Sbk_QtPointEditorFactory_Init(PyObject *self, PyObject *args, PyObject *kwds)
{
    ...
    if (numArgs + numNamedArgs > 1) {
        PyErr_SetString(PyExc_TypeError, "qtpropertybrowser.QtPointEditorFactory(): too many arguments");
        return -1;
    }
    ...
    // Call function/method
    {
        if (kwds) {
            ...
            if (value && pyArgs[0]) {
                PyErr_SetString(PyExc_TypeError, "qtpropertybrowser.QtPointEditorFactory(): got multiple values for keyword argument 'parent'.");
                return -1;
                        } else if (value) {
                pyArgs[0] = value;
    ...
    Sbk_QtPointEditorFactory_Init_TypeError:
        Shiboken::setErrorAboutWrongArguments(args, "qtpropertybrowser.QtPointEditorFactory");
        return -1;
}

static PyObject *Sbk_QtPointEditorFactoryFunc_connectPropertyManager(PyObject *self, PyObject *pyArg)
{
    QtPointEditorFactoryWrapper *cppSelf = nullptr;
    SBK_UNUSED(cppSelf)
    if (!Shiboken::Object::isValid(self))
        return {};
    cppSelf = static_cast<QtPointEditorFactoryWrapper *>(reinterpret_cast< ::QtPointEditorFactory *>(Shiboken::Conversions::cppPointer(SbkqtpropertybrowserTypes[SBK_QTPOINTEDITORFACTORY_IDX], reinterpret_cast<SbkObject *>(self))));
    int overloadId = -1;
    ...
    if ((pythonToCpp = Shiboken::Conversions::isPythonToCppPointerConvertible(reinterpret_cast<SbkObjectType *>(SbkqtpropertybrowserTypes[SBK_QTPOINTPROPERTYMANAGER_IDX]), (pyArg)))) {
    ...
    Sbk_QtPointEditorFactoryFunc_connectPropertyManager_TypeError:
        Shiboken::setErrorAboutWrongArguments(pyArg, "qtpropertybrowser.QtPointEditorFactory.connectPropertyManager");
        return {};
}
...
static PyObject *Sbk_QtPointEditorFactoryFunc_createAttributeEditor(PyObject *self, PyObject *args)
{
    ...
    // Overloaded function decisor
    // 0: QtPointEditorFactory::createAttributeEditor(QtPointPropertyManager*,QtProperty*,QWidget*,BrowserCol)
    if (numArgs == 4
        && (pythonToCpp[0] = Shiboken::Conversions::isPythonToCppPointerConvertible(reinterpret_cast<SbkObjectType *>(SbkqtpropertybrowserTypes[SBK_QTPOINTPROPERTYMANAGER_IDX]), (pyArgs[0])))
    ...
    Sbk_QtPointEditorFactoryFunc_createAttributeEditor_TypeError:
        Shiboken::setErrorAboutWrongArguments(args, "qtpropertybrowser.QtPointEditorFactory.createAttributeEditor");
        return {};
}
...
static PyObject *Sbk_QtPointEditorFactoryFunc_createEditor(PyObject *self, PyObject *args)
{
    ...
    // Overloaded function decisor
    // 0: QtPointEditorFactory::createEditor(QtPointPropertyManager*,QtProperty*,QWidget*)
    if (numArgs == 3
        && (pythonToCpp[0] = Shiboken::Conversions::isPythonToCppPointerConvertible(reinterpret_cast<SbkObjectType *>(SbkqtpropertybrowserTypes[SBK_QTPOINTPROPERTYMANAGER_IDX]), (pyArgs[0])))
        && (pythonToCpp[1] = Shiboken::Conversions::isPythonToCppPointerConvertible(reinterpret_cast<SbkObjectType *>(SbkqtpropertybrowserTypes[SBK_QTPROPERTY_IDX]), (pyArgs[1])))
        && (pythonToCpp[2] = Shiboken::Conversions::isPythonToCppPointerConvertible(reinterpret_cast<SbkObjectType *>(SbkPySide2_QtWidgetsTypes[SBK_QWIDGET_IDX]), (pyArgs[2])))) {
    ...
    Sbk_QtPointEditorFactoryFunc_createEditor_TypeError:
        Shiboken::setErrorAboutWrongArguments(args, "qtpropertybrowser.QtPointEditorFactory.createEditor");
        return {};
}
...
static PyObject *Sbk_QtPointEditorFactoryFunc_disconnectPropertyManager(PyObject *self, PyObject *pyArg)
{
    ...
    Sbk_QtPointEditorFactoryFunc_disconnectPropertyManager_TypeError:
        Shiboken::setErrorAboutWrongArguments(pyArg, "qtpropertybrowser.QtPointEditorFactory.disconnectPropertyManager");
        return {};
}

static PyMethodDef Sbk_QtPointEditorFactory_methods[] = {
    {"connectPropertyManager", reinterpret_cast<PyCFunction>(Sbk_QtPointEditorFactoryFunc_connectPropertyManager), METH_O},
    {"createAttributeEditor", reinterpret_cast<PyCFunction>(Sbk_QtPointEditorFactoryFunc_createAttributeEditor), METH_VARARGS},
    {"createEditor", reinterpret_cast<PyCFunction>(Sbk_QtPointEditorFactoryFunc_createEditor), METH_VARARGS},
    {"disconnectPropertyManager", reinterpret_cast<PyCFunction>(Sbk_QtPointEditorFactoryFunc_disconnectPropertyManager), METH_O},
...
// Class Definition -----------------------------------------------
extern "C" {
static SbkObjectType *_Sbk_QtPointEditorFactory_Type = nullptr;
static SbkObjectType *Sbk_QtPointEditorFactory_TypeF(void)
{
...
static PyType_Spec Sbk_QtPointEditorFactory_spec = {
    "qtpropertybrowser.QtPointEditorFactory",
    sizeof(SbkObject),
    0,
...
static PythonToCppFunc is_QtPointEditorFactory_PythonToCpp_QtPointEditorFactory_PTR_Convertible(PyObject *pyIn) {
    ...
    if (PyObject_TypeCheck(pyIn, reinterpret_cast<PyTypeObject *>(Sbk_QtPointEditorFactory_TypeF())))
...
static const char *QtPointEditorFactory_SignatureStrings[] = {
    "qtpropertybrowser.QtPointEditorFactory(parent:PySide2.QtCore.QObject=nullptr)",
    "qtpropertybrowser.QtPointEditorFactory.connectPropertyManager(manager:qtpropertybrowser.QtPointPropertyManager)",
    "qtpropertybrowser.QtPointEditorFactory.createAttributeEditor(manager:qtpropertybrowser.QtPointPropertyManager,property:qtpropertybrowser.QtProperty,parent:PySide2.QtWidgets.QWidget,attribute:qtpropertybrowser.BrowserCol)->PySide2.QtWidgets.QWidget",
    "qtpropertybrowser.QtPointEditorFactory.createEditor(manager:qtpropertybrowser.QtPointPropertyManager,property:qtpropertybrowser.QtProperty,parent:PySide2.QtWidgets.QWidget)->PySide2.QtWidgets.QWidget",
    "qtpropertybrowser.QtPointEditorFactory.disconnectPropertyManager(manager:qtpropertybrowser.QtPointPropertyManager)",
    nullptr}; // Sentinel
...
void init_QtPointEditorFactory(PyObject *module)
{
    _Sbk_QtPointEditorFactory_Type = Shiboken::ObjectType::introduceWrapperType(
        ...
        QtPointEditorFactory_SignatureStrings,
        &Shiboken::callCppDestructor< ::QtPointEditorFactory >,
        0,
        0,
        0    );
    
    SbkqtpropertybrowserTypes[SBK_QTPOINTEDITORFACTORY_IDX]
        = reinterpret_cast<PyTypeObject *>(Sbk_QtPointEditorFactory_TypeF());

    // Register Converter
    SbkConverter *converter = Shiboken::Conversions::createConverter(Sbk_QtPointEditorFactory_TypeF(),
