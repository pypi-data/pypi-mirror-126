...
class HubController:
	...
	def put_channel_sku_status(self, sku_id: str, channel_status: ChannelStatus):
		return requests.put(f'{self.__get_endpoint_base()}/channels/skus/{sku_id}/status', headers=self.headers, data=unpack_payload_dict(channel_status,remove_null=True))
