...
class Identification:
	...
	def get_value(self) -> enums.IecDevId:
		...
		RsAreg.System.language. Note: While working in an emulation mode, the R&S AREG100A specific command set is disabled, that
		is, the SCPI command method RsAreg.System.Identification.value is discarded. \n
