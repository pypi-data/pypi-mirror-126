...
def generate_random_password(include_semicolons: bool = False, include_braces: bool = False):
    punctuation = '!@#$%^&*()_-+=[]:>|./?'
...
def merge_client_config(client_config: dict, default_config: dict):
    ...
    for k, v in client_config.items():
        if isinstance(v, dict):
            ...
            merged[k] = merge_client_config(client_config[k], default_config[k])
