...
class RbacHandler(HandlerBase, IRbacHandler):
    def __init__(self, app_config: AppConfig,  env_config: EnvironmentConfig, rbac_manager: IAzRbacManager):
        HandlerBase.__init__(self, app_config=app_config)
        self.env_config = env_config
        self.__rbac_manager = rbac_manager
        self.rbac_policies_from_config = self.env_config.rbac_policies
