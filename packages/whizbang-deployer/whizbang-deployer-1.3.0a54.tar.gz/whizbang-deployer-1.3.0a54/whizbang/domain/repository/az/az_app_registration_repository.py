    ...
    def add_group_members_as_owner(self, app_id: str, group_object_id: str) -> None:
        ...
        for group_member in group_members:
            if group_member.object_type == 'User':
                ...
                print(f'added {group_member.display_name} with object id: {group_member.object_id} '
                      f'as owner to app registration with app id: {app_id}')
            else:
                print(f'adding object of type {group_member.object_type} as owner to service principal is not supported')
