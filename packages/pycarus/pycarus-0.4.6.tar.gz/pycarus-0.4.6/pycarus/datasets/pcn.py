...
class PCN(Dataset):
    ...
    def __getitem__(self, index: int) -> T_ITEM:
        ...
        path_partial = self.root / self.split / "partial" / path_to_end
        pcd_o3d = open3d.io.read_point_cloud(str(path_partial))
        partial = torch.tensor(pcd_o3d.points, dtype=torch.float)
    ...
    def show_item(cls, sample: T_ITEM) -> open3d.geometry.PointCloud:
        ...
        pcd_partial = get_o3d_pcd_from_tensor(partial)
