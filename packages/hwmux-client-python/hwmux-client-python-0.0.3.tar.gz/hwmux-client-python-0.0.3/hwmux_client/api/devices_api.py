...
class DevicesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.devices_create_endpoint = _Endpoint(
            settings={
                'response_type': (DeviceSerializerWithPermissions,),
                'auth': [
                    'cookieAuth',
                    'tokenAuth'
                ],
            ...
            params_map={
                'all': [
                    'device_serializer_with_permissions',
                ],
                'required': [
                    'device_serializer_with_permissions',
                ],
            ...
            root_map={
                ...
                'openapi_types': {
                    'device_serializer_with_permissions':
                        (DeviceSerializerWithPermissions,),
                },
                'attribute_map': {
                },
                'location_map': {
                    'device_serializer_with_permissions': 'body',
                },
        ...
        self.devices_list_my_retrieve_endpoint = _Endpoint(
            settings={
                'response_type': (PaginatedDeviceSerializerPrivateList,),
                'auth': [
                    'cookieAuth',
                ...
                'operation_id': 'devices_list_my_retrieve',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.devices_partial_update_endpoint = _Endpoint(
            ...
            params_map={
                'all': [
                    'id',
                    'patched_device_serializer_with_permissions',
                ],
                'required': [
                    'id',
                ],
            ...
            root_map={
                ...
                'openapi_types': {
                    'id':
                        (int,),
                    'patched_device_serializer_with_permissions':
                        (PatchedDeviceSerializerWithPermissions,),
                },
                'attribute_map': {
                    'id': 'id',
                },
                'location_map': {
                    'id': 'path',
                    'patched_device_serializer_with_permissions': 'body',
                },
                'collection_format_map': {
                }
            },
        ...
        self.devices_search_retrieve_endpoint = _Endpoint(
            settings={
                'response_type': (PaginatedDeviceSerializerPrivateList,),
                'auth': [
                    'cookieAuth',
                ...
                'operation_id': 'devices_search_retrieve',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def devices_create(
        ...
        **kwargs
        ...
        >>> thread = api.devices_create(device_serializer_with_permissions, async_req=True)
        >>> result = thread.get()

        Args:
            device_serializer_with_permissions (DeviceSerializerWithPermissions):
        ...
        kwargs['device_serializer_with_permissions'] = \
            device_serializer_with_permissions
    ...
    def devices_list_my_retrieve(
        self,
        **kwargs
    ):
        """devices_list_my_retrieve  # noqa: E501

        Get devices owned by authenticated user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.devices_list_my_retrieve(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.devices_list_my_retrieve_endpoint.call_with_http_info(**kwargs)
    ...
    def devices_partial_update(
        ...
        **kwargs
        ...
        Keyword Args:
            patched_device_serializer_with_permissions (PatchedDeviceSerializerWithPermissions): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
    ...
    def devices_search_retrieve(
        self,
        search_key_value_pairs,
        **kwargs
    ):
        """devices_search_retrieve  # noqa: E501
        ...
        >>> thread = api.devices_search_retrieve(search_key_value_pairs, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['search_key_value_pairs'] = \
            search_key_value_pairs
        return self.devices_search_retrieve_endpoint.call_with_http_info(**kwargs)
    ...
    def devices_set_offline_create(
        ...
        **kwargs
        ...
        >>> thread = api.devices_set_offline_create(device_serializer_with_permissions, async_req=True)
        >>> result = thread.get()
    ...
    def devices_update(
        ...
        **kwargs
        ...
        >>> thread = api.devices_update(id, device_serializer_with_permissions, async_req=True)
        >>> result = thread.get()
