...
class SitesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.sites_rooms_locations_create_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/sites/{site_pk}/rooms/{room_pk}/locations/',
                'operation_id': 'sites_rooms_locations_create',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.sites_rooms_locations_partial_update_endpoint = _Endpoint(
            settings={
                'response_type': (Location,),
                'auth': [
                    'cookieAuth',
                ...
                'endpoint_path': '/api/sites/{site_pk}/rooms/{room_pk}/locations/{id}/',
                'operation_id': 'sites_rooms_locations_partial_update',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
        ...
        self.sites_rooms_locations_retrieve_endpoint = _Endpoint(
            settings={
                'response_type': (Location,),
                'auth': [
                    'cookieAuth',
                ...
                'endpoint_path': '/api/sites/{site_pk}/rooms/{room_pk}/locations/{id}/',
                'operation_id': 'sites_rooms_locations_retrieve',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.sites_rooms_locations_update_endpoint = _Endpoint(
            settings={
                'response_type': (Location,),
                'auth': [
                    'cookieAuth',
                ...
                'endpoint_path': '/api/sites/{site_pk}/rooms/{room_pk}/locations/{id}/',
                'operation_id': 'sites_rooms_locations_update',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
    ...
    def sites_rooms_locations_create(
        self,
        room_pk,
        site_pk,
        **kwargs
    ):
        """sites_rooms_locations_create  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.sites_rooms_locations_create(room_pk, site_pk, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['site_pk'] = \
            site_pk
        return self.sites_rooms_locations_create_endpoint.call_with_http_info(**kwargs)

    def sites_rooms_locations_partial_update(
        self,
        id,
        room_pk,
        site_pk,
        **kwargs
        ...
        """sites_rooms_locations_partial_update  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.sites_rooms_locations_partial_update(id, room_pk, site_pk, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            patched_location (PatchedLocation): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['site_pk'] = \
            site_pk
        return self.sites_rooms_locations_partial_update_endpoint.call_with_http_info(**kwargs)

    def sites_rooms_locations_retrieve(
        self,
        id,
        room_pk,
        site_pk,
        **kwargs
        ...
        """sites_rooms_locations_retrieve  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.sites_rooms_locations_retrieve(id, room_pk, site_pk, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['site_pk'] = \
            site_pk
        return self.sites_rooms_locations_retrieve_endpoint.call_with_http_info(**kwargs)

    def sites_rooms_locations_update(
        self,
        id,
        room_pk,
        site_pk,
        **kwargs
        ...
        """sites_rooms_locations_update  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.sites_rooms_locations_update(id, room_pk, site_pk, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['site_pk'] = \
            site_pk
        return self.sites_rooms_locations_update_endpoint.call_with_http_info(**kwargs)
