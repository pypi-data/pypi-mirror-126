...
class DeviceSerializerPrivate(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'session': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, owner, location, part, loc_desc, last_update, date_created, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            session ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, location, part, *args, **kwargs):  # noqa: E501
        """DeviceSerializerPrivate - a model defined in OpenAPI
