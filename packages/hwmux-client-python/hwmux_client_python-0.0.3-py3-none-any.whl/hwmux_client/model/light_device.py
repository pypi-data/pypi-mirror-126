...
class LightDevice(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'part': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, sn_or_name, uri, is_wstk, metadata, online, part, location, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            online (bool):
            part (bool, date, datetime, dict, float, int, list, str, none_type):
            location (str):
