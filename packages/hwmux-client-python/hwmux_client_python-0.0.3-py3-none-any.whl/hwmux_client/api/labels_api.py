...
class LabelsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.labels_create_endpoint = _Endpoint(
            settings={
                'response_type': (LabelSerializerWithGroupAsPk,),
                'auth': [
                    'cookieAuth',
                    'tokenAuth'
                ],
            ...
            params_map={
                'all': [
                    'label_serializer_with_group_as_pk',
                ],
                'required': [
                    'label_serializer_with_group_as_pk',
                ],
            ...
            root_map={
                ...
                'openapi_types': {
                    'label_serializer_with_group_as_pk':
                        (LabelSerializerWithGroupAsPk,),
                },
                'attribute_map': {
                },
                'location_map': {
                    'label_serializer_with_group_as_pk': 'body',
                },
        ...
        self.labels_partial_update_endpoint = _Endpoint(
            ...
            params_map={
                'all': [
                    'id',
                    'patched_label_serializer_with_group_as_pk',
                ],
                'required': [
                    'id',
                ],
            ...
            root_map={
                ...
                'openapi_types': {
                    'id':
                        (int,),
                    'patched_label_serializer_with_group_as_pk':
                        (PatchedLabelSerializerWithGroupAsPk,),
                },
                'attribute_map': {
                    'id': 'id',
                },
                'location_map': {
                    'id': 'path',
                    'patched_label_serializer_with_group_as_pk': 'body',
                },
                'collection_format_map': {
                }
            },
        ...
        self.labels_release_all_update_endpoint = _Endpoint(
            settings={
                'response_type': (LabelSerializerWithGroupAsPk,),
                'auth': [
                    'cookieAuth',
                ...
                'endpoint_path': '/api/labels/{id}/release_all/',
                'operation_id': 'labels_release_all_update',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
        ...
        self.labels_reserve_all_update_endpoint = _Endpoint(
            settings={
                'response_type': (LabelSerializerWithGroupAsPk,),
                'auth': [
                    'cookieAuth',
                ...
                'endpoint_path': '/api/labels/{id}/reserve_all/',
                'operation_id': 'labels_reserve_all_update',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
    ...
    def labels_create(
        ...
        **kwargs
        ...
        >>> thread = api.labels_create(label_serializer_with_group_as_pk, async_req=True)
        >>> result = thread.get()

        Args:
            label_serializer_with_group_as_pk (LabelSerializerWithGroupAsPk):
        ...
        kwargs['label_serializer_with_group_as_pk'] = \
            label_serializer_with_group_as_pk
    ...
    def labels_partial_update(
        ...
        **kwargs
        ...
        Keyword Args:
            patched_label_serializer_with_group_as_pk (PatchedLabelSerializerWithGroupAsPk): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
    ...
    def labels_release_all_update(
        self,
        id,
        **kwargs
    ):
        """labels_release_all_update  # noqa: E501

        Viewset for DeviceGroup model  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.labels_release_all_update(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.labels_release_all_update_endpoint.call_with_http_info(**kwargs)

    def labels_reserve_all_update(
        self,
        id,
        **kwargs
    ):
        """labels_reserve_all_update  # noqa: E501

        Viewset for DeviceGroup model  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.labels_reserve_all_update(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.labels_reserve_all_update_endpoint.call_with_http_info(**kwargs)
    ...
    def labels_update(
        ...
        **kwargs
        ...
        >>> thread = api.labels_update(id, label_serializer_with_group_as_pk, async_req=True)
        >>> result = thread.get()
