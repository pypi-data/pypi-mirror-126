...
_LISTSCHEMASREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=b'\340A\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='handle', full_name='streammachine.api.schemas.v1.ListSchemasRequest.handle', index=2,
      ...
      serialized_options=b'\340A\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='name', full_name='streammachine.api.schemas.v1.ListSchemasRequest.name', index=3,
      ...
      serialized_options=b'\340A\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='public_private', full_name='streammachine.api.schemas.v1.ListSchemasRequest.public_private', index=4,
      ...
      serialized_options=b'\340A\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='schema_type', full_name='streammachine.api.schemas.v1.ListSchemasRequest.schema_type', index=5,
      ...
      serialized_options=b'\340A\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='labels', full_name='streammachine.api.schemas.v1.ListSchemasRequest.labels', index=6,
      ...
      serialized_options=b'\340A\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='domains', full_name='streammachine.api.schemas.v1.ListSchemasRequest.domains', index=7,
      ...
      serialized_options=b'\340A\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='industries', full_name='streammachine.api.schemas.v1.ListSchemasRequest.industries', index=8,
...
_GETSCHEMARESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='checksum', full_name='streammachine.api.schemas.v1.GetSchemaResponse.checksum', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CREATESCHEMARESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='checksum', full_name='streammachine.api.schemas.v1.CreateSchemaResponse.checksum', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_UPDATESCHEMAREQUEST = _descriptor.Descriptor(
  ...
  full_name='streammachine.api.schemas.v1.UpdateSchemaRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='billing_id', full_name='streammachine.api.schemas.v1.UpdateSchemaRequest.billing_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\340A\002', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='schema', full_name='streammachine.api.schemas.v1.UpdateSchemaRequest.schema', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\340A\002', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='checksum', full_name='streammachine.api.schemas.v1.UpdateSchemaRequest.checksum', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\340A\002', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='update_mask', full_name='streammachine.api.schemas.v1.UpdateSchemaRequest.update_mask', index=3,
...
_UPDATESCHEMARESPONSE = _descriptor.Descriptor(
  ...
  full_name='streammachine.api.schemas.v1.UpdateSchemaResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='schema', full_name='streammachine.api.schemas.v1.UpdateSchemaResponse.schema', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='checksum', full_name='streammachine.api.schemas.v1.UpdateSchemaResponse.checksum', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LISTSCHEMASREQUEST.fields_by_name['public_private'].enum_type = streammachine_dot_api_dot_entities_dot_v1_dot_entities__v1__pb2._FILTERPUBLICPRIVATE
_LISTSCHEMASREQUEST.fields_by_name['schema_type'].enum_type = streammachine_dot_api_dot_entities_dot_v1_dot_entities__v1__pb2._SCHEMATYPE
_LISTSCHEMASREQUEST.fields_by_name['labels'].message_type = streammachine_dot_api_dot_entities_dot_v1_dot_entities__v1__pb2._LABEL
...
_UPDATESCHEMAREQUEST.fields_by_name['schema'].message_type = streammachine_dot_api_dot_entities_dot_v1_dot_entities__v1__pb2._SCHEMA
_UPDATESCHEMAREQUEST.fields_by_name['update_mask'].message_type = google_dot_protobuf_dot_field__mask__pb2._FIELDMASK
_UPDATESCHEMARESPONSE.fields_by_name['schema'].message_type = streammachine_dot_api_dot_entities_dot_v1_dot_entities__v1__pb2._SCHEMA
...
UpdateSchemaRequest = _reflection.GeneratedProtocolMessageType('UpdateSchemaRequest', (_message.Message,), {
  ...
  '__module__' : 'streammachine.api.schemas.v1.schemas_v1_pb2'
  # @@protoc_insertion_point(class_scope:streammachine.api.schemas.v1.UpdateSchemaRequest)
  })
...
UpdateSchemaResponse = _reflection.GeneratedProtocolMessageType('UpdateSchemaResponse', (_message.Message,), {
  ...
  '__module__' : 'streammachine.api.schemas.v1.schemas_v1_pb2'
  # @@protoc_insertion_point(class_scope:streammachine.api.schemas.v1.UpdateSchemaResponse)
  })
...
_SCHEMASSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='UpdateSchema',
    full_name='streammachine.api.schemas.v1.SchemasService.UpdateSchema',
    index=3,
    containing_service=None,
