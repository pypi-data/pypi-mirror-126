...
class SagemakerEdgeManagerClient(BaseClient):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.19.11/reference/services/sagemaker-edge.html#SagemakerEdgeManager.Client)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.19.11/reference/services/sagemaker-edge.html#SagemakerEdgeManager.Client.can_paginate)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.19.11/reference/services/sagemaker-edge.html#SagemakerEdgeManager.Client.generate_presigned_url)
    ...
    def get_device_registration(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.19.11/reference/services/sagemaker-edge.html#SagemakerEdgeManager.Client.get_device_registration)
    ...
    def send_heartbeat(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.19.11/reference/services/sagemaker-edge.html#SagemakerEdgeManager.Client.send_heartbeat)
