...
setup(
    name='C3l3br1t1es-B1rth5-123142143523415', ## This will be the name your package will be published with
    version='0.0.1', 
    description='Mock package that allows you to find celebrity by date of birth',
    url='https://github.com/faizmeghjee/C3l3br1t1es-B1rth5-123142143523415.git', # Add the URL of your github repo if published 
                                                                   # in GitHub
    author='Room 18', # Your name
    license='MIT',
