...
from aliyunsdkcs.request.v20151215.DescribeClusterExtInfoRequest import DescribeClusterExtInfoRequest
...
class CsClient(AliCloudClient):
    ...
    def describe_detail_clusters(self, query_params=None, body_params=None):
        return self.do_request(DescribeClusterExtInfoRequest, query_params, body_params)
