...
class Lumekentta(models.fields.Field):
  ...
  #@classproperty
  #def descriptor_class(cls):
  #  # pylint: disable=no-self-argument, invalid-name, function-redefined
  #  super_descriptor_class = super().descriptor_class
  #  @functools.wraps(super_descriptor_class, updated=())
  #  class descriptor_class(
  #    #LumeFM2OMaare if issubclass(
  #    #  super_descriptor_class,
