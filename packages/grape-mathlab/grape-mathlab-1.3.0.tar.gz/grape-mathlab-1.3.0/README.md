...
**GRAPE** requires `numpy`, `scipy`, `matplotlib`, `networkx`, `nose`, `pandas`, `deap` (for local test) and `sphinx` (to generate the documentation). The code is compatible with Python 3.6, NetworkX 2.5, Pandas 1.1 and DEAP 1.3.
