...
def main():
    ...
    if platform.system() == "Linux":
        kudu_pkg_dir = os.path.join(pkg_resources.get_distribution("sol-warp").location, "bin/linux/kudu")
    elif platform.system() == "Darwin":
        kudu_pkg_dir = os.path.join(pkg_resources.get_distribution("sol-warp").location, "bin/macos/kudu")
