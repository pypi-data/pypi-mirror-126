...
def get_clone_modules_list(api_inputs: ApiInputs, parent_module_id: uuid.UUID, search_filter="*"):
    ...
    url = f"{api_inputs.api_projects_endpoint}/{api_inputs.api_project_id}/analytics/logic-modules-clones/parent-module/{parent_module_id}"
...
def sensor_has_not_changed(api_inputs: ApiInputs, start_date: datetime.date, end_date: datetime.date, templates: List[str] = None, hours_unchanged: int = 24):
