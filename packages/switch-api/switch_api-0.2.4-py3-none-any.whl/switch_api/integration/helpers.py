...
def get_templates(api_inputs: ApiInputs, object_property_type: str = None):
    ...
    if object_property_type is None:
        ...
        url = f"{api_inputs.api_projects_endpoint}/{api_inputs.api_project_id}/data-ingestion/templates?type={object_property_type}"
...
def get_units_of_measure(api_inputs: ApiInputs, object_property_type: str = None):
    ...
    if object_property_type is None:
        ...
        url = f"{api_inputs.api_projects_endpoint}/{api_inputs.api_project_id}/data-ingestion/units?type={object_property_type}"
...
def get_equipment_classes(api_inputs: ApiInputs):
    ...
    url = f"{api_inputs.api_projects_endpoint}/{api_inputs.api_project_id}/installation/00000000-0000-0000-0000-000000000000/equipment/integration-classes"
