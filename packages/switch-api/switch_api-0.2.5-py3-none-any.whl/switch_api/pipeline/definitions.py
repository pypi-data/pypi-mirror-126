...
from .._utils._utils import (ApiInputs, convert_to_pascal_case, DiscoveryIntegrationInput)
...
class IntegrationSettings(BaseProperty):
    """Class used for definining the UI editors, default values, etc for the key-values passed to integration_settings
    dictionaries. """
    def __init__(self, property_name, display_label, editor, default_value, allowed_values):
        """
...
#       #           raise ValueError(f"unit_of_measure can only be set to None if the is_configuration parameter is set to "
#       #                            f"True. ")
#
#     @property
