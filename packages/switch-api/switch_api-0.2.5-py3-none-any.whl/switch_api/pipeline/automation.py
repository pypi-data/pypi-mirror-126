...
class Automation:
    ...
    def deploy_as_ftp_data_feed(task, api_inputs: ApiInputs, ftp_user_name, ftp_password,
                                ...
                                data_feed_name: str = None, data_feed_id: uuid.UUID = None):
    ...
    def cancel_deployed_data_feed(api_inputs: ApiInputs, data_feed_id: uuid.UUID, deployment_type: List[DEPLOY_TYPE]):
        ...
        logger.info("Cancel deployment type/s with DataFeedID: %s for ApiProjectID: %s", data_feed_id, api_inputs.api_project_id)
    ...
    def delete_deployed_data_feed(api_inputs: ApiInputs, data_feed_id: uuid.UUID):
        ...
        url = f"{api_inputs.api_projects_endpoint}/{api_inputs.api_project_id}/data-ingestion/deployment/{data_feed_id}/delete"

        logger.info("Delete deployment with DataFeedID: %s for ApiProjectID: %s", data_feed_id, api_inputs.api_project_id)
        logger.info("Sending request: POST %s", url)
