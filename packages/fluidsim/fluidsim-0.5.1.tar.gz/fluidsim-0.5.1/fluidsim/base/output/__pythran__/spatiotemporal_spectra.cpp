...
namespace __pythran_spatiotemporal_spectra
{
  ...
  typename get_arange_minmax::type<argument_type0, argument_type1, argument_type2>::result_type get_arange_minmax::operator()(argument_type0&& times, argument_type1&& tmin, argument_type2&& tmax) const
  {
    ...
    typedef find_index_first_g __type4;
    typedef typename std::remove_cv<typename std::remove_reference<argument_type2>::type>::type __type6;
    typedef decltype(std::declval<__type4>()(std::declval<__type1>(), std::declval<__type6>())) __type7;
    ...
    typedef find_index_first_geq __type12;
    typedef typename std::remove_cv<typename std::remove_reference<argument_type1>::type>::type __type14;
    typedef decltype(std::declval<__type12>()(std::declval<__type1>(), std::declval<__type14>())) __type15;
    typedef typename pythonic::lazy<__type15>::type __type16;
    typedef typename __combined<__type11,__type16>::type __type17;
    typename pythonic::lazy<__type9>::type stop;
    typename pythonic::lazy<__type17>::type start;
...
PYTHRAN_MODULE_INIT(spatiotemporal_spectra)(void) {
    ...
    PyObject * theDoc = Py_BuildValue("(sss)",
                                      "0.10.0",
                                      "2021-10-13 17:31:41.832817",
                                      "c65f59ada09566d4bdf0ef447716df21d3ff8f5491e5d81818d77c5cd05013e7");
    if(! theDoc)
        PYTHRAN_RETURN;
