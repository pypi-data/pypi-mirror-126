...
namespace __pythran_operators3d
{
  ...
  struct dealiasing_variable
  {
    ...
    struct type
    {
      ...
      typedef typename std::remove_cv<typename std::remove_reference<argument_type0>::type>::type __type2;
      typedef container<typename std::remove_reference<__type0>::type> __type3;
  ...
  typename dealiasing_variable::type<argument_type0, argument_type1>::result_type dealiasing_variable::operator()(argument_type0&& ff_fft, argument_type1&& where_dealiased) const
  {
    ...
    {
      long  __target139889763902320 = n0;
      for (long  i0=0L; i0 < __target139889763902320; i0 += 1L)
      {
        {
          long  __target139889762637472 = n1;
          for (long  i1=0L; i1 < __target139889762637472; i1 += 1L)
          {
            {
              long  __target139889762638288 = n2;
              for (long  i2=0L; i2 < __target139889762638288; i2 += 1L)
              {
  ...
  typename dealiasing_setofvar::type<argument_type0, argument_type1>::result_type dealiasing_setofvar::operator()(argument_type0&& sov, argument_type1&& where_dealiased) const
  {
    ...
    {
      long  __target139889763824736 = n0;
      for (long  i0=0L; i0 < __target139889763824736; i0 += 1L)
      {
        {
          long  __target139889760622384 = n1;
          for (long  i1=0L; i1 < __target139889760622384; i1 += 1L)
          {
            {
              long  __target139889763901936 = n2;
              for (long  i2=0L; i2 < __target139889763901936; i2 += 1L)
              {
                if (where_dealiased[pythonic::types::make_tuple(i0, i1, i2)])
                {
                  {
                    long  __target139889763903088 = nk;
                    for (long  ik=0L; ik < __target139889763903088; ik += 1L)
                    {
    ...
    {NULL, NULL, 0, NULL}
            ...
            PYTHRAN_MODULE_INIT(operators3d)(void) {
                ...
                PyObject * theDoc = Py_BuildValue("(sss)",
                                                  "0.10.0",
                                                  "2021-10-13 17:32:03.533779",
                                                  "22fa738508607ed734342ace99d8c1d29c6ebf038d7dfca0c7142a3f29df3869");
                if(! theDoc)
                    PYTHRAN_RETURN;
