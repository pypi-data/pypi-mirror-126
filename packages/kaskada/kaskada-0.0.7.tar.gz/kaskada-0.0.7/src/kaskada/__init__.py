...
def init(client_id: str = os.getenv('KASKADA_CLIENT_ID'), client_secret: str = os.getenv('KASKADA_CLIENT_SECRET'), exchange_endpoint: str = 'prod-kaskada.us.auth0.com', audience: str = 'https://api.prod.kaskada.com', endpoint: str = 'api.kaskada.com:50051', is_secure: bool = True, demo: bool = False):
    """
    Initializes the Kaskada library with a client. Creating a client will update the default module default client.

    Args:
        client_id (str, optional): Kaskada Client ID. Defaults to os.getenv('KASKADA_CLIENT_ID').
        client_secret (str, optional): Kaskada Client Secret. Defaults to os.getenv('KASKADA_CLIENT_SECRET').
        exchange_endpoint (str, optional): Authentication endpoint to exchange JWTs. Defaults to 'prod-kaskada.us.auth0.com'.
        audience (str, optional): Authentication audience. Defaults to 'https://api.prod.kaskada.com'.
        endpoint (str, optional): API Endpoint. Defaults to 'api.kaskada.com:50051'.
...
def demo_only(client_id: str = 'lWYFx0020u4oulh7Z9UB8C5YXVRHNyk4', endpoint: str = 'api.kaskada.com:50051', is_secure: bool = True):
    """
    Initializes the Kaskada library with a demo only client.

    Args:
        client_id (str, optional): The demo only client ID. Defaults to 'lWYFx0020u4oulh7Z9UB8C5YXVRHNyk4'.
        exchange_endpoint (str, optional): Authentication endpoint to exchange JWTs. Defaults to 'prod-kaskada.us.auth0.com'.
        audience (str, optional): Authentication audience. Defaults to 'https://api.prod.kaskada.com'.
        endpoint (str, optional): API Endpoint. Defaults to 'api.kaskada.com:50051'.
        is_secure (bool, optional): Use SSL connection. Defaults to True.
...
def client(client_id: str = os.getenv('KASKADA_CLIENT_ID'), client_secret: str = os.getenv('KASKADA_CLIENT_SECRET'), exchange_endpoint: str = 'prod-kaskada.us.auth0.com', audience: str = 'https://api.prod.kaskada.com', endpoint: str = 'api.kaskada.com:50051', is_secure: bool = True) -> Client:
    """
