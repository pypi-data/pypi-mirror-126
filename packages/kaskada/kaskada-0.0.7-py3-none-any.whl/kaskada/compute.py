...
def query(query: str, with_tables: list[pb.WithTable] = [], with_views: list[pb.WithView] = [], result_behavior: str = 'all-results', response_as: str = 'parquet', data_token_id: str = None, limits: pb.QueryRequest.Limits = None, client: Client = None) -> pb.QueryResponse:
    """
    Performs a query
