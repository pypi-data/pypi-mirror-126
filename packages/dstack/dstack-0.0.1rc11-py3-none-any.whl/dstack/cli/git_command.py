...
def add_remote_func(args: Namespace):
    try:
...
def register_parsers(main_subparsers):
    parser = main_subparsers.add_parser("git", help="Manage Git repository settings")

    subparsers = parser.add_subparsers()

    remote_parser = subparsers.add_parser("remote", help="Manage remote repository settings")

    remote_subparsers = remote_parser.add_subparsers()

    parser = remote_subparsers.add_parser("add",
                                          help="Add a tracked remote repository and its credentials")
    ...
    parser.set_defaults(func=add_remote_func)
