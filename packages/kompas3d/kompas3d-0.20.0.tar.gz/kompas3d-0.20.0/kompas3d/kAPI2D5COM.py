...
IProcess2DNotify_vtables_ = [
	...
	(( 'AbortProcess' , ), 1610743816, (1610743816, (), [ ], 1 , 1 , 4 , 0 , 96 , (11, 0, None, None) , 0 , )),
]
...
IPropertyManagerNotify_vtables_ = [
	...
	(( 'DoubleClickItem' , 'Control' , 'Index' , ), 1610743826, (1610743826, (), [ (13, 0, None, None) , 
			 (3, 0, None, None) , ], 1 , 1 , 4 , 0 , 176 , (11, 0, None, None) , 0 , )),
]
