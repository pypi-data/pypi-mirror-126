...
def create_one_sensi_from_base(sensi_name, base_dir, sensi_path=None, logger=None):
    if sensi_path is not None:
        ...
        try:
            ...
            excluded = shutil.ignore_patterns("sensitivities", "executed", "settings_calibration.json", "settings_simulation.json", "RN_outputs", "RW_outputs", '*.zip', "*.log")
            shutil.copytree(base_dir, sensi_path, ignore=excluded)
