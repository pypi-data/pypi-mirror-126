...
class TickData:
    ...
    def __str__(self):
        return  "TickData: " + str(self.__dict__)
...
class ProductSnapshot:
    ...
    def __str__(self):
        return  "ProductSnapshot: " + str(self.__dict__)
    def __add__(self, other):
        return str(self) + other
    def __radd__(self, other):
        return other + str(self)
...
def decode_snapshot(data_map, market, json_data):
    ...
    for basic_raw in base_list:
        product = ProductSnapshot(market, basic_raw)
    ...
    for hl_raw in json_obj["HL"]:
        ...
        ProductSnapshot.appendHL(data_map[product], market, hl_raw)
...
if __name__ == "__main__":
    ...
    # mq.add_product("TWS", ["2330"], True, False)
