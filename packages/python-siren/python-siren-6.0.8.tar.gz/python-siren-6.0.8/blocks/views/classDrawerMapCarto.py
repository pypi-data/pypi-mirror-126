...
class CartoBase:
    ...
    def getCartoBackSetts(tcl, prefs):
        ...
        zorder = tcl.overlay_zorder if prefs["map_lines_overlay"] else None
        resolution = tcl.resolution_def
        if "map_resolution" in prefs and prefs["map_resolution"] in tcl.map_resolutions:
            resolution = tcl.map_resolutions[prefs["map_resolution"]]
...
class DrawerEntitiesMap(DrawerMap, DrawerEntitiesTD):
    pass


class DrawerClustMap(DrawerMap, DrawerClustTD):
    pass
