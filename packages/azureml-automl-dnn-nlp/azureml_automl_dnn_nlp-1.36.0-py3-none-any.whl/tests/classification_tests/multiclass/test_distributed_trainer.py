...
from azureml.automl.dnn.nlp.classification.multiclass.distributed_trainer import (
    DistributedTrainer,
...
class TestDistributedTrainerTests:
    ...
    @patch("horovod.torch.init")
    @patch("horovod.torch.local_size")
    @patch("azureml.automl.dnn.nlp.classification.multiclass.distributed_trainer.is_main_process")
