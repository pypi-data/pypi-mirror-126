...
class DistributedTrainingArguments(TrainingArguments):
    ...
    def __init__(self, training_args):
        """
        Funciton to initialize DistributedTrainingArguments similar to the TrainingArguments
...
class DistributedTrainer(Trainer):
    ...
    def __init__(self, model, args, train_dataset, tokenizer, data_collator):
        """
        Function to initialize DistributedTrainer ready horovod for disitrubted triaining
    ...
    def evaluate(self, test_dataset):
        ...
        :param test_dataset: dataset to use for evaluation
        """
        if is_main_process():
            return super().evaluate(test_dataset=test_dataset)
