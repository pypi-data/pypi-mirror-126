...
class Order:
    def __init__(self, id: int, pedido_venda_id: str, data_pedido: str, data_geracao: str, codigo_referencia: str,
        ...
        print(f'\n\n{type(forma_envio_parceiro)} {forma_envio_parceiro} \n\n')
        partner_shipping_methods: list[PartnerShippingMethod] = [PartnerShippingMethod(**forma_envio_parceiro)]  # [PartnerShippingMethod(**f) for f in forma_envio_parceiro]
