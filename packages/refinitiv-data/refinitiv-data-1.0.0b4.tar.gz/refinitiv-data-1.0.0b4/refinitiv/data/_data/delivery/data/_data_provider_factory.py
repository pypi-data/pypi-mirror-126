...
from ...content.data_grid._data_provider import data_grid_data_provider
...
data_provider_by_data_type = {
    ...
    ContentType.DATA_GRID: data_grid_data_provider,
}
...
api_type_by_data_type = {
    ...
    ContentType.DATA_GRID: APIType.DATA_GRID,
}
...
url_config_key_by_data_type = {
    ...
    ContentType.DATA_GRID: "endpoints.standard",
}
