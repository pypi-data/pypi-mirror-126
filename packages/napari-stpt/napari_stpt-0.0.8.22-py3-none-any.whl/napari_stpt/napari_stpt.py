...
class NapariSTPT:
    ...
    def Load(self, text):
        ...
        with napari.gui_qt():
            if self.cb_C1.isChecked():
                ...
                self.viewer.add_image([self.aligned_1], name='C1', scale=(float(self.slice_spacing)/float(self.optical_slices), output_resolution, output_resolution), blending='additive', colormap='bop purple')#, translate=(0, int(start_y*output_resolution), int(start_z*output_resolution)))
            ...
            if self.cb_C2.isChecked():
                ...
                self.viewer.add_image([self.aligned_2], name='C2', scale=(float(self.slice_spacing)/float(self.optical_slices), output_resolution, output_resolution), blending='additive', colormap='red')#, translate=(0, int(start_y*output_resolution), int(start_z*output_resolution)))
            ...
            if self.cb_C3.isChecked():
                ...
                self.viewer.add_image([self.aligned_3], name='C3', scale=(float(self.slice_spacing)/float(self.optical_slices), output_resolution, output_resolution), blending='additive', colormap='green')#, translate=(0, int(start_y*output_resolution), int(start_z*output_resolution)))
            ...
            if self.cb_C4.isChecked():
                ...
                self.viewer.add_image([self.aligned_4], name='C4', scale=(float(self.slice_spacing)/float(self.optical_slices), output_resolution, output_resolution), blending='additive', colormap='bop blue')#, translate=(0, int(start_y*output_resolution), int(start_z*output_resolution)))
    ...
    def Normalize_slices(self):
        import statistics
        print("Normalize_slices")
        ...
        if self.cb_C1.isChecked():
            ...
            for i in range(0,slices):
                ...
                mean = np.mean(self.aligned_1[i,:,:])
                self.aligned_1[i,:,:] = self.aligned_1[i,:,:] - mean

                st_dev = np.std(self.aligned_1[i,:,:])
                self.aligned_1[i,:,:] = self.aligned_1[i,:,:] / st_dev
        ...
        if self.cb_C2.isChecked():  
            ...
            for i in range(0,slices):
                ...
                mean = np.mean(self.aligned_2[i,:,:])
                self.aligned_2[i,:,:] = self.aligned_2[i,:,:] - mean

                st_dev = np.std(self.aligned_2[i,:,:])
                self.aligned_2[i,:,:] = self.aligned_2[i,:,:] / st_dev
        ...
        if self.cb_C3.isChecked():
            ...
            for i in range(0,slices):
                ...
                mean = np.mean(self.aligned_3[i,:,:])
                self.aligned_3[i,:,:] = self.aligned_3[i,:,:] - mean

                st_dev = np.std(self.aligned_3[i,:,:])
                self.aligned_3[i,:,:] = self.aligned_3[i,:,:] / st_dev
        ...
        if self.cb_C4.isChecked():
            slices, size_x, size_y = self.aligned_4.shape
            for i in range(0,slices):

                mean = np.mean(self.aligned_4[i,:,:])
                self.aligned_4[i,:,:] = self.aligned_4[i,:,:] - mean

                st_dev = np.std(self.aligned_4[i,:,:])
                self.aligned_4[i,:,:] = self.aligned_4[i,:,:] / st_dev
    ...
    def main(self):
        ...
        with napari.gui_qt():
            ...
            bNormalize.clicked.connect(self.Normalize_slices)
