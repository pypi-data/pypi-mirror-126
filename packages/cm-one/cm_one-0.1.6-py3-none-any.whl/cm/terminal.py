...
class Terminal():
    ...
    def getEntysInfo(self):
        ...
        info['carrier'] = self.operator.get_client_id(self.contragentCombo.get())
        info['trash_cat'] = self.operator.get_trash_cat_id(self.trashCatOm.get())
        info['trash_type'] = self.operator.get_trash_type_id(self.trashTypeOm.get())
        info['operator'] = self.operator.get_user_id(self.operator.authWin.currentUser)
