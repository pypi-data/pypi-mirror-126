...
class MaskCompositor(ImageViewer):
  ...
  def addLabelMask(
    ...
    **overlayKwargs
    ...
    :param ignoreValue: Label values matching ``ignoreValue`` will be transparent in the mask overlay.
    :param ignoreIfBlank: If *True* and the whole mask is the background color, no action will be performed
