...
class Node:
    def __init__(self, resourceID='', text='', contentDesc='', bounds='', Class=''):
...
class UIAutomator:
    ...
    def getDict(self, resourceID='', text='', contentDesc='', xml='', bounds='', Class=''):
        self.node = Node(resourceID, text, contentDesc, bounds, Class)
        if xml:
            self.xml = xml
        else:
