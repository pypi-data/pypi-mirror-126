...
class TestFuncQuery(TQBaseTestcase):
    ...
    def test_func_query(self):
        ...
        self.assertEqual(
            ls,
            ['SHFE.rb2209', 'SHFE.rb2206', 'SHFE.rb2201', 'SHFE.rb2202', 'SHFE.rb2203', 'SHFE.rb2205', 'SHFE.rb2208', 'SHFE.rb2110', 'SHFE.rb2111', 'SHFE.rb2112', 'SHFE.rb2204', 'SHFE.rb2207']
        )
        ls_cont = api.query_cont_quotes(exchange_id="DCE")
        self.assertEqual(
            ls_cont,
            ['DCE.pp2201', 'DCE.eb2111', 'DCE.l2201', 'DCE.rr2111', 'DCE.lh2201', 'DCE.pg2111', 'DCE.cs2111', 'DCE.b2111', 'DCE.i2201', 'DCE.jm2201', 'DCE.y2201', 'DCE.v2201', 'DCE.jd2201', 'DCE.m2201', 'DCE.eg2201', 'DCE.fb2110', 'DCE.bb2110', 'DCE.a2111', 'DCE.p2201', 'DCE.j2201', 'DCE.c2201']
        )
        ...
        in_options, at_options, out_options = api.query_all_level_finance_options(underlying_symbol="SSE.510300",
                                                                                  ...
                                                                                  option_class="CALL",
                                                                                  nearbys=[0, 1])
        self.assertEqual(in_options, ['SSE.10003619', 'SSE.10003641', 'SSE.10003599', 'SSE.10003642', 'SSE.10003600', 'SSE.10003643', 'SSE.10003601', 'SSE.10003644'])
        self.assertEqual(at_options, ['SSE.10003602'])
        self.assertEqual(out_options, ['SSE.10003645', 'SSE.10003603', 'SSE.10003646', 'SSE.10003604', 'SSE.10003647', 'SSE.10003605', 'SSE.10003648', 'SSE.10003606', 'SSE.10003649', 'SSE.10003607', 'SSE.10003659'])
    ...
    def test_func_query_async(self):
        ...
        async def t1(api):
            ...
            in_options, at_options, out_options = await api.query_all_level_finance_options("SSE.510300", 4.60, "CALL",
                                                                                            nearbys=1)
            self.assertEqual(in_options, ['SSE.10003641'])
            self.assertEqual(at_options, ['SSE.10003642'])
            self.assertEqual(out_options, ['SSE.10003643', 'SSE.10003644', 'SSE.10003645', 'SSE.10003646', 'SSE.10003647', 'SSE.10003648', 'SSE.10003649', 'SSE.10003659'])
            ...
            self.assertEqual(ls, ['SHFE.wr2206', 'SHFE.wr2204', 'SHFE.wr2112', 'SHFE.wr2202', 'SHFE.wr2207', 'SHFE.wr2209', 'SHFE.wr2205', 'SHFE.wr2110', 'SHFE.wr2208', 'SHFE.wr2111', 'SHFE.wr2201', 'SHFE.wr2203'])
            ls = await api.query_cont_quotes(exchange_id="SHFE")
            self.assertEqual(ls, ['SHFE.fu2201', 'SHFE.rb2201', 'SHFE.au2112', 'SHFE.al2111', 'SHFE.sp2111', 'SHFE.hc2201', 'SHFE.zn2111', 'SHFE.pb2111', 'SHFE.ni2110', 'SHFE.wr2110', 'SHFE.cu2111', 'SHFE.sn2111', 'SHFE.ag2112', 'SHFE.bu2112', 'SHFE.ru2201', 'SHFE.ss2110'])
            df = await api.query_symbol_info(ls)
            print(df.to_string())

            ls = await api.query_options(underlying_symbol="SHFE.cu2112")
            self.assertEqual(ls, ['SHFE.cu2112C80000', 'SHFE.cu2112P69000', 'SHFE.cu2112C70000', 'SHFE.cu2112C68000', 'SHFE.cu2112P82000', 'SHFE.cu2112C79000', 'SHFE.cu2112P68000', 'SHFE.cu2112P74000', 'SHFE.cu2112P61000', 'SHFE.cu2112P71000', 'SHFE.cu2112P77000', 'SHFE.cu2112P75000', 'SHFE.cu2112P72000', 'SHFE.cu2112C66000', 'SHFE.cu2112C61000', 'SHFE.cu2112P84000', 'SHFE.cu2112P63000', 'SHFE.cu2112C65000', 'SHFE.cu2112C84000', 'SHFE.cu2112C69000', 'SHFE.cu2112C78000', 'SHFE.cu2112C71000', 'SHFE.cu2112P62000', 'SHFE.cu2112P67000', 'SHFE.cu2112P65000', 'SHFE.cu2112P66000', 'SHFE.cu2112C63000', 'SHFE.cu2112C82000', 'SHFE.cu2112P73000', 'SHFE.cu2112P70000', 'SHFE.cu2112C74000', 'SHFE.cu2112P76000', 'SHFE.cu2112C67000', 'SHFE.cu2112P78000', 'SHFE.cu2112C73000', 'SHFE.cu2112C75000', 'SHFE.cu2112P80000', 'SHFE.cu2112P79000', 'SHFE.cu2112C72000', 'SHFE.cu2112C76000', 'SHFE.cu2112C62000', 'SHFE.cu2112C77000', 'SHFE.cu2112P64000', 'SHFE.cu2112C64000'])
