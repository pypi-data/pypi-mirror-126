...
class CellNumberConfig:
    def __init__(self, cfg_mgr, cell_phone=None,
                 section_heading='cell number',
                 phone_number_tag='phone_number',
                 carrier_tag='carrier'):
        """
        This class represents data in a configuration file that represents a text cell phone configuration
        :param cfg_mgr: the configuration manager for this file
        :param cell_phone: the thompcoutils.email_utils.CellPhone
        ...
        """
        self.cfg_mgr = cfg_mgr
        self.phone_number = cfg_mgr.read_entry(section=section_heading,
                                               entry=phone_number_tag, default_value=1234567890)
        self.carrier = cfg_mgr.read_entry(section=section_heading,
                                          entry=carrier_tag, default_value=CellPhone.Carrier.ATT)
        CellPhone
