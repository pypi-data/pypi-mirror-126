...
class LightSensor:
    """
    Defines a Light Sensor that is in a RC circuit.  It takes a certain amount of time for the capacitor to charge.
    ...
    def check_for_light(self):
        """
        Checks for light. This resets the pin, grounding the capacitor, then sets back to input.
        It waits the min_time for the capacitor to charge:
