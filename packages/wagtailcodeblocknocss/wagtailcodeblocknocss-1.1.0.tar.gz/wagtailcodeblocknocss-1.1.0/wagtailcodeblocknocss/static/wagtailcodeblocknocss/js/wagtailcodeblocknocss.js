...
CodeBlockDefinition.prototype.render = function (
	placeholder,
	prefix,
	initialState,
	initialError
	...
	var block =
		window.wagtailStreamField.blocks.StructBlockDefinition.prototype.render.apply(
			this,
			arguments
		);
...
window.telepath.register(
	"wagtailcodeblocknocss.blocks.CodeBlock",
	CodeBlockDefinition
);
