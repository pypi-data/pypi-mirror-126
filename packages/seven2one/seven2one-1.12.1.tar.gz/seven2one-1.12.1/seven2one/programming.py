...
class Programming():
    ...
    def createFunction(self, name:str, languageVersion:str, description:str=None, 
        files:list=None, deploy:bool=False, automationTopic:str=None, 
        envVars:dict=None) -> str:
        """ 
        ...
        deploy : bool
            ...
            None in this case.
        automationTopic : str
            The connector to a Camunda workflow. If no topic is provided, the function can only
            be executed with the Programming Service, but cannot used in an Automation workflow.
        envVars : dict
        ...
        if files == None: 
            ...
            if deploy == False:
                ...
                self.deployFunction(functionId, name, automationTopic, envVars)
                return functionId

    def commitFunctionFiles(self, functionId:str, files:list=None, deploy:bool=False, 
        deploymentName:str=None, automationTopic:str=None, envVars:dict=None) -> None:
        """
        ...
        >>> files = [path1, path2, path3]
            ...
            commitFunctionFiles('3dba276e3c8645838c2d598043cab057', files=files, deploy=True, 
                deploymentName=myfunction, automationTopic='autFunction', envVars=vars)
        """
        ...
        if result == None: 
            ...
            if deploy == False:
                ...
                if automationTopic==None:
                    automationTopic = ''
                self.deployFunction(functionId, deploymentName, automationTopic, envVars)

        return result

    def deployFunction(self, functionId:str, deploymentName:str, automationTopic:str=None, 
        envVars:dict=None):
        """
