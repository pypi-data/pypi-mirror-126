...
class BuiltinMacro:
    ...
    def if_macro(tree_slice: list, ev_func, token_cls) -> list:
        ...
        ASSERT_LIST_LENGTH_IS(
            tree_slice, 3, m='if: invalid arity, three forms are required')
    ...
    def and_macro(tree_slice: list, ev_func, token_cls) -> list:
        ...
        ASSERT_NOT_EMPTY_COLLECTION(tree_slice, m='and: at least one form is required')
    ...
    def or_macro(tree_slice: list, ev_func, token_cls) -> list:
        ...
        ASSERT_NOT_EMPTY_COLLECTION(tree_slice, m='or: at least one form is required')
    ...
    def first_threading_macro(tree_slice: list, ev_func, token_cls) -> list:
        ...
        ASSERT_NOT_EMPTY_COLLECTION(
            tree_slice, m='->: at least one form is required')
    ...
    def fn_macro(tree_slice: list, ev_func, token_cls) -> list:
        ...
        assert len(tree_slice) == 3 or len(tree_slice) == 2, (
            'fn: invalid form arity, either two or three forms are required'
        )
        ...
        ASSERT_IS_INSTANCE_OF(fn_arguments_form, list, m='fn: arguments form incorrect!')
    ...
    def let_macro(tree_slice: list, ev_func, token_cls) -> list:
        ...
        ASSERT_LIST_LENGTH_IS(tree_slice, 2, m='let: invalid form arity, two forms are required')
...
class Builtin:
    ...
    def find_mc_func(args: List[datatypes.String]) -> datatypes.Macro or datatypes.Nil:
        ...
        ASSERT_LIST_LENGTH_IS(args, 1, m='find-mc: invalid arity, exactly one argument is required')

        macro_name_as_string: datatypes.String = args[0]

        ASSERT_IS_INSTANCE_OF(macro_name_as_string, datatypes.String,
                              m='find-mc: macro-name needs to be a String')
    ...
    def find_fn_func(args: List[datatypes.String]) -> datatypes.Function or datatypes.Nil:
        ...
        ASSERT_LIST_LENGTH_IS(args, 1, m='find-fn: invalid arity, exactly one argument is required')

        function_name_as_string: datatypes.String = args[0]

        ASSERT_IS_INSTANCE_OF(function_name_as_string, datatypes.String,
                              m='find-fn: function-name needs to be a String')
    ...
    def doc_func(args: List[datatypes.Function or datatypes.Macro]) -> datatypes.HashMap:
        ...
        ASSERT_LIST_LENGTH_IS(args, 1, m='doc: invalid arity, exactly one argument is required')

        function_or_macro: datatypes.Function or datatypes.Macro = args[0]

        assert (isinstance(function_or_macro, datatypes.Function)
                or isinstance(function_or_macro, datatypes.Macro)), (
            'doc: function-or-macro needs to be either a Function or a Macro'
        )
    ...
    def get_func(args: List[datatypes.Base]) -> datatypes.Base:
        ...
        ASSERT_LIST_LENGTH_IS(
            args, 2, m='get: invalid arity, exactly two arguments are required')
        ...
        assert (isinstance(collection, datatypes.Vector)
            ...
            'get: collection needs to be either a HashMap or a Vector'
        )

        if isinstance(collection, datatypes.Vector):
            assert isinstance(key_or_index, datatypes.IntegerNumber), (
                'get: key-or-index needs to be an IntegerNumber when collection is a Vector'
            )
    ...
    def map_func(args: List[datatypes.Base]) -> datatypes.Vector:
        ...
        ASSERT_LIST_LENGTH_IS(args, 2, m='map: invalid arity, exactly two arguments are required')
        ...
        assert isinstance(function, datatypes.Function), 'map: function needs to be a Function'
        assert isinstance(collection, datatypes.Vector), 'map: collection needs to be a Vector'
    ...
    def filter_func(args: List[datatypes.Base]) -> datatypes.Vector:
        ...
        ASSERT_LIST_LENGTH_IS(args, 2, m='filter: invalid arity, exactly two arguments are required')
        ...
        assert isinstance(function, datatypes.Function), 'filter: function needs to be a Function'
        assert isinstance(collection, datatypes.Vector), 'filter: collection needs to be a Vector'
    ...
    def make_set_func(args: List[datatypes.Base]) -> datatypes.Set:
        ...
        ASSERT_NOT_EMPTY_COLLECTION(args, m='make-set: invalid arity, at least one argument is required')
    ...
    def make_vector_func(args: List[datatypes.Base]) -> datatypes.Vector:
        ...
        ASSERT_NOT_EMPTY_COLLECTION(args, m='make-vector: invalid arity, at least one argument is required')
    ...
    def make_hashmap_func(args: List[datatypes.Base]) -> datatypes.HashMap:
        ...
        ASSERT_LIST_LENGTH_IS_EVEN(args, 'make-hashmap: invalid arity, a number of args passed must be even')
    ...
    def inc_func(args: (List[datatypes.IntegerNumber]
        ...
        ASSERT_LIST_LENGTH_IS(args, 1, m='inc: invalid arity, exactly one argument is required')
    ...
    def dec_func(args: (List[datatypes.IntegerNumber]
        ...
        ASSERT_LIST_LENGTH_IS(args, 1, m='dec: invalid arity, exactly one argument is required')
    ...
    def identity_func(args: List[datatypes.Base]) -> datatypes.Base:
        ...
        ASSERT_LIST_LENGTH_IS(args, 1, m='invalid arity, exactly one argument is required')
    ...
    def eq_func(args: List[datatypes.Base]) -> datatypes.Boolean:
        ...
        ASSERT_LIST_LENGTH_IS(args, 2, m='=: invalid arity, exactly two arguments are required')
    ...
    def plus_func(args: (List[datatypes.IntegerNumber]
        ...
        ASSERT_NOT_EMPTY_COLLECTION(args, m='+: invalid arity, at least one argument is required')
        for arg in args:
            assert (isinstance(arg, datatypes.IntegerNumber)
                    or isinstance(arg, datatypes.FloatNumber)), 'IntegerNumber or FloatNumber were expected'
    ...
    @meta({'name': 'mod',
           'type': 'function',
           'sample': '(mod n1 n2 ... nX)',
           'docstring': 'All passed numbers mod'})
    def mod_func(args: (List[datatypes.IntegerNumber]
        ...
        ASSERT_NOT_EMPTY_COLLECTION(args, '*: invalid arity, at least one argument is required')
        for arg in args:
            assert (isinstance(arg, datatypes.IntegerNumber)
                    or isinstance(arg, datatypes.FloatNumber)), 'IntegerNumber or FloatNumber were expected'
