...
def SuperSTARPrediction(image, model, n_tiles, MaskImage, OverAllMaskImage, UseProbability = True):
...
def STARPrediction3D(image, model, n_tiles, MaskImage = None,  UseProbability = True, globalthreshold = 1.0E-5, extent = 0, seedpool = True):
