...
The file will be created in your site-package (always writable by your computer), and you can edit it manually. 
...
The configuration file will be found in your site package. You canno't see it in textastic so you can only edit it throught vim in a-shell. 

### Pyto shortcuts

⚠️ Pyto seems broken in IOS / Ipad OS 15 and I dunno why. 
