...
class IFactorProvider(metaclass=abc.ABCMeta):
    ...
    def GetPriceScaleFactor(self, searchDate: typing.Union[datetime.datetime, datetime.date], dataNormalizationMode: QuantConnect.DataNormalizationMode, dataMappingMode: typing.Optional[QuantConnect.DataMappingMode] = None, contractOffset: int = 0) -> float:
...
class CorporateFactorRow(System.Object, QuantConnect.Data.Auxiliary.IFactorRow):
    ...
    def GetDividend(self, futureCorporateFactorRow: QuantConnect.Data.Auxiliary.CorporateFactorRow, symbol: typing.Union[QuantConnect.Symbol, str], exchangeHours: QuantConnect.Securities.SecurityExchangeHours, decimalPlaces: int = 2) -> QuantConnect.Data.Market.Dividend:
        """
        ...
        :param futureCorporateFactorRow: The next factor file row in time
    ...
    def GetSplit(self, futureCorporateFactorRow: QuantConnect.Data.Auxiliary.CorporateFactorRow, symbol: typing.Union[QuantConnect.Symbol, str], exchangeHours: QuantConnect.Securities.SecurityExchangeHours) -> QuantConnect.Data.Market.Split:
        """
