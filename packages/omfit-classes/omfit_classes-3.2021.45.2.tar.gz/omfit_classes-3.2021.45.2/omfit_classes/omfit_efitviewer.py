...
def parse_load_cx_ods_kw(gfile=None, device=None, shot=None, t=None, efitid=None, index=0, no_empty=None, settings=None):
    """
    ...
    return gfile, device, shot, efitid, no_empty, ods_tag
...
def load_cx_ods(gfile=None, device=None, shot=None, t=None, efitid=None, index=0, no_empty=None):
    ...
    gfile, device, shot, efitid, no_empty, ods_tag = parse_load_cx_ods_kw(
        gfile=gfile, device=device, shot=shot, t=t, efitid=efitid, index=index, no_empty=no_empty, settings=settings
    )
