...
setup(
    ...
    # required packages
    install_requires=["scipy>=1.6.3", "numpy>=1.20.2", "pandas>=1.2.0", "cython>=0.29.23", "setuptools>=56.0.0", "pip>=20.3.3", "biopython>=1.78", "mypy>=0.800", "psutil>=5.8.0", "scikit-learn>=0.24.1", "wheel>=0.36.0", "filetype>=1.0.7"], # specify minimum version
