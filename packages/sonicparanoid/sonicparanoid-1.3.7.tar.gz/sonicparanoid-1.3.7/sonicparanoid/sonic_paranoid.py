...
def get_params(softVersion):
    ...
    # Mandatory arguments
    parser.add_argument("-i", "--input-directory", type=str, required=True, help="Directory containing the proteomes (in FASTA format) of the species to be analyzed.", default="")
...
def citation_and_help():
    ...
    emailSC2: str = "salvocos@bs.s.u-tokyo.ac.jp"
