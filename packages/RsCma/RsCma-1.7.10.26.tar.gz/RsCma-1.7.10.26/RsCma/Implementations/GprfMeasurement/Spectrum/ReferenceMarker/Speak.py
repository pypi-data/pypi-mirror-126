...
class Speak:
	...
	def fetch(self, detector: enums.Detector, statistic: enums.Statistic) -> FetchStruct:
		...
		Snippet: value: FetchStruct = driver.gprfMeasurement.spectrum.referenceMarker.speak.fetch(detector = enums.Detector.AUTopeak, statistic = enums.Statistic.AVERage) \n
