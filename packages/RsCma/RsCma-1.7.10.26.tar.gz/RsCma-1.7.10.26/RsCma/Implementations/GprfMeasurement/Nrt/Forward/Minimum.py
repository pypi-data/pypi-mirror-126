...
class Minimum:
	...
	def calculate(self) -> CalculateStruct:
		...
		Snippet: value: CalculateStruct = driver.gprfMeasurement.nrt.forward.minimum.calculate() \n
		...
		return self._core.io.query_struct(f'CALCulate:GPRF:MEASurement<Instance>:NRT:FWARd:MINimum?', self.__class__.CalculateStruct())
	...
	def fetch(self) -> ResultData:
		...
		Snippet: value: ResultData = driver.gprfMeasurement.nrt.forward.minimum.fetch() \n
		Return the measurement results for the forward direction. CALCulate commands return error indicators instead of
		measurement values. \n
			:return: structure: for return value, see the help for ResultData structure arguments."""
		return self._core.io.query_struct(f'FETCh:GPRF:MEASurement<Instance>:NRT:FWARd:MINimum?', self.__class__.ResultData())

	def read(self) -> ResultData:
		"""SCPI: READ:GPRF:MEASurement<Instance>:NRT:FWARd:MINimum \n
		Snippet: value: ResultData = driver.gprfMeasurement.nrt.forward.minimum.read() \n
		Return the measurement results for the forward direction. CALCulate commands return error indicators instead of
		measurement values. \n
			:return: structure: for return value, see the help for ResultData structure arguments."""
		return self._core.io.query_struct(f'READ:GPRF:MEASurement<Instance>:NRT:FWARd:MINimum?', self.__class__.ResultData())
