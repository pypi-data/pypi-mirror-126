...
class Current:
	...
	def calculate(self) -> List[float or bool]:
		...
		Snippet: value: List[float or bool] = driver.gprfMeasurement.power.current.calculate() \n
		Queries the 'Power Current RMS' result. CALCulate commands return an error indicator instead of a power value. \n
		Use RsCma.reliability.last_value to read the updated reliability indicator. \n
			:return: power_current_rms: (float or boolean items) 'Power Current RMS' result Unit: dBm"""
