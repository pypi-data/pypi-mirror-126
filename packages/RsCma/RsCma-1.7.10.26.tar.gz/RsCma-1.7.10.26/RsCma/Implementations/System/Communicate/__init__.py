...
class Communicate:
	"""Communicate commands group definition. 18 total commands, 7 Sub-groups, 0 group commands"""
	...
	def net(self):
		...
		if not hasattr(self, '_net'):
			from .Net import Net
			self._net = Net(self._core, self._cmd_group)
		return self._net
	...
	def vxi(self):
		...
		if not hasattr(self, '_vxi'):
			from .Vxi import Vxi
			self._vxi = Vxi(self._core, self._cmd_group)
		return self._vxi
