...
class Spdif:
	"""Spdif commands group definition. 6 total commands, 2 Sub-groups, 4 group commands"""
	...
	class SnRatioStruct(StructBase):  # From WriteStructDefinition CmdPropertyTemplate.xml
		"""Structure for setting input parameters. Contains optional set arguments. Fields: \n
			...
			- Upper_Left: float: Optional setting parameter. Upper limit for the left SPDIF channel Range: 1 dB to 46 dB, Unit: dB
			- Upper_Right: float: Optional setting parameter. Upper limit for the right SPDIF channel Range: 1 dB to 46 dB, Unit: dB"""
		__meta_args_list = [
