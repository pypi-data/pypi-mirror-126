...
class Demodulation:
	...
	def get_tmode(self) -> enums.DigitalToneMode:
		...
		Snippet: value: enums.DigitalToneMode = driver.configure.afRf.measurement.multiEval.demodulation.get_tmode() \n
		No command help available \n
			:return: tone_mode: No help available
		"""
		response = self._core.io.query_str('CONFigure:AFRF:MEASurement<Instance>:MEValuation:DEModulation:TMODe?')
	...
	def set_tmode(self, tone_mode: enums.DigitalToneMode) -> None:
		"""SCPI: CONFigure:AFRF:MEASurement<Instance>:MEValuation:DEModulation:TMODe \n
		Snippet: driver.configure.afRf.measurement.multiEval.demodulation.set_tmode(tone_mode = enums.DigitalToneMode.DCS) \n
		No command help available \n
			:param tone_mode: No help available
		"""
		param = Conversions.enum_scalar_to_str(tone_mode, enums.DigitalToneMode)
		self._core.io.write(f'CONFigure:AFRF:MEASurement<Instance>:MEValuation:DEModulation:TMODe {param}')
