...
class Current:
	...
	def calculate(self) -> CalculateStruct:
		"""SCPI: CALCulate:AFRF:MEASurement<Instance>:MEValuation:DEModulation:FDEViation:CURRent \n
		Snippet: value: CalculateStruct = driver.afRf.measurement.multiEval.demodulation.fdeviation.current.calculate() \n
		...
		return self._core.io.query_struct(f'CALCulate:AFRF:MEASurement<Instance>:MEValuation:DEModulation:FDEViation:CURRent?', self.__class__.CalculateStruct())
	...
	def fetch(self) -> ResultData:
		"""SCPI: FETCh:AFRF:MEASurement<Instance>:MEValuation:DEModulation:FDEViation:CURRent \n
		Snippet: value: ResultData = driver.afRf.measurement.multiEval.demodulation.fdeviation.current.fetch() \n
		Queries the demodulation results for FM or FM stereo demodulation. A statistical evaluation of the frequency deviation or
		multiplex deviation is returned. CALCulate commands return error indicators instead of measurement values. \n
			:return: structure: for return value, see the help for ResultData structure arguments."""
		return self._core.io.query_struct(f'FETCh:AFRF:MEASurement<Instance>:MEValuation:DEModulation:FDEViation:CURRent?', self.__class__.ResultData())

	def read(self) -> ResultData:
		"""SCPI: READ:AFRF:MEASurement<Instance>:MEValuation:DEModulation:FDEViation:CURRent \n
		Snippet: value: ResultData = driver.afRf.measurement.multiEval.demodulation.fdeviation.current.read() \n
		Queries the demodulation results for FM or FM stereo demodulation. A statistical evaluation of the frequency deviation or
		multiplex deviation is returned. CALCulate commands return error indicators instead of measurement values. \n
			:return: structure: for return value, see the help for ResultData structure arguments."""
		return self._core.io.query_struct(f'READ:AFRF:MEASurement<Instance>:MEValuation:DEModulation:FDEViation:CURRent?', self.__class__.ResultData())
