...
class Current:
	...
	def fetch(self) -> List[float]:
		"""SCPI: FETCh:AFRF:MEASurement<Instance>:MEValuation:OSCilloscope:DEModulation:PDEViation:CURRent \n
		Snippet: value: List[float] = driver.afRf.measurement.multiEval.oscilloscope.demodulation.pdeviation.current.fetch() \n
		Queries the contents of the AF oscilloscope diagram for PM demodulation. \n
	...
	def read(self) -> List[float]:
		"""SCPI: READ:AFRF:MEASurement<Instance>:MEValuation:OSCilloscope:DEModulation:PDEViation:CURRent \n
