...
class All:
	...
	def fetch(self) -> List[enums.ResourceState]:
		...
		Snippet: value: List[enums.ResourceState] = driver.afRf.measurement.multiEval.state.all.fetch() \n
		...
		response = self._core.io.query_str(f'FETCh:AFRF:MEASurement<Instance>:MEValuation:STATe:ALL?')
