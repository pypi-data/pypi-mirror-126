...
class Deviation:
	...
	def fetch(self) -> ResultData:
		...
		Snippet: value: ResultData = driver.afRf.measurement.multiEval.spdifLeft.afSignal.deviation.fetch() \n
		Queries the AF frequency and level results for the left SPDIF channel. \n
			:return: structure: for return value, see the help for ResultData structure arguments."""
		return self._core.io.query_struct(f'FETCh:AFRF:MEASurement<Instance>:MEValuation:SINLeft:AFSignal:DEViation?', self.__class__.ResultData())

	def read(self) -> ResultData:
		"""SCPI: READ:AFRF:MEASurement<Instance>:MEValuation:SINLeft:AFSignal:DEViation \n
		Snippet: value: ResultData = driver.afRf.measurement.multiEval.spdifLeft.afSignal.deviation.read() \n
		Queries the AF frequency and level results for the left SPDIF channel. \n
			:return: structure: for return value, see the help for ResultData structure arguments."""
		return self._core.io.query_struct(f'READ:AFRF:MEASurement<Instance>:MEValuation:SINLeft:AFSignal:DEViation?', self.__class__.ResultData())
