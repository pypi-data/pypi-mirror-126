...
class FftSpecAn:
	"""FftSpecAn commands group definition. 9 total commands, 2 Sub-groups, 7 group commands"""
	...
	def osStop(self):
		...
		if not hasattr(self, '_osStop'):
			from .OsStop import OsStop
			self._osStop = OsStop(self._core, self._cmd_group)
		return self._osStop
