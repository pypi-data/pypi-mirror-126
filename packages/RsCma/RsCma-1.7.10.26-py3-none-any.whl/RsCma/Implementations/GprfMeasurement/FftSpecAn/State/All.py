...
class All:
	...
	def fetch(self) -> List[enums.ResourceState]:
		...
		Snippet: value: List[enums.ResourceState] = driver.gprfMeasurement.fftSpecAn.state.all.fetch() \n
		Queries the main FFT spectrum analyzer state and all substates. The substates provide additional information for the main
		state RUN. \n
