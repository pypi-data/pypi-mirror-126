...
class Deviation:
	...
	def fetch(self) -> ResultData:
		...
		Snippet: value: ResultData = driver.afRf.measurement.multiEval.spdifRight.afSignal.deviation.fetch() \n
		Queries the AF frequency and level results for the right SPDIF channel. \n
			:return: structure: for return value, see the help for ResultData structure arguments."""
		return self._core.io.query_struct(f'FETCh:AFRF:MEASurement<Instance>:MEValuation:SINRight:AFSignal:DEViation?', self.__class__.ResultData())

	def read(self) -> ResultData:
		"""SCPI: READ:AFRF:MEASurement<Instance>:MEValuation:SINRight:AFSignal:DEViation \n
		Snippet: value: ResultData = driver.afRf.measurement.multiEval.spdifRight.afSignal.deviation.read() \n
		Queries the AF frequency and level results for the right SPDIF channel. \n
			:return: structure: for return value, see the help for ResultData structure arguments."""
		return self._core.io.query_struct(f'READ:AFRF:MEASurement<Instance>:MEValuation:SINRight:AFSignal:DEViation?', self.__class__.ResultData())
