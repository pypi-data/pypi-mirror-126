...
class Maximum:
	...
	def fetch(self) -> ResultData:
		...
		Snippet: value: ResultData = driver.afRf.measurement.multiEval.voip.afSignal.maximum.fetch() \n
		Queries the AF frequency and level results for the VoIP path. \n
			:return: structure: for return value, see the help for ResultData structure arguments."""
		return self._core.io.query_struct(f'FETCh:AFRF:MEASurement<Instance>:MEValuation:VOIP:AFSignal:MAXimum?', self.__class__.ResultData())

	def read(self) -> ResultData:
		"""SCPI: READ:AFRF:MEASurement<Instance>:MEValuation:VOIP:AFSignal:MAXimum \n
		Snippet: value: ResultData = driver.afRf.measurement.multiEval.voip.afSignal.maximum.read() \n
		Queries the AF frequency and level results for the VoIP path. \n
			:return: structure: for return value, see the help for ResultData structure arguments."""
		return self._core.io.query_struct(f'READ:AFRF:MEASurement<Instance>:MEValuation:VOIP:AFSignal:MAXimum?', self.__class__.ResultData())
