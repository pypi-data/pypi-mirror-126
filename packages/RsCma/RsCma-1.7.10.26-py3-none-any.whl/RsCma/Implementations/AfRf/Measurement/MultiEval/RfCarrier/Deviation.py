...
class Deviation:
	...
	def calculate(self) -> CalculateStruct:
		...
		Snippet: value: CalculateStruct = driver.afRf.measurement.multiEval.rfCarrier.deviation.calculate() \n
		...
		return self._core.io.query_struct(f'CALCulate:AFRF:MEASurement<Instance>:MEValuation:RFCarrier:DEViation?', self.__class__.CalculateStruct())
	...
	def fetch(self) -> ResultData:
		...
		Snippet: value: ResultData = driver.afRf.measurement.multiEval.rfCarrier.deviation.fetch() \n
		Queries the RF carrier measurement results. CALCulate commands return error indicators instead of measurement values. \n
			:return: structure: for return value, see the help for ResultData structure arguments."""
		return self._core.io.query_struct(f'FETCh:AFRF:MEASurement<Instance>:MEValuation:RFCarrier:DEViation?', self.__class__.ResultData())

	def read(self) -> ResultData:
		"""SCPI: READ:AFRF:MEASurement<Instance>:MEValuation:RFCarrier:DEViation \n
		Snippet: value: ResultData = driver.afRf.measurement.multiEval.rfCarrier.deviation.read() \n
		Queries the RF carrier measurement results. CALCulate commands return error indicators instead of measurement values. \n
			:return: structure: for return value, see the help for ResultData structure arguments."""
		return self._core.io.query_struct(f'READ:AFRF:MEASurement<Instance>:MEValuation:RFCarrier:DEViation?', self.__class__.ResultData())
