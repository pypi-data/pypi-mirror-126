...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, pulp_labels=None, password=None, url=None, ca_cert=None, download_concurrency=None, headers=None, client_key=None, name=None, client_cert=None, tls_validation=None, max_retries=None, sock_read_timeout=None, connect_timeout=None, total_timeout=None, proxy_password=None, proxy_username=None, username=None, sock_connect_timeout=None, rate_limit=None, proxy_url=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
