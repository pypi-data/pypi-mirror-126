...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, pulp_href=None, total_timeout=None, client_cert=None, headers=None, rate_limit=None, connect_timeout=None, pulp_labels=None, url=None, pulp_created=None, sock_read_timeout=None, sock_connect_timeout=None, ca_cert=None, proxy_url=None, name=None, max_retries=None, pulp_last_updated=None, download_concurrency=None, tls_validation=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
