...
class AnsibleGitRemote(object):
    ...
    def __init__(self, tls_validation=None, ca_cert=None, pulp_labels=None, rate_limit=None, client_key=None, client_cert=None, sock_read_timeout=None, url=None, proxy_username=None, sock_connect_timeout=None, password=None, total_timeout=None, headers=None, download_concurrency=None, max_retries=None, username=None, proxy_password=None, name=None, proxy_url=None, connect_timeout=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
