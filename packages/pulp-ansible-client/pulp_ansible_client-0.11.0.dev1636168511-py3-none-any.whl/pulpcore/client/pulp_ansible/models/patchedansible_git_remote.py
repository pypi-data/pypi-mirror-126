...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, max_retries=None, headers=None, username=None, pulp_labels=None, connect_timeout=None, tls_validation=None, sock_read_timeout=None, client_cert=None, sock_connect_timeout=None, rate_limit=None, password=None, total_timeout=None, proxy_url=None, ca_cert=None, name=None, url=None, client_key=None, proxy_username=None, proxy_password=None, download_concurrency=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
