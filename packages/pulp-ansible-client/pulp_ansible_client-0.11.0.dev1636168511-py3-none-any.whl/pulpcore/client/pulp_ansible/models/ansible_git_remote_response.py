...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, max_retries=None, headers=None, pulp_labels=None, connect_timeout=None, tls_validation=None, sock_read_timeout=None, pulp_created=None, client_cert=None, sock_connect_timeout=None, pulp_last_updated=None, rate_limit=None, total_timeout=None, proxy_url=None, ca_cert=None, name=None, url=None, pulp_href=None, download_concurrency=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
