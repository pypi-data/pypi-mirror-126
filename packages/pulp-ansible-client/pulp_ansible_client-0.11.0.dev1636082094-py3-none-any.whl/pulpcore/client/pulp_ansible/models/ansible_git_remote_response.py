...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, pulp_labels=None, connect_timeout=None, download_concurrency=None, total_timeout=None, proxy_url=None, client_cert=None, name=None, pulp_href=None, tls_validation=None, sock_connect_timeout=None, url=None, pulp_last_updated=None, headers=None, max_retries=None, pulp_created=None, rate_limit=None, sock_read_timeout=None, ca_cert=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
