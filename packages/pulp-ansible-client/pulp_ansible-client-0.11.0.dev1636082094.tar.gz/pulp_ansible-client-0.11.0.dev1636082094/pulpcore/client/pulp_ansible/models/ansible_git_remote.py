...
class AnsibleGitRemote(object):
    ...
    def __init__(self, pulp_labels=None, connect_timeout=None, client_key=None, download_concurrency=None, total_timeout=None, password=None, proxy_url=None, client_cert=None, name=None, tls_validation=None, sock_connect_timeout=None, url=None, username=None, proxy_username=None, headers=None, max_retries=None, rate_limit=None, sock_read_timeout=None, proxy_password=None, ca_cert=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
