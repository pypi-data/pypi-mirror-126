...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, pulp_created=None, tls_validation=None, ca_cert=None, pulp_labels=None, rate_limit=None, client_cert=None, sock_read_timeout=None, url=None, sock_connect_timeout=None, total_timeout=None, headers=None, download_concurrency=None, max_retries=None, name=None, pulp_href=None, pulp_last_updated=None, proxy_url=None, connect_timeout=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
