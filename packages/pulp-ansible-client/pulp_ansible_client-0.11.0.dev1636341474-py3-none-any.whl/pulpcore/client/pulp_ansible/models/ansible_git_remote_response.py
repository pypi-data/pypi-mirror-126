...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, pulp_labels=None, url=None, ca_cert=None, download_concurrency=None, headers=None, name=None, pulp_created=None, client_cert=None, pulp_href=None, pulp_last_updated=None, tls_validation=None, max_retries=None, sock_read_timeout=None, connect_timeout=None, total_timeout=None, sock_connect_timeout=None, rate_limit=None, proxy_url=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
