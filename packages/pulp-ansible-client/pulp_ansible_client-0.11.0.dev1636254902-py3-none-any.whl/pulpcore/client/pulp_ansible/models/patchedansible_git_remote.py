...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, rate_limit=None, url=None, proxy_username=None, total_timeout=None, connect_timeout=None, username=None, sock_read_timeout=None, max_retries=None, tls_validation=None, name=None, proxy_password=None, download_concurrency=None, sock_connect_timeout=None, headers=None, client_key=None, pulp_labels=None, client_cert=None, proxy_url=None, password=None, ca_cert=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
