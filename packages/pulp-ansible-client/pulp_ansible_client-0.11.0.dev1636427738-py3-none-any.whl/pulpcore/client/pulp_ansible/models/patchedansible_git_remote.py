...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, client_key=None, total_timeout=None, client_cert=None, headers=None, rate_limit=None, connect_timeout=None, username=None, pulp_labels=None, url=None, sock_read_timeout=None, proxy_password=None, sock_connect_timeout=None, ca_cert=None, proxy_url=None, name=None, max_retries=None, password=None, download_concurrency=None, proxy_username=None, tls_validation=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
