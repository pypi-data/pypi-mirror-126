...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, rate_limit=None, url=None, total_timeout=None, connect_timeout=None, pulp_created=None, sock_read_timeout=None, max_retries=None, tls_validation=None, name=None, download_concurrency=None, sock_connect_timeout=None, headers=None, pulp_last_updated=None, pulp_labels=None, client_cert=None, pulp_href=None, proxy_url=None, ca_cert=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
