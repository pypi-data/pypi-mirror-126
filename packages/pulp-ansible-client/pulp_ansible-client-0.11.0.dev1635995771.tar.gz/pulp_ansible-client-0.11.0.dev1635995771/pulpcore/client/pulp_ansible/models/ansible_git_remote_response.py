...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, pulp_href=None, pulp_labels=None, pulp_created=None, sock_connect_timeout=None, url=None, proxy_url=None, connect_timeout=None, download_concurrency=None, pulp_last_updated=None, rate_limit=None, client_cert=None, max_retries=None, ca_cert=None, name=None, headers=None, tls_validation=None, total_timeout=None, sock_read_timeout=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
