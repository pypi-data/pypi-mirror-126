...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, pulp_labels=None, sock_connect_timeout=None, password=None, url=None, client_key=None, proxy_url=None, connect_timeout=None, download_concurrency=None, username=None, proxy_password=None, rate_limit=None, client_cert=None, max_retries=None, ca_cert=None, name=None, headers=None, tls_validation=None, proxy_username=None, total_timeout=None, sock_read_timeout=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
