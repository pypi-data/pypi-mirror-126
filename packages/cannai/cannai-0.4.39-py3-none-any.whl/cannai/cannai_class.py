...
class Cmodel(Cannaibase):
    ...
    def add_model_base(self, model, model_n, ii, target_label=None,input_spfunc=None,output_spfunc=None,evals_result=None,group=None):
...
class CE_Cmodel(Cmodel):
    ...
    def add_model(self, model,group, model_n=None,input_spfunc=None,output_spfunc=None,evals_result=None):
        ...
        sub_ml = self.add_model_base(model, model_n, ii,group, None,input_spfunc=input_spfunc,output_spfunc=output_spfunc,evals_result = evals_result)
        self.save_df(sub_ml[1], model_n)
        self.model_list.append(sub_ml)
        self.model_name_list.append(sub_ml[0])

    def add_model_base(self, model, model_n, ii,group, target_label=None,input_spfunc=None,output_spfunc=None,evals_result=None,group_name=None):
        sub_ml0 = super(Cmodel, self).add_model_base(model, model_n, ii, target_label=target_label,input_spfunc=input_spfunc,output_spfunc=output_spfunc,evals_result=evals_result)
        sub_ml0.append(group)
        return sub_ml0
