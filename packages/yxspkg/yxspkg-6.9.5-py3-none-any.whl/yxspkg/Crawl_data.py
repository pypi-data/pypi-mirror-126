...
def is_table(cursor,table_name):
    cmd = f"SELECT COUNT(*) FROM sqlite_master where type='table' and name='{table_name}'"
    t = list(cursor.execute(cmd))[0][0]
    return t>0
