...
from Aspidites._vendor.pyrsistent._pvector import PythonPVector, python_pvector
...
def _get_class(type_name):
    ...
    module = __import__('Aspidites.tests._vendor.pyrsistent.' + module_name, fromlist=[class_name])
