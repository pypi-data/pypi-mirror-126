...
class ImplStorage(ImplBase):
    ...
    def plot_summary(self, aggregate_name, workspace, timeout, primary_metric, max_workers, max_runs, verbose, use_azure_storage):
        ...
        search_history = SearchHistory(agg_name=aggregate_name, workspace=workspace, timeout=timeout, primary_metric=primary_metric, 
            hp_config_file_name=hp_config_path, max_workers=max_workers, max_runs=max_runs, xt_config=self.config, verbose=verbose, use_azure_storage=use_azure_storage)
