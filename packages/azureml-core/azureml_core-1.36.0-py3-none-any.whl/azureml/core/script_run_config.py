...
def _update_args_and_io(workspace, run_config):
    ...
    update_args_and_io(run_config.arguments, run_config.data, run_config.output_data, run_config.datacaches)
    if hasattr(run_config, 'command'):
        update_args_and_io(run_config.command, run_config.data, run_config.output_data, run_config.datacaches)
