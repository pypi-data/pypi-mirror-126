...
from hestia_earth.models.cml2001NonBaseline.eutrophicationPotentialIncludingFateAverageEurope import TERM_ID, run

class_path = f"hestia_earth.models.cml2001NonBaseline.{TERM_ID}"
fixtures_folder = f"{fixtures_path}/cml2001NonBaseline/{TERM_ID}"
