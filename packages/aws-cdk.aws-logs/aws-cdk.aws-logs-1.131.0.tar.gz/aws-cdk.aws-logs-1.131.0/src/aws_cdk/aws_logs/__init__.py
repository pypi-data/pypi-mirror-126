...
resource_policy = ResourcePolicy(self, "ResourcePolicy")
resource_policy.document.add_statements(iam.PolicyStatement(
...
policy_statement = iam.PolicyStatement(
    ...
    principals=[iam.ArnPrincipal("arn:aws:iam::123456789012:user/user-name")]
)()
resource_policy = ResourcePolicy(self, "ResourcePolicy",
    policy_name="myResourcePolicy",
