...
class TestTransform(unittest.TestCase):
    ...
    def test_trans(self) -> None:
        for key, value in self.height_data.items():
            self.assertEqual(trans(key, cls="height", unit="cm"), value[0])
            self.assertEqual(trans(key, cls="height"), value[0])  # unit default: cm
            self.assertEqual(trans(key, unit="cm"), value[0])
            self.assertEqual(trans(key, cls="height", unit="m"), value[1])
        ...
        for key, value in self.foot_data.items():
            ...
            self.assertEqual(trans(key, cls="foot"),  value[0])
            self.assertEqual(trans(key, cls="foot", unit="cm"), value[0])
            self.assertEqual(trans(key, cls="foot", unit="m"),  value[1])
