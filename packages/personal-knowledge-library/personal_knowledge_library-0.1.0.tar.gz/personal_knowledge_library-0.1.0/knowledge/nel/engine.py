...
from knowledge.base.entity import LANGUAGE_CODE_TAG, LanguageCode
...
from knowledge.services.graph import AUTHORIZATION_HEADER_FLAG, CONTENT_TYPE_HEADER_FLAG, TEXT_TAG
...
class WacomEntityLinkingEngine(PersonalEntityLinkingProcessor):
    ...
    service_url: str
        URL of the service
    """
    SERVICE_ENDPOINT: str = 'graphdata/nel/text'
    ...
    def link_personal_entities(self, auth_key: str, text: str, language_code: str = 'en_US') \
        ...
        payload: Dict[str, str] = {
            LANGUAGE_CODE_TAG: language_code,
            TEXT_TAG: text
        }
