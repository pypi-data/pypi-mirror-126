...
class NeuralNetwork(depthai.Node):
    ...
    def setBlobPath(self, path: str) -> None: ...
...
class VideoEncoder(depthai.Node):
    ...
    @overload
    def setDefaultProfilePreset(self, width: int, height: int, fps: float, profile: depthai.VideoEncoderProperties.Profile) -> None: ...
    @overload
    def setDefaultProfilePreset(self, size: Tuple[int,int], fps: float, profile: depthai.VideoEncoderProperties.Profile) -> None: ...
    ...
    @overload
    def setProfile(self, size: Tuple[int,int], profile: depthai.VideoEncoderProperties.Profile) -> None: ...
    @overload
    def setProfile(self, width: int, height: int, profile: depthai.VideoEncoderProperties.Profile) -> None: ...
