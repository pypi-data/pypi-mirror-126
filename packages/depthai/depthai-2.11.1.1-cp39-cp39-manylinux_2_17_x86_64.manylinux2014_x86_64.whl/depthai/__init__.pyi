...
class RawStereoDepthConfig(RawBuffer):
    ...
    class CostAggregation:
        divisionFactor: int
        horizontalPenaltyCosts: Optional[List[int[256]]]
        verticalPenaltyCosts: Optional[List[int[256]]]
        def __init__(self) -> None: ...
