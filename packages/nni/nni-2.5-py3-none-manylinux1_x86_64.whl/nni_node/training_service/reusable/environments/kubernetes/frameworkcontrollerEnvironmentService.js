...
const frameworkcontrollerConfig_1 = require("../../../kubernetes/frameworkcontroller/frameworkcontrollerConfig");
...
let FrameworkControllerEnvironmentService = class FrameworkControllerEnvironmentService extends kubernetesEnvironmentService_1.KubernetesEnvironmentService {
    ...
    constructor(config, info) {
        ...
        this.config = experimentConfig_1.flattenConfig(config, 'frameworkcontroller');
        ...
        if (this.config.storage.storageType === 'azureStorage') {
            ...
            const azureKubeflowClusterConfig = new frameworkcontrollerConfig_1.FrameworkControllerClusterConfigAzure(this.config.namespace, this.config.apiVersion, keyValutConfig, azureStorage);
