...
# Suite of test that checks if data_type inferred correctly by Solas
def test_check_cars():
    solas.config.set_SQL_connection("")
...
def test_check_int_id():
    df = pd.read_csv(
        "https://github.com/lux/solas-datasets/blob/master/data/instacart_sample.csv?raw=true"
    )
...
def test_check_str_id():
    df = pd.read_csv("https://github.com/lux/solas-datasets/blob/master/data/churn.csv?raw=true")
    df._ipython_display_()
    assert (
...
def test_check_hpi():
    df = pd.read_csv("https://github.com/lux/solas-datasets/blob/master/data/hpi.csv?raw=true")
    df.maintain_metadata()
...
def test_check_airbnb():
    df = pd.read_csv("https://github.com/lux/solas-datasets/blob/master/data/airbnb_nyc.csv?raw=true")
    df.maintain_metadata()
    assert df.data_type == {
        "id": "id",
        "name": "nominal",
...
def test_check_datetime_numeric_values():
    car_df = pd.read_csv("solas/data/car.csv")
    ...
    spotify_df = pd.read_csv(
        "https://raw.githubusercontent.com/lux/solas-datasets/master/data/spotify.csv"
    )
...
def test_check_stock():
    df = pd.read_csv("https://github.com/lux/solas-datasets/blob/master/data/stocks.csv?raw=true")
    df.maintain_metadata()
    assert df.data_type == {
        "symbol": "nominal",
        "monthdate": "temporal",
...
def test_id_aug_test():
    ...
    """
    df = pd.read_csv("https://github.com/lux/solas-datasets/blob/master/data/aug_test.csv?raw=true")
    df.maintain_metadata()
    assert df.data_type == {
        "enrollee_id": "id",
        "city": "nominal",
...
def test_id_absenteeism_data():
    ...
    df = pd.read_csv("https://github.com/lux/solas-datasets/blob/master/data/absenteeism.csv?raw=true")
    df.maintain_metadata()
    assert df.data_type == {
        "ID": "quantitative",
