...
def test_nan_data_type_detection():
    ...
    inverted_data_type = solas.config.executor.invert_data_type(test.data_type)
    ...
    inverted_data_type = solas.config.executor.invert_data_type(nona_test.data_type)
    assert inverted_data_type["nominal"] == [
        "fully_nan",
        "some_nan",
        "some_nan2",
...
def test_nan_series_occurence():
    ...
    nan_series = SolasSeries(dvalues)
