...
class Vis:
    ...
    def __repr__(self):
        all_clause = all([isinstance(unit, solas.Clause) for unit in self._inferred_intent])
        if all_clause:
            filter_intents = None
    ...
    def _ipython_display_(self):
        ...
        if self.data is None:
            ...
            widget = solaswidget.SolasWidget(
                currentVis=SolasDataFrame.current_vis_to_JSON([self]),
                recommendations=[],
                intent="",
                message="",
                history_list=[],
    ...
    def to_matplotlib(self) -> str:
        ...
        """
        from solas.vislib.matplotlib.MatplotlibRenderer import MatplotlibRenderer
    ...
    def refresh_source(self, ldf):  # -> Vis:
        ...
        See Also
        --------
        solas.Vis.VisList.refresh_source
        ...
        if ldf is not None:
            ...
            solas.config.executor.execute([self], ldf)
    ...
    def check_not_vislist_intent(self):
        ...
        syntaxMsg = (
            ...
            "For more information, see: https://solas-api.readthedocs.io/en/latest/source/guide/vis.html#working-with-collections-of-visualization-with-vislist"
        )
