...
from solas.vislib.matplotlib.BarChart import BarChart
from solas.vislib.matplotlib.ScatterChart import ScatterChart
from solas.vislib.matplotlib.LineChart import LineChart
from solas.vislib.matplotlib.Histogram import Histogram
from solas.vislib.matplotlib.Heatmap import Heatmap
from solas.vislib.altair.AltairRenderer import AltairRenderer
import matplotlib.pyplot as plt
from solas.utils.utils import matplotlib_setup
    ...
    def create_vis(self, vis, standalone=True):
        ...
        if chart:
            ...
            if solas.config.plotting_style and (
                ...
                or solas.config.plotting_backend == "matplotlib_svg"
            ):
                chart.ax = solas.config.plotting_style(chart.fig, chart.ax)
            plt.tight_layout()
            tmpfile = BytesIO()
