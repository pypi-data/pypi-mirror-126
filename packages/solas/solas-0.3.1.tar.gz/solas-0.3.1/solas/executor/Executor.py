...
class Executor:
    """
    Abstract class for the execution engine that fetches data for a given vis on a SolasDataFrame
    """
    ...
    @staticmethod
    def execute(vislist: VisList, ldf: SolasDataFrame, approx: bool = False):
        """
    ...
    @staticmethod
    def execute_aggregate(vis: Vis, ldf: SolasDataFrame):
        """
