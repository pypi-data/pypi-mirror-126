...
class AzureMLDeploymentClient(BaseDeploymentClient):
    ...
    def create_deployment(self, name, model_uri, flavor=None, config=None):
        ...
        if v1_deploy_config:
            return self._v1_create_deployment(name, model_name, model_version, aml_model, config, v1_deploy_config)
        else:
            return self._v2_create_deployment(name, model_name, model_version, v2_deploy_config)
