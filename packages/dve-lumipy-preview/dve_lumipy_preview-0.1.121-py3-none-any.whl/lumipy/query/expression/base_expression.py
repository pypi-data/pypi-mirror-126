...
class BaseExpression(Lockable):
    ...
    def __init__(
            ...
            *values: Union['BaseExpression', ProviderMetadata, FieldMetadata]
    ):
        ...
        def type_check_failure(t):
            return not issubclass(t, BaseExpression) and t != FieldMetadata and t != ProviderMetadata
    ...
    def get_lineage(self) -> Tuple[Union['BaseExpression', ProviderMetadata, FieldMetadata]]:
