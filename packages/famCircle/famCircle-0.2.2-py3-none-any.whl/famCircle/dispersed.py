...
class dispersed():
    ...
    def run(self):
        ...
        one_gene = []
        alphagenepairs = open(self.genepair, 'r', encoding='utf-8')
        if self.pairtype == 'famCircle':
            ...
            for row in alphagenepairs:
                if (row[0] == '\n'):
                    ...
                    if id2 not in one_gene:
                        one_gene.append(id2)
        elif self.pairtype == 'ColinearScan':
            for row in alphagenepairs:
                if (row[0] == '\n' and row[0] == '+'):
                    continue
                elif (row[:3] == 'the'):
        ...
        for i in pair:
            ...
            chro1,chro2 = gff[id1]['chr'],gff[id2]['chr']
            if chro1 == chro2 and id1 not in tandem_list and id2 not in tandem_list and abs(int(gff[id1]['order'])-int(gff[id2]['order'])) < 15:
                if id1 not in tp_list:
                    tp_list.append(id1)
                if id2 not in tp_list:
                    tp_list.append(id2)
        ...
        all_ = []
        for i in family:
            if i in tp_list or i in wgd_list:
                continue
            else:
                all_.append(i)
                    ...
                    if id2 in gff.keys():
                        if id1 != id2:
                            if id1 not in family or id1 in tp_list:
                                break
                            if id2 not in family or id1 in tp_list:
                                continue
                            if id1 in wgd_list and id2 not in wgd_list and id2 in all_:
                                if id2 not in trd_list:
                                    trd_list.append(id2)
                            elif id2 in wgd_list and id1 not in wgd_list and id1 in all_:
                                if id2 not in trd_list:
                                    trd_list.append(id2)
        out_list = []
        ...
        old = tp_list+prox_list+wgd_list+trd_list
        for i in family:
            if i not in old:
                outfile.write(str(i) + '\n')
                out_list.append(i)
        ...
        #     elif  id1 in tpd or id2 in tpd:
        #         print(id1,id2,'tpd')
        #     elif id1 in one_gene or id2 in one_gene:
        #         print(id1,id2,'wgd')
        #     else:
        #         put0.append(i)
