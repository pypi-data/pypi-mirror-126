...
class proximal():
    ...
    def run(self):
        ...
        for i in pair:
            ...
            chro1,chro2 = gff[id1]['chr'],gff[id2]['chr']
            if chro1 == chro2 and id1 not in tandem_list and id2 not in tandem_list and abs(int(gff[id1][self.position])-int(gff[id2][self.position])) < 15:
        ...
        for i in pair:
            ...
            if id1 == id2:
                continue
            if [id1,id2] not in proximal_list:
