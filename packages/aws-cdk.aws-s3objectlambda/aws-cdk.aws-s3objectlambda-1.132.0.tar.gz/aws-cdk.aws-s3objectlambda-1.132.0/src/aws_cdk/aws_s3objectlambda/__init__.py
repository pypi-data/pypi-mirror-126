...
class CfnAccessPoint(
    ...
    def __init__(
        ...
        *,
        ...
        object_lambda_configuration: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnAccessPoint.ObjectLambdaConfigurationProperty"]] = None,
    ) -> None:
    ...
    def object_lambda_configuration(
        self,
    ) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnAccessPoint.ObjectLambdaConfigurationProperty"]]:
        ...
        '''
        return typing.cast(typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnAccessPoint.ObjectLambdaConfigurationProperty"]], jsii.get(self, "objectLambdaConfiguration"))

    @object_lambda_configuration.setter
    def object_lambda_configuration(
        self,
        value: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnAccessPoint.ObjectLambdaConfigurationProperty"]],
    ) -> None:
...
class CfnAccessPointProps:
    ...
    def object_lambda_configuration(
        ...
        return typing.cast(typing.Optional[typing.Union[aws_cdk.core.IResolvable, CfnAccessPoint.ObjectLambdaConfigurationProperty]], result)
