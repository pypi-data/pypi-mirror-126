...
#  define YARP_EXPORT
#  define YARP_LOCAL
#  define YARP_IMPORT_EXTERN YARP_EXTERN_TEMPLATE
#  define YARP_EXPORT_EXTERN YARP_EXTERN_TEMPLATE
#endif
...
#  define YARP_DEPRECATED_EXPORT YARP_DEPRECATED YARP_EXPORT
#  define YARP_DEPRECATED_IMPORT YARP_DEPRECATED YARP_IMPORT
#  define YARP_DEPRECATED_MSG_EXPORT(X) YARP_DEPRECATED_MSG(X) YARP_EXPORT
#  define YARP_DEPRECATED_MSG_IMPORT(X) YARP_DEPRECATED_MSG(X) YARP_IMPORT
#else
#  define YARP_DEPRECATED_API // YARP_DEPRECATED Since YARP 3.5
#  define YARP_DEPRECATED_API_MSG(X) // YARP_DEPRECATED Since YARP 3.5
