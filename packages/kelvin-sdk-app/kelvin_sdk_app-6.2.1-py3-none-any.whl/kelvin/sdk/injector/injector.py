...
from kelvin.sdk.app import PollerApplication
from kelvin.sdk.app.utils import inflate
...
class InjectorApp(PollerApplication):
    ...
    _generator: Optional[
        Generator[Tuple[datetime, Dict[str, Any]], Tuple[datetime, Dict[str, Any]], None]
    ] = None
    ...
    def _make_generator(
        ...
        for filename in filenames:
            ...
            if "time" in data:
                ...
                origin = (
                    datetime.utcfromtimestamp(self.process_time)
                    if config.relative_timestamps
                    else 0.0
                )
                data["time"] = pandas.to_datetime(data["time"], unit=unit, utc=True, origin=origin)
    ...
    def process(self) -> None:
        ...
        while True:
            ...
            # push value back onto generator if not on same timestamp
            ...
            # collect header fields for reuse (e.g. _asset_name, etc)
