...
class GeneratorWindTurbine(Generator):
    ...
    def __init__(self, model: "Model"):
        _openstudiomodelgenerators.GeneratorWindTurbine_swiginit(self, _openstudiomodelgenerators.new_GeneratorWindTurbine(model))
    ...
    def setRotorType(self, rotorType: "std::string") -> "bool":
        return _openstudiomodelgenerators.GeneratorWindTurbine_setRotorType(self, rotorType)

    def setPowerControl(self, powerControl: "std::string") -> "bool":
