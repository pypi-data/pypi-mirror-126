...
class ClusterCreateParams(object):
    ...
    def __init__(self, name=None, high_availability_mode='Full', openshift_version=None, ocp_release_image=None, base_dns_domain=None, cluster_network_cidr='10.128.0.0/14', cluster_network_host_prefix=None, service_network_cidr='172.30.0.0/16', ingress_vip=None, pull_secret=None, ssh_public_key=None, vip_dhcp_allocation=True, http_proxy=None, https_proxy=None, no_proxy=None, user_managed_networking=False, additional_ntp_source=None, olm_operators=None, hyperthreading='all', network_type='OpenShiftSDN', schedulable_masters=False, cluster_networks=None, service_networks=None, machine_networks=None, platform=None, cpu_architecture='x86_64', disk_encryption=None, ignition_endpoint_url=None):  # noqa: E501
        ...
        self._ignition_endpoint_url = None
        ...
        if ignition_endpoint_url is not None:
            self.ignition_endpoint_url = ignition_endpoint_url
    ...
    @property
    def ignition_endpoint_url(self):
        """Gets the ignition_endpoint_url of this ClusterCreateParams.  # noqa: E501

        Explicit ignition endpoint overrides the default ignition endpoint.  # noqa: E501

        :return: The ignition_endpoint_url of this ClusterCreateParams.  # noqa: E501
        :rtype: str
        """
        return self._ignition_endpoint_url

    @ignition_endpoint_url.setter
    def ignition_endpoint_url(self, ignition_endpoint_url):
        """Sets the ignition_endpoint_url of this ClusterCreateParams.

        Explicit ignition endpoint overrides the default ignition endpoint.  # noqa: E501

        :param ignition_endpoint_url: The ignition_endpoint_url of this ClusterCreateParams.  # noqa: E501
        :type: str
        """

        self._ignition_endpoint_url = ignition_endpoint_url
