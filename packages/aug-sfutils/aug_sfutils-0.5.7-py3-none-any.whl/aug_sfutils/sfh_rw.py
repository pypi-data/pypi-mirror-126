...
class SFH_WRITE:
    ...
    def __init__(self, sfo):
        ...
        """
        self.sfo = sfo
        objnam   = sf.str_byt.to_byt(sfo.objnam)
        ...
        descr    = sf.str_byt.to_byt(sfo.descr)
        ...
        if sfo.obj_type in val_func.keys():
            print(sfo.objid, sfo.objnam, sfo.obj_type)
            val_func[sfo.obj_type]()
        else:
            print('Object type %d not supported' %sfo.obj_type)
