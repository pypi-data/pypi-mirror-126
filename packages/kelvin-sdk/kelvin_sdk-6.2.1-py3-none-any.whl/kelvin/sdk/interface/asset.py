...
def asset_create(asset_name: str, asset_type_name: str, asset_title: str) -> OperationResponse:
    ...
    return _asset_create(asset_name=asset_name, asset_type_name=asset_type_name, asset_title=asset_title)
...
def asset_type_create(asset_type_name: str, asset_type_title: str) -> OperationResponse:
    ...
    return _asset_type_create(asset_type_name=asset_type_name, asset_type_title=asset_type_title)
