...
from kelvin.sdk.lib.models.ksdk_workload_deployment import WorkloadDeploymentRequest
...
def workload_list(
    ...
    """
    from kelvin.sdk.lib.api.workload import workload_list as _workload_list
...
def workload_show(
    ...
    """
    from kelvin.sdk.lib.api.workload import workload_show as _workload_show
...
def workload_deploy(workload_deployment_request: WorkloadDeploymentRequest) -> OperationResponse:
    ...
    """
    from kelvin.sdk.lib.api.workload import workload_deploy as _workload_deploy
...
def workload_update(
    ...
    """
    from kelvin.sdk.lib.api.workload import workload_update as _workload_update
...
def workload_logs(workload_name: str, tail_lines: int, output_file: Optional[str], follow: bool) -> OperationResponse:
    ...
    """
    from kelvin.sdk.lib.api.workload import workload_logs as _workload_logs
...
def workload_undeploy(workload_name: str, ignore_destructive_warning: bool) -> OperationResponse:
    ...
    """
    from kelvin.sdk.lib.api.workload import workload_undeploy as _workload_undeploy
...
def workload_start(workload_name: str) -> OperationResponse:
    ...
    """
    from kelvin.sdk.lib.api.workload import workload_start as _workload_start
...
def workload_stop(workload_name: str, ignore_destructive_warning: bool) -> OperationResponse:
    ...
    """
    from kelvin.sdk.lib.api.workload import workload_stop as _workload_stop
...
def workload_deploy_bulk(
    ...
    """
    from kelvin.sdk.lib.api.workload import workload_deploy_bulk
