...
def list(node_name: str, app_name: str, enabled: bool, source: str) -> bool:
    """
...
@click.option("--app-name", type=click.STRING, required=False, help=KSDKHelpMessages.workload_deploy_app_name)
