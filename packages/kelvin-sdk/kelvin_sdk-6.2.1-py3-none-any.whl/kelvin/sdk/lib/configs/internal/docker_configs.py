...
class DockerConfigs:
    ...
    ksdk_app_identification_label: dict = {"source": "ksdk", "name": "", "type": ""}
    # app storage configs
    container_app_dir_path: str = "/opt/kelvin/app"
    container_app_config_file_path: str = "/opt/kelvin/app/app.yaml"
    container_app_datatype_dir_path: str = "/opt/kelvin/datatype"
    # Maintain for extractor/studio purposes
    container_app_shared_dir_path: str = "/opt/kelvin/app/data"
    container_app_shared_dir_bind: str = "{shared_dir_path}:/opt/kelvin/app/data:Z"
    # default app dir
