...
from kelvin.sdk.lib.models.ksdk_docker import DockerBuildEntry, DockerProgressEntry
from kelvin.sdk.lib.models.types import LogColor
from kelvin.sdk.lib.utils import logger_utils
from kelvin.sdk.lib.utils.display_utils import error_colored_message
from kelvin.sdk.lib.utils.general_utils import check_if_dependency_is_installed
...
def process_dockerfile_build_entry(entry: dict) -> str:
    ...
    ----------
    entry: dict
        A dictionary containing the dockerfile build entry.
    ...
    try:
        ...
        return dockerfile_build_entry.encode("ascii", "ignore").decode("utf-8")
    except Exception:
        return ""
