...
class Api:
    """
    Maintain API connection with the greenops API service
    =====================================================

    Notes
    -----
        This is singleton, no initialization required
    """
    ...
    def get_consumption_by_long_name(cls, name : str) -> any:
        """
        Access to endpoint getConsumptionByLongName
        ===========================================
    ...
    def get_consumption_by_short_name(cls, name : str) -> any:
        """
        Access to endpoint getConsumptionByShortName
        ============================================
    ...
    def get_cost_by_country_code(cls, code : str) -> any:
        """
        Access to endpoint getCostByCountryCode
        =======================================
    ...
    def get_cost_by_country_name(cls, name : str) -> any:
        """
        Access to endpoint getCostByCountryName
        =======================================
    ...
    def get_source_rates_by_country_code(cls, code : str) -> any:
        """
        Access to endpoint getSourceRatesByCountryCode
        =============================================
    ...
    def get_source_rates_by_country_name(cls, name : str) -> any:
        """
        Access to endpoint getSourceRatesByCountryName
        =============================================
