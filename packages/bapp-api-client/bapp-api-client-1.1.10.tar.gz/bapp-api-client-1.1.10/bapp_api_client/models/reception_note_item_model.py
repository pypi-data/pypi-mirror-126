...
class ReceptionNoteItemModel(object):
    ...
    def __init__(self, id=None, company=None, product=None, unit=None, name=None, description=None, quantity_doc=None, quantity=None, tax=None, price=None, subtotal=None, tax_value=None, total=None, price_currency=None, subtotal_currency=None, tax_value_currency=None, total_currency=None, _configuration=None):  # noqa: E501
