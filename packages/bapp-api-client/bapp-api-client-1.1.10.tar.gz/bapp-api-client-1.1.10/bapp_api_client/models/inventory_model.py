...
class InventoryModel(object):
    ...
    def __init__(self, id=None, stock=None, administrator=None, series=None, number=None, _date=None, status=None, accounting=None, inventory=None, difference=None, depreciation=None, _configuration=None):  # noqa: E501
