...
class ProductionApi(object):
    ...
    def production_material_consumption_pdf(self, id, data, **kwargs):  # noqa: E501
        """production_material_consumption_pdf  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.production_material_consumption_pdf(id, data, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.production_material_consumption_pdf_with_http_info(id, data, **kwargs)  # noqa: E501
        else:
            (data) = self.production_material_consumption_pdf_with_http_info(id, data, **kwargs)  # noqa: E501
            return data

    def production_material_consumption_pdf_with_http_info(self, id, data, **kwargs):  # noqa: E501
        """production_material_consumption_pdf  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.production_material_consumption_pdf_with_http_info(id, data, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method production_material_consumption_pdf" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if self.api_client.client_side_validation and ('id' not in params or
                                                       params['id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `id` when calling `production_material_consumption_pdf`")  # noqa: E501
        # verify the required parameter 'data' is set
        if self.api_client.client_side_validation and ('data' not in params or
                                                       params['data'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `data` when calling `production_material_consumption_pdf`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/production/material-consumption/{id}/pdf/', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def production_time_consumption_list_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['q', 'product', 'ordering', 'ids', 'page']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
