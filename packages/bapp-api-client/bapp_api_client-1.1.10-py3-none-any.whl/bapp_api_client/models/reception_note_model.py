...
class ReceptionNoteModel(object):
    ...
    def __init__(self, id=None, stock=None, supplier=None, delegate=None, series=None, number=None, document_type=None, document_number=None, auto=None, _date=None, status=None, observations=None, exchange_rate=None, subtotal=None, tax_value=None, total=None, subtotal_currency=None, tax_value_currency=None, total_currency=None, items=None, _configuration=None):  # noqa: E501
