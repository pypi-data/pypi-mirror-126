...
class StockSettings(object):
    ...
    def __init__(self, allows_negative_quantity=False, default_stock_for_billing=None, default_stock_for_reception_note=None, automatic_transfer=False, stock_method='cmp', automatically_generate_and_finalise_reception_note=False, _configuration=None):  # noqa: E501
