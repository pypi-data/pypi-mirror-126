...
class SupplierIncome(object):
    ...
    def __init__(self, id=None, partner=None, currency=None, type=None, status=None, _date=None, due_date=None, observations=None, identifier=None, value=None, remaining=None, extra=None, invoices_ids=None, _configuration=None):  # noqa: E501
