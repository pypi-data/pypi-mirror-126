...
Welcome to ``MAAP`` contributor's guide.
...
If you experience bugs or general issues with ``MAAP``, please have a look
...
You can help improve ``MAAP`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``MAAP`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``MAAP``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n MAAP python=3 six virtualenv pytest pytest-cov
    conda activate MAAP
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/MAAP.git
    cd MAAP
...
#. Install |pre-commit|_::
   ...
   ``MAAP`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/MAAP
.. _issue tracker: https://github.com/<USERNAME>/MAAP/issues
.. <-- end -->
