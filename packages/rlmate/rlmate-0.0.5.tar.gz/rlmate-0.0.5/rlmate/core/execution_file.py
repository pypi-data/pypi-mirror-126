...
class ExecutionFile:
    ...
    option_parser.add_argument(
        "-git",
        "--git",
        help="automatically push results as soon as job is done",
        default=False,
        action="store_true",
    )
    ...
    def union_options(self, standard_options, other_options):
        ...
        options.git = standard_options.git or other_options.git
    ...
    def __init__(self, path_to_execution_file, comment=[]):
