...
d_nconv = {
    ...
    's_format_tiff_tissueedgedistance': '{}_{}_areathresh{}_TissueEdgeDistance.tif',  # s_slide_pxscene, s_tissue_dapi, i_tissue_area_thresh
    's_regex_tiff_tissueedgedistance': r'^([^_]+)_([^_]+)_([^_]+)_areathresh(\d+)_TissueEdgeDistance.tif$',  # s_slide_pxscene, s_tissue_dapi, i_tissue_area_thresh
    'di_regex_tiff_tissueedgedistance': {'s_slide':1, 's_pxscene':2, 's_tissue_dapi':3, 'i_tissue_area_thresh':4},
}
