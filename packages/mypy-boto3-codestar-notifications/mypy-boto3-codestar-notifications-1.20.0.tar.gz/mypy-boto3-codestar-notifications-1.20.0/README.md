...
[boto3.CodeStarNotifications 1.20.0](https://boto3.amazonaws.com/v1/documentation/api/1.20.0/reference/services/codestar-notifications.html#CodeStarNotifications)
