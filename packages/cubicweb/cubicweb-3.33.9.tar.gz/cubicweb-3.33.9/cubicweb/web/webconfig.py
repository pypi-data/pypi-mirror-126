        ...
        + (
            ...
            (
                "allowed-http-host-headers",
                {
                    "type": "string",
                    "help": (
                        "a comma separated list of hosts. Only request with a Host header which "
                        "is compatible with the values in this list will be accepted. "
                        "Request without host or a faulty one will be denied for "
                        "protecting against HTTP Host header attacks. '*' can be used to accept "
