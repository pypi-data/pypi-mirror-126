...
class System:
	"""System commands group definition. 184 total commands, 35 Sub-groups, 29 group commands"""
	...
	def extDevices(self):
		...
		if not hasattr(self, '_extDevices'):
			from .ExtDevices import ExtDevices
			self._extDevices = ExtDevices(self._core, self._cmd_group)
	...
	def files(self):
		...
		if not hasattr(self, '_files'):
			...
			self._files = Files(self._core, self._cmd_group)
		return self._files
