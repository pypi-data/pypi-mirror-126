...
&xstop_1 - 1, ystart_1 - 1, ystop_1 - 1)
        ...
        u_fld_cl_mem = TRANSFER(u_fld % device_ptr, u_fld_cl_mem)
        v_fld_cl_mem = TRANSFER(v_fld % device_ptr, v_fld_cl_mem)
        CALL compute_z_code_set_args(kernel_compute_z_code, z_fld_cl_mem, p_fld_cl_mem, u_fld_cl_mem, v_fld_cl_mem, &
&p_fld % grid % dx, p_fld % grid % dy, xstart_2 - 1, xstop_2 - 1, ystart_2 - 1, ystop_2 - 1)
...
&ystart_1 - 1, ystop_1 - 1)
      ...
      localsize_1 = (/4, 1/)
      ierr = clEnqueueNDRangeKernel(cmd_queues(2), kernel_compute_cv_code, 2, C_NULL_PTR, C_LOC(globalsize_1), C_LOC(localsize_1), &
...
&p_fld % grid % dx, p_fld % grid % dy, xstart_2 - 1, xstop_2 - 1, ystart_2 - 1, ystop_2 - 1)
      ...
      localsize_2 = (/4, 1/)
      ierr = clEnqueueNDRangeKernel(cmd_queues(3), kernel_compute_z_code, 2, C_NULL_PTR, C_LOC(globalsize_2), C_LOC(localsize_2), &
&0, C_NULL_PTR, C_NULL_PTR)
      xstart_3 = h_fld % internal % xstart
      xstop_3 = h_fld % internal % xstop
      ystart_3 = h_fld % internal % ystart
...
&xstop_3 - 1, ystart_3 - 1, ystop_3 - 1)
      ...
      localsize_3 = (/4, 1/)
      ierr = clEnqueueNDRangeKernel(cmd_queues(4), kernel_compute_h_code, 2, C_NULL_PTR, C_LOC(globalsize_3), C_LOC(localsize_3), &
&0, C_NULL_PTR, C_NULL_PTR)
    ...
    SUBROUTINE psy_init()
      ...
      IF (.NOT.initialised) THEN
        ...
        kernel_names(2) = 'compute_cu_code'
