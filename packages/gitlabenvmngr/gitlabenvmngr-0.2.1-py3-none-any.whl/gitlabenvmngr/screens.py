...
from .helps import help_projects, help_variables, help_variable_editor
    ...
    def input_stream(self):
        ...
        while True:
            ...
            if ch == curses.KEY_UP:
                ...
                variables = VariablesScreen(self._gl, selector[self.current + self.top]["ref"])
                variables.run()
