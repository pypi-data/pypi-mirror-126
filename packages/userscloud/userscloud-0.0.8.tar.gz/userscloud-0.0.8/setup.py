...
setup(
    name="userscloud",
    version="0.0.8",
    keywords=["file host batch remote upload zippyshare captcha recaptcha bypass account register registration api cli manager archive"],
    ...
    project_urls={
        ...
        "Documentation": "https://github.com/foxe6/userscloud/blob/master/userscloud/test",
