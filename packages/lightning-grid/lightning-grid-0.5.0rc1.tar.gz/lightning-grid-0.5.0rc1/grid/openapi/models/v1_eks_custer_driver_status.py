...
class V1EKSCusterDriverStatus(object):
    ...
    def __init__(self, ecr_registry_id=None, ecr_repository_uri=None, gridlet_role_arn=None, user_workload_role_arn=None, vpc_id=None, _configuration=None):  # noqa: E501
    ...
    def ecr_registry_id(self, ecr_registry_id):
    ...
    def ecr_repository_uri(self, ecr_repository_uri):
    ...
    def gridlet_role_arn(self, gridlet_role_arn):
    ...
    @property
    def user_workload_role_arn(self):
    ...
    def user_workload_role_arn(self, user_workload_role_arn):
