...
class LunVvolBindingsSchema(ResourceSchema):
...
Example: 1 """
    ...
    partner = fields.Nested("netapp_ontap.models.lun_vvol_partner.LunVvolPartnerSchema", unknown=EXCLUDE, data_key="partner")
