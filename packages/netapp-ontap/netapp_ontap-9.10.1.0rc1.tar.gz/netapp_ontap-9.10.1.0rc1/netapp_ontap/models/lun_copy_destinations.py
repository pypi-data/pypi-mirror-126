...
class LunCopyDestinationsSchema(ResourceSchema):
...
Example: /vol/vol1/lun1 """
    ...
    progress = fields.Nested("netapp_ontap.models.lun_copy_progress.LunCopyProgressSchema", unknown=EXCLUDE, data_key="progress")
