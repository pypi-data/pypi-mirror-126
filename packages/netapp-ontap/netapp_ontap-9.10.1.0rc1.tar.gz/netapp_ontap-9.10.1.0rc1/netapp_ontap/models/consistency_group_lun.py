...
class ConsistencyGroupLunSchema(ResourceSchema):
    """The fields of the ConsistencyGroupLun object"""

    clone = fields.Nested("netapp_ontap.models.consistency_group_lun_clone.ConsistencyGroupLunCloneSchema", unknown=EXCLUDE, data_key="clone")
...
Example: 1cd8a442-86d1-11e0-ae1c-123478563412 """
    ...
    """comment,create_time,enabled,lun_maps,name,os_type,provisioning_options,qos.policy,serial_number,space,uuid,"""
