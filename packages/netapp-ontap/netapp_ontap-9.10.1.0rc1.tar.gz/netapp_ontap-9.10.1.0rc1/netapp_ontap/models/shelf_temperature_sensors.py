...
class ShelfTemperatureSensorsSchema(ResourceSchema):
...
Example: 32 """
    ...
    threshold = fields.Nested("netapp_ontap.models.shelf_threshold.ShelfThresholdSchema", unknown=EXCLUDE, data_key="threshold")
