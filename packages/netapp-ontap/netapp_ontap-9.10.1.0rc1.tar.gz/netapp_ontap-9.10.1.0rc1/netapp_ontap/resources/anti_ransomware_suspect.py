...
class AntiRansomwareSuspectSchema(ResourceSchema):
    ...
    volume = fields.Nested("netapp_ontap.models.anti_ransomware_suspect_volume.AntiRansomwareSuspectVolumeSchema", data_key="volume", unknown=EXCLUDE)
    ...
    """links,file,is_false_positive,volume,"""
    ...
    if RECLINE_INSTALLED:
        ...
        async def anti_ransomware_suspect_delete(
            ...
            try:
                ...
                raise ClicheCommandError("Unable to delete AntiRansomwareSuspect: %s" % err)
