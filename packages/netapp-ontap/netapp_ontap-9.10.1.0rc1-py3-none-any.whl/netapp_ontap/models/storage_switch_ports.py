...
class StorageSwitchPortsSchema(ResourceSchema):
...
* af_port """
    ...
    sfp = fields.Nested("netapp_ontap.models.storage_switch_sfp.StorageSwitchSfpSchema", unknown=EXCLUDE, data_key="sfp")
