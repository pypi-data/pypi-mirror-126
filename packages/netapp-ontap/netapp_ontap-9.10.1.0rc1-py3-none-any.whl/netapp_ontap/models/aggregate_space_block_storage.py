...
class AggregateSpaceBlockStorageSchema(ResourceSchema):
    ...
    aggregate_metadata = Size(data_key="aggregate-metadata")
    r""" Aggregate metadata, in bytes.

Example: 2655 """

    aggregate_metadata_percent = Size(data_key="aggregate-metadata-percent")
...
Example: 2088960 """
    ...
    used_including_snapshot_reserve = Size(data_key="used-including-snapshot-reserve")
    r""" Total used including the Snapshot copy reserve, in bytes.

Example: 674685 """

    used_including_snapshot_reserve_percent = Size(data_key="used-including-snapshot-reserve-percent")
    r""" Total used including the Snapshot reserve as a percentage.

Example: 35 """

    volume_footprints_percent = Size(data_key="volume-footprints-percent")
    r""" Total of volume footprints as a percentage.
...
Example: 27 """
    ...
    """aggregate_metadata,aggregate_metadata_percent,available,data_compacted_count,data_compaction_space_saved,data_compaction_space_saved_percent,full_threshold_percent,inactive_user_data,inactive_user_data_percent,physical_used,physical_used_percent,size,used,used_including_snapshot_reserve,used_including_snapshot_reserve_percent,volume_footprints_percent,volume_deduplication_shared_count,volume_deduplication_space_saved,volume_deduplication_space_saved_percent,"""
