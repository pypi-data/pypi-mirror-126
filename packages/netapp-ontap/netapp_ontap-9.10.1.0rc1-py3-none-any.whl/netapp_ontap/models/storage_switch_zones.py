...
class StorageSwitchZonesSchema(ResourceSchema):
    ...
    port = fields.Nested("netapp_ontap.models.storage_switch_port1.StorageSwitchPort1Schema", unknown=EXCLUDE, data_key="port")
