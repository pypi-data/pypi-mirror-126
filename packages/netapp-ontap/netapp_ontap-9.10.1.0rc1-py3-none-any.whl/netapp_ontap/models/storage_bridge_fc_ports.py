...
class StorageBridgeFcPortsSchema(ResourceSchema):
...
Example: 200650eb1a238892 """
    ...
    sfp = fields.Nested("netapp_ontap.models.storage_bridge_sfp.StorageBridgeSfpSchema", unknown=EXCLUDE, data_key="sfp")
