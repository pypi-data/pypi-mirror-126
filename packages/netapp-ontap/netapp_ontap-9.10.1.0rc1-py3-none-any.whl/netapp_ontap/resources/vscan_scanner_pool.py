...
Example: ["1.1.1.1","10.72.204.27","vmwin204-27.fsct.nb"] """
    ...
    """cluster.name,cluster.uuid,privileged_users,role,servers,svm.name,svm.uuid,"""
    ...
    """cluster.name,cluster.uuid,name,privileged_users,role,servers,svm.name,svm.uuid,"""
