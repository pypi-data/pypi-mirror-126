        ...
        function create_branches(field, wrapper, branches) {
            ...
            branches.forEach(function (item) {
                ...
                template
                    ...
                    .attr('data-relation-pk', item.relation_pk)
...
function report_designer() {
    ...
    $(document).on('click', '.js-tree-function-btn', function (e) {
        ...
        let relation_pk = $(this).data('relation-pk');
        ...
        if (name === 'field') {
            ...
            // ID связи таблицы
            relation_pk = branches.last().data('relation-pk');
        ...
        template
            .removeClass('hidden')
            .attr('data-name', name)
            .attr('data-relation-pk', relation_pk)
        ...
        function build_tree(branches) {
            ...
            branches.each(function (index, value) {
                ...
                data.push({
                    ...
                    'relation_pk': $(value).attr('data-relation-pk'),
    ...
    $(document).on('change', '.js-dr-report-generate-form .js-rd-field_report', function (e) {
        ...
        let btn = form.find('.js-rd-form-submit-btn');
        rd_utils.toggle_disable_field(btn, !Boolean($(this).val()));
    });
