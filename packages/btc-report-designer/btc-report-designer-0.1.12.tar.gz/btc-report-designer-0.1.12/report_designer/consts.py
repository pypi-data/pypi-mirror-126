...
class Functions:
    ...
    class __KeyMaker:
        ...
        def key(cls, key: str):
            ...
            Генерация ключа
            """
            return f'{cls.__name__.lower()}:{key.lower()}'
    ...
    class String(__KeyMaker):
        ...
        CHOICES = (
            (CONCAT, _('Конкатенация'), _('КОНКАТ')),
            (SUBSTRING, _('Подстрока'), _('ПОДСТРОКА')),
        )
    ...
    class Arithmetic(__KeyMaker):
        ...
        CHOICES = (
            (ADD, _('Сложение'), Combinable.ADD),
            (SUB, _('Вычитание'), Combinable.SUB),
            (MUL, _('Умножение'), Combinable.MUL),
            (DIV, _('Деление'), Combinable.DIV),
            (POW, _('Возведение в степень'), Combinable.POW),
            (MOD, _('Деление по модулю'), Combinable.MOD),
            (BITAND, _('Побитовое И'), Combinable.BITAND),
            (BITOR, _('Побитовое ИЛИ'), Combinable.BITOR),
            (BITLEFTSHIFT, _('Побитовый сдвиг влево'), Combinable.BITLEFTSHIFT),
            (BITRIGHTSHIFT, _('Побитовый сдвиг вправо'), Combinable.BITRIGHTSHIFT),
        )
    ...
    class Date(__KeyMaker):
        ...
        CHOICES = (
            (YEAR, _('Год'), _('ГОД')),
            (QUARTER, _('Квартал'), _('КВРТАЛ')),
            (MONTH, _('Месяц'), _('МЕСЯЦ')),
            (WEEK, _('Неделя'), _('НЕДЕЛЯ')),
            (WEEK_DAY, _('День недели'), _('ДЕНЬ_НЕДЕЛИ')),
            (DAY, _('День'), _('ДЕНЬ')),
            (HOUR, _('Час'), _('ЧАС')),
            (MINUTE, _('Минута'), _('МИНУТА')),
            (SECOND, _('Секунда'), _('СЕКУНДА')),
        )
    ...
    def create_tree_for_template(cls):
        ...
        tree_branch_class = namedtuple('TreeBranch', ('name', 'title', 'display_name', 'tree_branches', 'has_subtree'))
        ...
        for item in cls.ITEMS:
            ...
            tree.append(tree_branch_class(item.__name__.lower(), item.title, None, tree_branches, True))
        return tree
