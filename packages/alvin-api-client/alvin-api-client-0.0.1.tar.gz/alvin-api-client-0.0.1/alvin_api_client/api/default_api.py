...
class DefaultApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_impact_by_query_api_v2_query_impact_analysis_post_endpoint = _Endpoint(
            settings={
                'response_type': (ImpactAnalysisV2Response,),
                'auth': [],
                'endpoint_path': '/api/v2/query-impact-analysis',
                'operation_id': 'get_impact_by_query_api_v2_query_impact_analysis_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.get_impact_from_validation_payload_api_v2_impact_analysis_post_endpoint = _Endpoint(
            settings={
                'response_type': (ImpactAnalysisV2Response,),
                'auth': [],
                'endpoint_path': '/api/v2/impact-analysis',
                'operation_id': 'get_impact_from_validation_payload_api_v2_impact_analysis_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
                'all': [
                    'body_get_impact_from_validation_payload_api_v2_impact_analysis_post',
                ],
                'required': [],
                'nullable': [
                ],
            ...
            root_map={
                ...
                'openapi_types': {
                    'body_get_impact_from_validation_payload_api_v2_impact_analysis_post':
                        (BodyGetImpactFromValidationPayloadApiV2ImpactAnalysisPost,),
                },
                'attribute_map': {
                },
                'location_map': {
                    'body_get_impact_from_validation_payload_api_v2_impact_analysis_post': 'body',
                },
                'collection_format_map': {
                }
            },
        ...
        self.validate_impact_analysis_query_api_v2_validate_impact_query_post_endpoint = _Endpoint(
            settings={
                'response_type': (ImpactAnalysisQueryValidation,),
                'auth': [],
                'endpoint_path': '/api/v2/validate-impact-query',
                'operation_id': 'validate_impact_analysis_query_api_v2_validate_impact_query_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def get_impact_by_query_api_v2_query_impact_analysis_post(
        self,
        query_string,
        data_platform_get,
        **kwargs
        ...
        >>> thread = api.get_impact_by_query_api_v2_query_impact_analysis_post(query_string, data_platform_get, async_req=True)
        >>> result = thread.get()

        Args:
            query_string (str):
            data_platform_get (DataPlatformGet):
        ...
        kwargs['query_string'] = \
            query_string
        kwargs['data_platform_get'] = \
            data_platform_get
        return self.get_impact_by_query_api_v2_query_impact_analysis_post_endpoint.call_with_http_info(**kwargs)

    def get_impact_from_validation_payload_api_v2_impact_analysis_post(
        self,
        **kwargs
    ):
        ...
        >>> thread = api.get_impact_from_validation_payload_api_v2_impact_analysis_post(async_req=True)
        >>> result = thread.get()


        Keyword Args:
            body_get_impact_from_validation_payload_api_v2_impact_analysis_post (BodyGetImpactFromValidationPayloadApiV2ImpactAnalysisPost): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.get_impact_from_validation_payload_api_v2_impact_analysis_post_endpoint.call_with_http_info(**kwargs)
    ...
    def validate_impact_analysis_query_api_v2_validate_impact_query_post(
        self,
        data_platform_get,
        **kwargs
    ):
        ...
        >>> thread = api.validate_impact_analysis_query_api_v2_validate_impact_query_post(data_platform_get, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['data_platform_get'] = \
            data_platform_get
        return self.validate_impact_analysis_query_api_v2_validate_impact_query_post_endpoint.call_with_http_info(**kwargs)
