...
class FinSpaceDataClient(BaseClient):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.19.11/reference/services/finspace-data.html#FinSpaceData.Client)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.19.11/reference/services/finspace-data.html#FinSpaceData.Client.can_paginate)
    ...
    def create_changeset(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.19.11/reference/services/finspace-data.html#FinSpaceData.Client.create_changeset)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.19.11/reference/services/finspace-data.html#FinSpaceData.Client.generate_presigned_url)
    ...
    def get_programmatic_access_credentials(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.19.11/reference/services/finspace-data.html#FinSpaceData.Client.get_programmatic_access_credentials)
    ...
    def get_working_location(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.19.11/reference/services/finspace-data.html#FinSpaceData.Client.get_working_location)
