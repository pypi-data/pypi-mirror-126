...
_DEFAULT_ATTRIBUTES = ['cn','c','title','physicalDeliveryOfficeName','telephoneNumber','distinguishedName','instanceType',
                        ...
                        'name','objectGUID','userAccountControl','badPwdCount','codePage','countryCode','primaryGroupID',
                        'objectSid','logonCount','sAMAccountName','sAMAccountType','userPrincipalName','objectCategory',
                        'mail','homePhone']
