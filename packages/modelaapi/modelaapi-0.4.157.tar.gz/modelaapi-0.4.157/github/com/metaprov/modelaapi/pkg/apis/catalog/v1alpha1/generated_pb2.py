...
_FEATURESELECTIONSPEC = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='cummImportancePrecent', full_name='github.com.metaprov.modelaapi.pkg.apis.catalog.v1alpha1.FeatureSelectionSpec.cummImportancePrecent', index=4,
