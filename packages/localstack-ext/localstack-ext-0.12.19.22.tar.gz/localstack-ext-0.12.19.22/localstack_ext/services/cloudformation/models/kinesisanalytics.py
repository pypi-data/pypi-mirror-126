...
class KinesisAnalyticsApplicationOutput(GenericBaseModel):
 ...
 def get_cfn_attribute(self,attribute_name):
  ...
  return AiBJh(KinesisAnalyticsApplicationOutput,self).get_cfn_attribute(attribute_name)
class KinesisAnalyticsApplication(GenericBaseModel):
 ...
 def get_cfn_attribute(self,attribute_name):
  if attribute_name in REF_ID_ATTRS:
   ...
   if app_name:
    return app_name
  return AiBJh(KinesisAnalyticsApplication,self).get_cfn_attribute(attribute_name)
