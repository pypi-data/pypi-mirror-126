...
class StateFileLocator(abc.ABC):
 location="_none_"
 active_instance=HKcBy
 @abc.abstractmethod
 def get_state_file_location_by_key(self,key:HKcBx)->HKcBx:
  pass
 @HKcBR
 def get(cls,requested_file_locator:HKcBx):
...
class ObjectStorageProvider(abc.ABC):
 ...
 active_instance=HKcBy
 @HKcBR
 def get(cls,state_file_locator:HKcBx,requested_storage:HKcBx,serializers:Dict[HKcBx,CPVCSSerializer]):
  ...
  return cls.active_instance
 def __init__(self,state_file_locator:StateFileLocator,serializers:Dict[HKcBx,CPVCSSerializer]):
 ...
 def get_state_file_location_by_key(self,key:HKcBx)->HKcBx:
  pass
 @abc.abstractmethod
 def get_version_by_key(self,key:HKcBx)->Version:
  pass
 @abc.abstractmethod
 def get_revision_by_key(self,key:HKcBx)->Revision:
  pass
 @abc.abstractmethod
 def get_revision_or_version_by_key(self,key:HKcBx)->Union[Revision,Version]:
  pass
 @abc.abstractmethod
 def get_delta_file_by_key(self,key:HKcBx)->HKcBx:
  pass
 @abc.abstractmethod
 def upsert_objects(self,*args:CPVCSObj)->List[HKcBx]:
  pass
 @abc.abstractmethod
 def update_revision_key(self,old_key:HKcBx,new_key:HKcBx,referenced_by_version:HKcBx=HKcBy):
  pass
 @abc.abstractmethod
 def version_exists(self,key:HKcBx)->HKcBP:
  pass
 @abc.abstractmethod
 def merge_remote_into_local_version(self,remote_location:HKcBx,key:HKcBx):
  pass
 @abc.abstractmethod
 def _update_key(self,old_key:HKcBx,new_key:HKcBx,base_path:HKcBx)->HKcBP:
  pass
 @abc.abstractmethod
 def _serialize(self,*args:CPVCSObj)->List[HKcBx]:
  pass
 @abc.abstractmethod
 def _deserialize(self,key_serializer:Dict[HKcBx,HKcBx],remote_location:HKcBx=HKcBy)->List[CPVCSObj]:
  pass
class ObjectStorageLocal(ObjectStorageProvider):
 ...
 def _serialize(self,*args:CPVCSObj)->List[HKcBx]:
  ...
  for cpvcs_obj in args:
   if HKcBN(cpvcs_obj,Version):
    hash_refs.append(self.serializers["version"].store_obj(cpvcs_obj))
   elif HKcBN(cpvcs_obj,Revision):
    hash_refs.append(self.serializers["revision"].store_obj(cpvcs_obj))
  return hash_refs
 def _deserialize(self,key_serializer:Dict[HKcBx,HKcBx],remote_location:HKcBx=HKcBy)->List[Union[Revision,Version]]:
