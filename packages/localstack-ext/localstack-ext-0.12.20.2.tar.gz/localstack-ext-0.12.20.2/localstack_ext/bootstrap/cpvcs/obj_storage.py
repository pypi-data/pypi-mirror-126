...
class StateFileLocator(abc.ABC):
 location="_none_"
 active_instance=QvxUk
 @abc.abstractmethod
 def get_state_file_location_by_key(self,key:QvxUp)->QvxUp:
  pass
 @QvxUP
 def get(cls,requested_file_locator:QvxUp):
...
class ObjectStorageProvider(abc.ABC):
 ...
 active_instance=QvxUk
 @QvxUP
 def get(cls,state_file_locator:QvxUp,requested_storage:QvxUp,serializers:Dict[QvxUp,CPVCSSerializer]):
  ...
  return cls.active_instance
 def __init__(self,state_file_locator:StateFileLocator,serializers:Dict[QvxUp,CPVCSSerializer]):
 ...
 def get_state_file_location_by_key(self,key:QvxUp)->QvxUp:
  pass
 @abc.abstractmethod
 def get_version_by_key(self,key:QvxUp)->Version:
  pass
 @abc.abstractmethod
 def get_revision_by_key(self,key:QvxUp)->Revision:
  pass
 @abc.abstractmethod
 def get_revision_or_version_by_key(self,key:QvxUp)->Union[Revision,Version]:
  pass
 @abc.abstractmethod
 def get_delta_file_by_key(self,key:QvxUp)->QvxUp:
  pass
 @abc.abstractmethod
 def upsert_objects(self,*args:CPVCSObj)->List[QvxUp]:
  pass
 @abc.abstractmethod
 def update_revision_key(self,old_key:QvxUp,new_key:QvxUp,referenced_by_version:QvxUp=QvxUk):
  pass
 @abc.abstractmethod
 def version_exists(self,key:QvxUp)->QvxUm:
  pass
 @abc.abstractmethod
 def merge_remote_into_local_version(self,remote_location:QvxUp,key:QvxUp):
  pass
 @abc.abstractmethod
 def _update_key(self,old_key:QvxUp,new_key:QvxUp,base_path:QvxUp)->QvxUm:
  pass
 @abc.abstractmethod
 def _serialize(self,*args:CPVCSObj)->List[QvxUp]:
  pass
 @abc.abstractmethod
 def _deserialize(self,key_serializer:Dict[QvxUp,QvxUp],remote_location:QvxUp=QvxUk)->List[CPVCSObj]:
  pass
class ObjectStorageLocal(ObjectStorageProvider):
 ...
 def _serialize(self,*args:CPVCSObj)->List[QvxUp]:
  ...
  for cpvcs_obj in args:
   if QvxUa(cpvcs_obj,Version):
    hash_refs.append(self.serializers["version"].store_obj(cpvcs_obj))
   elif QvxUa(cpvcs_obj,Revision):
    hash_refs.append(self.serializers["revision"].store_obj(cpvcs_obj))
  return hash_refs
 def _deserialize(self,key_serializer:Dict[QvxUp,QvxUp],remote_location:QvxUp=QvxUk)->List[Union[Revision,Version]]:
