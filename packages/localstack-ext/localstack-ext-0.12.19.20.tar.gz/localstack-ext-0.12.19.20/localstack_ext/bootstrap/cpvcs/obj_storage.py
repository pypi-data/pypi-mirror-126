...
class StateFileLocator(abc.ABC):
 location="_none_"
 active_instance=Gqbyl
 @abc.abstractmethod
 def get_state_file_location_by_key(self,key:GqbyX)->GqbyX:
  pass
 @GqbyQ
 def get(cls,requested_file_locator:GqbyX):
...
class ObjectStorageProvider(abc.ABC):
 ...
 active_instance=Gqbyl
 @GqbyQ
 def get(cls,state_file_locator:GqbyX,requested_storage:GqbyX,serializers:Dict[GqbyX,CPVCSSerializer]):
  ...
  return cls.active_instance
 def __init__(self,state_file_locator:StateFileLocator,serializers:Dict[GqbyX,CPVCSSerializer]):
 ...
 def get_state_file_location_by_key(self,key:GqbyX)->GqbyX:
  pass
 @abc.abstractmethod
 def get_version_by_key(self,key:GqbyX)->Version:
  pass
 @abc.abstractmethod
 def get_revision_by_key(self,key:GqbyX)->Revision:
  pass
 @abc.abstractmethod
 def get_revision_or_version_by_key(self,key:GqbyX)->Union[Revision,Version]:
  pass
 @abc.abstractmethod
 def get_delta_file_by_key(self,key:GqbyX)->GqbyX:
  pass
 @abc.abstractmethod
 def upsert_objects(self,*args:CPVCSObj)->List[GqbyX]:
  pass
 @abc.abstractmethod
 def update_revision_key(self,old_key:GqbyX,new_key:GqbyX,referenced_by_version:GqbyX=Gqbyl):
  pass
 @abc.abstractmethod
 def version_exists(self,key:GqbyX)->GqbyL:
  pass
 @abc.abstractmethod
 def merge_remote_into_local_version(self,remote_location:GqbyX,key:GqbyX):
  pass
 @abc.abstractmethod
 def _update_key(self,old_key:GqbyX,new_key:GqbyX,base_path:GqbyX)->GqbyL:
  pass
 @abc.abstractmethod
 def _serialize(self,*args:CPVCSObj)->List[GqbyX]:
  pass
 @abc.abstractmethod
 def _deserialize(self,key_serializer:Dict[GqbyX,GqbyX],remote_location:GqbyX=Gqbyl)->List[CPVCSObj]:
  pass
class ObjectStorageLocal(ObjectStorageProvider):
 ...
 def _serialize(self,*args:CPVCSObj)->List[GqbyX]:
  ...
  for cpvcs_obj in args:
   if GqbyT(cpvcs_obj,Version):
    hash_refs.append(self.serializers["version"].store_obj(cpvcs_obj))
   elif GqbyT(cpvcs_obj,Revision):
    hash_refs.append(self.serializers["revision"].store_obj(cpvcs_obj))
  return hash_refs
 def _deserialize(self,key_serializer:Dict[GqbyX,GqbyX],remote_location:GqbyX=Gqbyl)->List[Union[Revision,Version]]:
