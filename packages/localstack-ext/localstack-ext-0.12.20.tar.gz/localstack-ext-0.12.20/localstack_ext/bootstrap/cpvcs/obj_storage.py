...
class StateFileLocator(abc.ABC):
 location="_none_"
 active_instance=MamWI
 @abc.abstractmethod
 def get_state_file_location_by_key(self,key:MamWg)->MamWg:
  pass
 @MamWG
 def get(cls,requested_file_locator:MamWg):
...
class ObjectStorageProvider(abc.ABC):
 ...
 active_instance=MamWI
 @MamWG
 def get(cls,state_file_locator:MamWg,requested_storage:MamWg,serializers:Dict[MamWg,CPVCSSerializer]):
  ...
  return cls.active_instance
 def __init__(self,state_file_locator:StateFileLocator,serializers:Dict[MamWg,CPVCSSerializer]):
 ...
 def get_state_file_location_by_key(self,key:MamWg)->MamWg:
  pass
 @abc.abstractmethod
 def get_version_by_key(self,key:MamWg)->Version:
  pass
 @abc.abstractmethod
 def get_revision_by_key(self,key:MamWg)->Revision:
  pass
 @abc.abstractmethod
 def get_revision_or_version_by_key(self,key:MamWg)->Union[Revision,Version]:
  pass
 @abc.abstractmethod
 def get_delta_file_by_key(self,key:MamWg)->MamWg:
  pass
 @abc.abstractmethod
 def upsert_objects(self,*args:CPVCSObj)->List[MamWg]:
  pass
 @abc.abstractmethod
 def update_revision_key(self,old_key:MamWg,new_key:MamWg,referenced_by_version:MamWg=MamWI):
  pass
 @abc.abstractmethod
 def version_exists(self,key:MamWg)->MamWz:
  pass
 @abc.abstractmethod
 def merge_remote_into_local_version(self,remote_location:MamWg,key:MamWg):
  pass
 @abc.abstractmethod
 def _update_key(self,old_key:MamWg,new_key:MamWg,base_path:MamWg)->MamWz:
  pass
 @abc.abstractmethod
 def _serialize(self,*args:CPVCSObj)->List[MamWg]:
  pass
 @abc.abstractmethod
 def _deserialize(self,key_serializer:Dict[MamWg,MamWg],remote_location:MamWg=MamWI)->List[CPVCSObj]:
  pass
class ObjectStorageLocal(ObjectStorageProvider):
 ...
 def _serialize(self,*args:CPVCSObj)->List[MamWg]:
  ...
  for cpvcs_obj in args:
   if MamWP(cpvcs_obj,Version):
    hash_refs.append(self.serializers["version"].store_obj(cpvcs_obj))
   elif MamWP(cpvcs_obj,Revision):
    hash_refs.append(self.serializers["revision"].store_obj(cpvcs_obj))
  return hash_refs
 def _deserialize(self,key_serializer:Dict[MamWg,MamWg],remote_location:MamWg=MamWI)->List[Union[Revision,Version]]:
