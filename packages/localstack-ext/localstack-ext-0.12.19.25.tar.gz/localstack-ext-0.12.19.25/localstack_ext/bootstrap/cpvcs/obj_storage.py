...
class StateFileLocator(abc.ABC):
 location="_none_"
 active_instance=NCnIt
 @abc.abstractmethod
 def get_state_file_location_by_key(self,key:NCnIl)->NCnIl:
  pass
 @NCnIQ
 def get(cls,requested_file_locator:NCnIl):
...
class ObjectStorageProvider(abc.ABC):
 ...
 active_instance=NCnIt
 @NCnIQ
 def get(cls,state_file_locator:NCnIl,requested_storage:NCnIl,serializers:Dict[NCnIl,CPVCSSerializer]):
  ...
  return cls.active_instance
 def __init__(self,state_file_locator:StateFileLocator,serializers:Dict[NCnIl,CPVCSSerializer]):
 ...
 def get_state_file_location_by_key(self,key:NCnIl)->NCnIl:
  pass
 @abc.abstractmethod
 def get_version_by_key(self,key:NCnIl)->Version:
  pass
 @abc.abstractmethod
 def get_revision_by_key(self,key:NCnIl)->Revision:
  pass
 @abc.abstractmethod
 def get_revision_or_version_by_key(self,key:NCnIl)->Union[Revision,Version]:
  pass
 @abc.abstractmethod
 def get_delta_file_by_key(self,key:NCnIl)->NCnIl:
  pass
 @abc.abstractmethod
 def upsert_objects(self,*args:CPVCSObj)->List[NCnIl]:
  pass
 @abc.abstractmethod
 def update_revision_key(self,old_key:NCnIl,new_key:NCnIl,referenced_by_version:NCnIl=NCnIt):
  pass
 @abc.abstractmethod
 def version_exists(self,key:NCnIl)->NCnIH:
  pass
 @abc.abstractmethod
 def merge_remote_into_local_version(self,remote_location:NCnIl,key:NCnIl):
  pass
 @abc.abstractmethod
 def _update_key(self,old_key:NCnIl,new_key:NCnIl,base_path:NCnIl)->NCnIH:
  pass
 @abc.abstractmethod
 def _serialize(self,*args:CPVCSObj)->List[NCnIl]:
  pass
 @abc.abstractmethod
 def _deserialize(self,key_serializer:Dict[NCnIl,NCnIl],remote_location:NCnIl=NCnIt)->List[CPVCSObj]:
  pass
class ObjectStorageLocal(ObjectStorageProvider):
 ...
 def _serialize(self,*args:CPVCSObj)->List[NCnIl]:
  ...
  for cpvcs_obj in args:
   if NCnIR(cpvcs_obj,Version):
    hash_refs.append(self.serializers["version"].store_obj(cpvcs_obj))
   elif NCnIR(cpvcs_obj,Revision):
    hash_refs.append(self.serializers["revision"].store_obj(cpvcs_obj))
  return hash_refs
 def _deserialize(self,key_serializer:Dict[NCnIl,NCnIl],remote_location:NCnIl=NCnIt)->List[Union[Revision,Version]]:
