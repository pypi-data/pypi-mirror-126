...
setup(
    ...
    version='0.1.10',
    download_url='https://github.com/suap-ead/lib_suap_ead/releases/tag/0.1.10',
    url='https://github.com/suap-ead/lib_suap_ead',
    keywords=['SUAP', 'EAD', 'complemento', 'JWT', 'Django', 'Auth', 'SSO', 'client', 'Theme', ],
    install_requires=['PyJWT>=2.3.0', 'django>=3.2.9', 'djangorestframework==3.11.0', 'sc4py>=0.1.4', 'sc4net>=0.1.2'],
    classifiers=[
