...
def main():
    ...
    check_generic_parser.add_argument(
        'genus_ledger', help='file indicating desired genus names for specific genomes or NONE')
    ...
    add_dummy_parser.add_argument('input_tree', help='input tree file or NONE')
