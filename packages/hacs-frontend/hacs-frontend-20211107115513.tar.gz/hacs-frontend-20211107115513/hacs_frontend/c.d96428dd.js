import{_ as s,H as t,e as o,t as i,m as e,aj as a,a5 as r,p as l,ak as h,al as n,am as c,an as d,ai as p,d as _,r as y,n as m}from"./main-42851b08.js";import{a as u}from"./c.0a038163.js";import"./c.7db9a0c7.js";import"./c.bee36bb6.js";import{s as v}from"./c.f59570d9.js";import{u as g}from"./c.e0898dbe.js";import"./c.5aad7ef9.js";import"./c.c72401a7.js";import"./c.31401eee.js";import"./c.9f27b448.js";import"./c.f195f0b2.js";import"./c.70e07439.js";import"./c.4cf801d0.js";import"./c.0c8dac2c.js";import"./c.2f9eddfe.js";import"./c.28cc9784.js";import"./c.a34115ef.js";import"./c.3944d22b.js";let f=s([m("hacs-install-dialog")],(function(s,t){return{F:class extends t{constructor(...t){super(...t),s(this)}},d:[{kind:"field",decorators:[o()],key:"repository",value:void 0},{kind:"field",decorators:[i()],key:"_toggle",value:()=>!0},{kind:"field",decorators:[i()],key:"_installing",value:()=>!1},{kind:"field",decorators:[i()],key:"_error",value:void 0},{kind:"field",decorators:[i()],key:"_repository",value:void 0},{kind:"field",decorators:[i()],key:"_downloadRepositoryData",value:()=>({beta:!1,version:""})},{kind:"method",key:"shouldUpdate",value:function(s){return s.forEach((s,t)=>{"hass"===t&&(this.sidebarDocked='"docked"'===window.localStorage.getItem("dockedSidebar")),"repositories"===t&&(this._repository=this._getRepository(this.repositories,this.repository))}),s.has("sidebarDocked")||s.has("narrow")||s.has("active")||s.has("_toggle")||s.has("_error")||s.has("_repository")||s.has("_downloadRepositoryData")||s.has("_installing")}},{kind:"field",key:"_getRepository",value:()=>e((s,t)=>null==s?void 0:s.find(s=>s.id===t))},{kind:"field",key:"_getInstallPath",value:()=>e(s=>{let t=s.local_path;return"theme"===s.category&&(t=`${t}/${s.file_name}`),t})},{kind:"method",key:"firstUpdated",value:async function(){var s,t;this._repository=this._getRepository(this.repositories,this.repository),null!==(s=this._repository)&&void 0!==s&&s.updated_info||(await a(this.hass,this._repository.id),this.repositories=await r(this.hass)),this._toggle=!1,this.hass.connection.subscribeEvents(s=>this._error=s.data,"hacs/error"),this._downloadRepositoryData.beta=this._repository.beta,this._downloadRepositoryData.version="version"===(null===(t=this._repository)||void 0===t?void 0:t.version_or_commit)?this._repository.releases[0]:""}},{kind:"method",key:"render",value:function(){var s;if(!this.active||!this._repository)return l``;const t=this._getInstallPath(this._repository),o=[{type:"boolean",name:"beta"},{type:"select",name:"version",optional:!0,options:"version"===this._repository.version_or_commit?this._repository.releases.map(s=>[s,s]).concat(["hacs/integration"===this._repository.full_name||this._repository.hide_default_branch?["",""]:[this._repository.default_branch,this._repository.default_branch]]):[]}];return l`
      <hacs-dialog
        .active=${this.active}
        .narrow=${this.narrow}
        .hass=${this.hass}
    ...
    `}},{kind:"method",key:"_valueChanged",value:async function(s){this._downloadRepositoryData.beta!==s.detail.value.beta&&(this._toggle=!0,await n(this.hass,this.repository),this.repositories=await r(this.hass),this._toggle=!1),this._downloadRepositoryData=s.detail.value}},{kind:"method",key:"_installRepository",value:async function(){var s;if(this._installing=!0,!this._repository)return;const t=this._downloadRepositoryData.version||this._repository.available_version||this._repository.default_branch;"commit"!==(null===(s=this._repository)||void 0===s?void 0:s.version_or_commit)?await c(this.hass,this._repository.id,t):await d(this.hass,this._repository.id),this.hacs.log.debug(this._repository.category,"_installRepository"),this.hacs.log.debug(this.hacs.status.lovelace_mode,"_installRepository"),"plugin"===this._repository.category&&"storage"===this.hacs.status.lovelace_mode&&await g(this.hass,this._repository,t),this._installing=!1,this.dispatchEvent(new Event("hacs-secondary-dialog-closed",{bubbles:!0,composed:!0})),this.dispatchEvent(new Event("hacs-dialog-closed",{bubbles:!0,composed:!0})),"plugin"===this._repository.category&&"storage"===this.hacs.status.lovelace_mode&&v(this,{title:this.hacs.localize("common.reload"),text:l`${this.hacs.localize("dialog.reload.description")}</br>${this.hacs.localize("dialog.reload.confirm")}`,dismissText:this.hacs.localize("common.cancel"),confirmText:this.hacs.localize("common.reload"),confirm:()=>{p.location.href=p.location.href}})}},{kind:"get",static:!0,key:"styles",value:function(){return[_,y`
      ...
      `]}}]}}),t);export{f as HacsInstallDialog};
