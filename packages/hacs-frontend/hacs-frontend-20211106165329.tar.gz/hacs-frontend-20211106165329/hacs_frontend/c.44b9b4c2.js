import{_ as i,H as s,e as t,m as o,ak as a,ac as e,p as r,ay as h,az as c,aA as n,aB as l,aC as p,c as d,r as u,n as y}from"./main-5345dc77.js";import"./c.4ae0ea3f.js";import{m as _}from"./c.1e5c960c.js";import"./c.0447beb9.js";import"./c.b40ebb03.js";import"./c.0be06691.js";import"./c.9f27b448.js";import"./c.0a038163.js";let m=i([y("hacs-repository-info-dialog")],(function(i,s){return{F:class extends s{constructor(...s){super(...s),i(this)}},d:[{kind:"field",decorators:[t()],key:"repository",value:void 0},{kind:"field",decorators:[t({attribute:!1})],key:"_repository",value:void 0},{kind:"field",key:"_getRepository",value:()=>o((i,s)=>null==i?void 0:i.find(i=>i.id===s))},{kind:"field",key:"_getAuthors",value:()=>o(i=>{const s=[];if(!i.authors)return s;if(i.authors.forEach(i=>s.push(i.replace("@",""))),0===s.length){const t=i.full_name.split("/")[0];if(["custom-cards","custom-components","home-assistant-community-themes"].includes(t))return s;s.push(t)}return s})},{kind:"method",key:"shouldUpdate",value:function(i){return i.forEach((i,s)=>{"hass"===s&&(this.sidebarDocked='"docked"'===window.localStorage.getItem("dockedSidebar")),"repositories"===s&&(this._repository=this._getRepository(this.repositories,this.repository))}),i.has("sidebarDocked")||i.has("narrow")||i.has("active")||i.has("_repository")}},{kind:"method",key:"firstUpdated",value:async function(){var i;this._repository=this._getRepository(this.repositories,this.repository),null!==(i=this._repository)&&void 0!==i&&i.updated_info||(await a(this.hass,this._repository.id),this.repositories=await e(this.hass))}},{kind:"method",key:"render",value:function(){if(!this.active||!this._repository)return r``;const i=this._getAuthors(this._repository);return r`
      <hacs-dialog
      ...
      >
        <div class="content scroll">
          ${this._repository.updated_info?r` <div class="chips">
    ...
    `}},{kind:"get",static:!0,key:"styles",value:function(){return[d,u`
        .content {
          width: calc(100% - 12px);
          max-height: 75vh;
          padding-right: 12px;
