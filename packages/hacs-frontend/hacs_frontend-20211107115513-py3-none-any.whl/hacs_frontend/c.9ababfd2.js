import{g as t,h as e,e as i,t as a,C as o,j as s,R as n,p as r,o as d,r as l,n as c,_ as p,D as h,E as m,P as u,J as f,L as b,aO as v,l as g,m as x,aM as y,aP as w,aQ as _,aR as k,a9 as $,aS as z,W as R,aj as T,aT as C,ah as E,ap as F,ak as L,as as S,at as A,d as I,a as j,aU as P,b as B,aV as M,aW as O,aX as D,aY as H,aZ as N,s as U,c as Y}from"./main-42851b08.js";import{f as V}from"./c.d4bf3663.js";import{i as W,s as q}from"./c.aa401ed8.js";import"./c.a34115ef.js";import"./c.31401eee.js";import{a as K}from"./c.0a038163.js";import"./c.1dfe664d.js";import"./c.001b66dc.js";import{a as G}from"./c.f59570d9.js";import"./c.5aad7ef9.js";import"./c.70e07439.js";import"./c.4cf801d0.js";import"./c.d53914f2.js";import"./c.3944d22b.js";import"./c.2f9eddfe.js";import"./c.9f27b448.js";class J extends s{constructor(){super(...arguments),this.mini=!1,this.exited=!1,this.disabled=!1,this.extended=!1,this.showIconAtEnd=!1,this.reducedTouchTarget=!1,this.icon="",this.label="",this.shouldRenderRipple=!1,this.useStateLayerCustomProperties=!1,this.rippleHandlers=new n(()=>(this.shouldRenderRipple=!0,this.ripple))}render(){const t=this.mini&&!this.reducedTouchTarget,e={"mdc-fab--mini":this.mini,"mdc-fab--touch":t,"mdc-fab--exited":this.exited,"mdc-fab--extended":this.extended,"icon-end":this.showIconAtEnd},i=this.label?this.label:this.icon;return r`<button
          class="mdc-fab ${d(e)}"
...
`,is:"paper-tooltip",hostAttributes:{role:"tooltip",tabindex:-1},properties:{for:{type:String,observer:"_findTarget"},manualMode:{type:Boolean,value:!1,observer:"_manualModeChanged"},position:{type:String,value:"bottom"},fitToVisibleBounds:{type:Boolean,value:!1},offset:{type:Number,value:14},marginTop:{type:Number,value:14},animationDelay:{type:Number,value:500,observer:"_delayChange"},animationEntry:{type:String,value:""},animationExit:{type:String,value:""},animationConfig:{type:Object,value:function(){return{entry:[{name:"fade-in-animation",node:this,timing:{delay:0}}],exit:[{name:"fade-out-animation",node:this}]}}},_showing:{type:Boolean,value:!1}},listeners:{webkitAnimationEnd:"_onAnimationEnd"},get target(){var t=b(this).parentNode,e=b(this).getOwnerRoot();return this.for?b(e).querySelector("#"+this.for):t.nodeType==Node.DOCUMENT_FRAGMENT_NODE?e.host:t},attached:function(){this._findTarget()},detached:function(){this.manualMode||this._removeListeners()},playAnimation:function(t){"entry"===t?this.show():"exit"===t&&this.hide()},cancelAnimation:function(){this.$.tooltip.classList.add("cancel-animation")},show:function(){if(!this._showing){if(""===b(this).textContent.trim()){for(var t=!0,e=b(this).getEffectiveChildNodes(),i=0;i<e.length;i++)if(""!==e[i].textContent.trim()){t=!1;break}if(t)return}this._showing=!0,this.$.tooltip.classList.remove("hidden"),this.$.tooltip.classList.remove("cancel-animation"),this.$.tooltip.classList.remove(this._getAnimationType("exit")),this.updatePosition(),this._animationPlaying=!0,this.$.tooltip.classList.add(this._getAnimationType("entry"))}},hide:function(){if(this._showing){if(this._animationPlaying)return this._showing=!1,void this._cancelAnimation();this._onAnimationFinish(),this._showing=!1,this._animationPlaying=!0}},updatePosition:function(){if(this._target&&this.offsetParent){var t=this.offset;14!=this.marginTop&&14==this.offset&&(t=this.marginTop);var e,i,a=this.offsetParent.getBoundingClientRect(),o=this._target.getBoundingClientRect(),s=this.getBoundingClientRect(),n=(o.width-s.width)/2,r=(o.height-s.height)/2,d=o.left-a.left,l=o.top-a.top;switch(this.position){case"top":e=d+n,i=l-s.height-t;break;case"bottom":e=d+n,i=l+o.height+t;break;case"left":e=d-s.width-t,i=l+r;break;case"right":e=d+o.width+t,i=l+r}this.fitToVisibleBounds?(a.left+e+s.width>window.innerWidth?(this.style.right="0px",this.style.left="auto"):(this.style.left=Math.max(0,e)+"px",this.style.right="auto"),a.top+i+s.height>window.innerHeight?(this.style.bottom=a.height-l+t+"px",this.style.top="auto"):(this.style.top=Math.max(-a.top,i)+"px",this.style.bottom="auto")):(this.style.left=e+"px",this.style.top=i+"px")}},_addListeners:function(){this._target&&(this.listen(this._target,"mouseenter","show"),this.listen(this._target,"focus","show"),this.listen(this._target,"mouseleave","hide"),this.listen(this._target,"blur","hide"),this.listen(this._target,"tap","hide")),this.listen(this.$.tooltip,"animationend","_onAnimationEnd"),this.listen(this,"mouseenter","hide")},_findTarget:function(){this.manualMode||this._removeListeners(),this._target=this.target,this.manualMode||this._addListeners()},_delayChange:function(t){500!==t&&this.updateStyles({"--paper-tooltip-delay-in":t+"ms"})},_manualModeChanged:function(){this.manualMode?this._removeListeners():this._addListeners()},_cancelAnimation:function(){this.$.tooltip.classList.remove(this._getAnimationType("entry")),this.$.tooltip.classList.remove(this._getAnimationType("exit")),this.$.tooltip.classList.remove("cancel-animation"),this.$.tooltip.classList.add("hidden")},_onAnimationFinish:function(){this._showing&&(this.$.tooltip.classList.remove(this._getAnimationType("entry")),this.$.tooltip.classList.remove("cancel-animation"),this.$.tooltip.classList.add(this._getAnimationType("exit")))},_onAnimationEnd:function(){this._animationPlaying=!1,this._showing||(this.$.tooltip.classList.remove(this._getAnimationType("exit")),this.$.tooltip.classList.add("hidden"))},_getAnimationType:function(t){if("entry"===t&&""!==this.animationEntry)return this.animationEntry;if("exit"===t&&""!==this.animationExit)return this.animationExit;if(this.animationConfig[t]&&"string"==typeof this.animationConfig[t][0].name){if(this.animationConfig[t][0].timing&&this.animationConfig[t][0].timing.delay&&0!==this.animationConfig[t][0].timing.delay){var e=this.animationConfig[t][0].timing.delay;"entry"===t?this.updateStyles({"--paper-tooltip-delay-in":e+"ms"}):"exit"===t&&this.updateStyles({"--paper-tooltip-delay-out":e+"ms"})}return this.animationConfig[t][0].name}},_removeListeners:function(){this._target&&(this.unlisten(this._target,"mouseenter","show"),this.unlisten(this._target,"focus","show"),this.unlisten(this._target,"mouseleave","hide"),this.unlisten(this._target,"blur","hide"),this.unlisten(this._target,"tap","hide")),this.unlisten(this.$.tooltip,"animationend","_onAnimationEnd"),this.unlisten(this,"mouseenter","hide")}}),p([c("ha-icon-overflow-menu")],(function(t,e){return{F:class extends e{constructor(...e){super(...e),t(this)}},d:[{kind:"field",decorators:[i({attribute:!1})],key:"hass",value:void 0},{kind:"field",decorators:[i({type:Array})],key:"items",value:()=>[]},{kind:"field",decorators:[i({type:Boolean})],key:"narrow",value:()=>!1},{kind:"method",key:"render",value:function(){return r`
      ...
      <ha-card class=${d(this._borderClass)} ?narrow=${this.narrow}>
        ...
        <div class="card-actions">
          ...
          ${this.repository.installed?r` <ha-icon-overflow-menu
                ...
                narrow
                .hass=${this.hass}
                .items=${[{path:y,label:this.hacs.localize("repository_card.information"),action:()=>this._showReopsitoryInfo()},{path:w,label:this.hacs.localize("repository_card.update_information"),action:()=>this._updateReopsitoryInfo()},{path:_,label:this.hacs.localize("repository_card.redownload"),action:()=>this._installRepository()},{category:"plugin",path:k,label:this.hacs.localize("repository_card.open_source"),action:()=>{var e;return null===(e=top)||void 0===e?void 0:e.open(`/hacsfiles/${t.pop()}/${this.repository.file_name}`,"_blank","noreferrer=true")}},{path:$,label:this.hacs.localize("repository_card.open_issue"),action:()=>{var t;return null===(t=top)||void 0===t?void 0:t.open(`https://github.com/${this.repository.full_name}/issues`,"_blank","noreferrer=true")}},{hideForId:"172733314",path:z,label:this.hacs.localize("repository_card.report"),action:()=>{var t;return null===(t=top)||void 0===t?void 0:t.open(`https://github.com/hacs/integration/issues/new?assignees=ludeeus&labels=flag&template=removal.yml&repo=${this.repository.full_name}&title=Request for removal of ${this.repository.full_name}`,"_blank","noreferrer=true")}},{hideForId:"172733314",path:R,label:this.hacs.localize("common.remove"),action:()=>this._uninstallRepositoryDialog()}].filter(t=>!(t.category&&this.repository.category!==t.category||t.hideForId&&String(this.repository.id)===t.hideForId))}
              >
              </ha-icon-overflow-menu>`:""}
        </div>
      </ha-card>
    `}},{kind:"method",key:"_updateReopsitoryInfo",value:async function(){await T(this.hass,this.repository.id)}},{kind:"method",key:"_showReopsitoryInfo",value:async function(){this.dispatchEvent(new CustomEvent("hacs-dialog",{detail:{type:"repository-info",repository:this.repository.id},bubbles:!0,composed:!0}))}},{kind:"method",key:"_updateRepository",value:async function(){this.dispatchEvent(new CustomEvent("hacs-dialog",{detail:{type:"update",repository:this.repository.id},bubbles:!0,composed:!0}))}},{kind:"method",key:"_setNotNew",value:async function(){await C(this.hass,this.repository.id)}},{kind:"method",key:"_installRepository",value:function(){this.dispatchEvent(new CustomEvent("hacs-dialog",{detail:{type:"install",repository:this.repository.id},bubbles:!0,composed:!0}))}},{kind:"method",key:"_uninstallRepositoryDialog",value:async function(){if("integration"===this.repository.category&&this.repository.config_flow){if((await(t=this.hass,t.callApi("GET","config/config_entries/entry"))).some(t=>t.domain===this.repository.domain))return void await G(this,{title:this.hacs.localize("dialog.configured.title"),text:this.hacs.localize("dialog.configured.message",{name:this.repository.name}),confirmText:this.hacs.localize("dialog.configured.confirm"),confirm:()=>{E("/config/integrations",{replace:!0})}})}var t;this.dispatchEvent(new CustomEvent("hacs-dialog",{detail:{type:"progress",title:this.hacs.localize("dialog.remove.title"),confirmText:this.hacs.localize("dialog.remove.title"),content:this.hacs.localize("dialog.remove.message",{name:this.repository.name}),confirm:async()=>{await this._uninstallRepository()}},bubbles:!0,composed:!0}))}},{kind:"method",key:"_uninstallRepository",value:async function(){var t;if("plugin"===this.repository.category&&"yaml"!==(null===(t=this.hacs.status)||void 0===t?void 0:t.lovelace_mode)){const t=await F(this.hass),e=L({repository:this.repository,skipTag:!0});await Promise.all(t.filter(t=>t.url.includes(e)).map(t=>S(this.hass,String(t.id))))}await A(this.hass,this.repository.id)}},{kind:"get",static:!0,key:"styles",value:function(){return[I,l`
        ha-card {
          display: flex;
          flex-direction: column;
          height: 100%;
      ...
      `]}}]}}),s);let tt=p([c("hacs-store-panel")],(function(t,e){return{F:class extends e{constructor(...e){super(...e),t(this)}},d:[{kind:"field",decorators:[i({attribute:!1})],key:"filters",value:()=>({})},{kind:"field",decorators:[i({attribute:!1})],key:"hacs",value:void 0},{kind:"field",decorators:[i()],key:"_searchInput",value:()=>""},{kind:"field",decorators:[i({attribute:!1})],key:"hass",value:void 0},{kind:"field",decorators:[i({attribute:!1})],key:"narrow",value:void 0},{kind:"field",decorators:[i({attribute:!1})],key:"isWide",value:void 0},{kind:"field",decorators:[i({attribute:!1})],key:"repositories",value:void 0},{kind:"field",decorators:[i({attribute:!1})],key:"route",value:void 0},{kind:"field",decorators:[i({attribute:!1})],key:"sections",value:void 0},{kind:"field",decorators:[i()],key:"section",value:void 0},{kind:"field",key:"_repositoriesInActiveSection",value(){return x((t,e)=>[(null==t?void 0:t.filter(t=>{var i,a,o;return(null===(i=this.hacs.sections)||void 0===i||null===(a=i.find(t=>t.id===e))||void 0===a||null===(o=a.categories)||void 0===o?void 0:o.includes(t.category))&&t.installed}))||[],(null==t?void 0:t.filter(t=>{var i,a,o;return(null===(i=this.hacs.sections)||void 0===i||null===(a=i.find(t=>t.id===e))||void 0===a||null===(o=a.categories)||void 0===o?void 0:o.includes(t.category))&&t.new&&!t.installed}))||[]])}},{kind:"get",key:"allRepositories",value:function(){const[t,e]=this._repositoriesInActiveSection(this.repositories,this.section);return e.concat(t)}},{kind:"field",key:"_filterRepositories",value:()=>x(V)},{kind:"get",key:"visibleRepositories",value:function(){const t=this.allRepositories.filter(t=>{var e,i;return null===(e=this.filters[this.section])||void 0===e||null===(i=e.find(e=>e.id===t.category))||void 0===i?void 0:i.checked});return this._filterRepositories(t,this._searchInput)}},{kind:"method",key:"firstUpdated",value:async function(){this.addEventListener("filter-change",t=>this._updateFilters(t))}},{kind:"method",key:"_updateFilters",value:function(t){var e;const i=null===(e=this.filters[this.section])||void 0===e?void 0:e.find(e=>e.id===t.detail.id);this.filters[this.section].find(t=>t.id===i.id).checked=!i.checked,this.requestUpdate()}},{kind:"method",key:"render",value:function(){var t,e;if(!this.hacs)return r``;const i=this._repositoriesInActiveSection(this.repositories,this.section)[1];if(!this.filters[this.section]&&this.hacs.configuration.categories){var a;const t=null===(a=j(this.hacs.language,this.route))||void 0===a?void 0:a.categories;this.filters[this.section]=[],null==t||t.filter(t=>{var e;return null===(e=this.hacs.configuration)||void 0===e?void 0:e.categories.includes(t)}).forEach(t=>{this.filters[this.section].push({id:t,value:t,checked:!0})})}return r`<hass-tabs-subpage
    ...
    >
      <ha-icon-overflow-menu
        ...
        narrow
        .hass=${this.hass}
        .items=${[{path:P,label:this.hacs.localize("menu.documentation"),action:()=>{var t;return null===(t=top)||void 0===t?void 0:t.open("https://hacs.xyz/","_blank","noreferrer=true")}},{path:B,label:"GitHub",action:()=>{var t;return null===(t=top)||void 0===t?void 0:t.open("https://github.com/hacs","_blank","noreferrer=true")}},{path:$,label:this.hacs.localize("menu.open_issue"),action:()=>{var t;return null===(t=top)||void 0===t?void 0:t.open("https://hacs.xyz/docs/issues","_blank","noreferrer=true")}},{path:M,label:this.hacs.localize("menu.dismiss"),disabled:0===(null===(t=this.repositories)||void 0===t?void 0:t.filter(t=>{var e,i,a;return t.new&&(null===(e=this.hacs.sections)||void 0===e||null===(i=e.find(t=>t.id===this.section))||void 0===i||null===(a=i.categories)||void 0===a?void 0:a.includes(t.category))}).length),action:()=>this._clearAllNewRepositories()},{path:O,label:this.hacs.localize("menu.custom_repositories"),disabled:this.hacs.status.disabled||this.hacs.status.background_task,action:()=>this.dispatchEvent(new CustomEvent("hacs-dialog",{detail:{type:"custom-repositories",repositories:this.repositories},bubbles:!0,composed:!0}))},{path:y,label:this.hacs.localize("menu.about"),action:()=>q(this,this.hacs)}]}
      >
      </ha-icon-overflow-menu>
      ${this.narrow?r`
            <div slot="header">
          ...
          `:r`<div class="search">
            <search-input
              .hass=${this.hass}
              no-label-float
              .label=${0===i.length?this.hacs.localize("search.downloaded"):this.hacs.localize("search.downloaded_new")}
              .filter=${this._searchInput||""}
              @value-changed=${this._inputValueChanged}
            ></search-input>
          </div>`}
      <div class="content ${this.narrow?"narrow-content":""}">
        ${(null===(e=this.filters[this.section])||void 0===e?void 0:e.length)>1?r`<div class="filters">
              <hacs-filter
                .hacs=${this.hacs}
                .filters="${this.filters[this.section]}"
              ></hacs-filter>
            </div>`:""}
        ${(null==i?void 0:i.length)>10?r`<div class="new-repositories">
      ...
      >
        ...
        ></hacs-repository-card>`)}},{kind:"method",key:"_clearAllNewRepositories",value:async function(){var t;await H(this.hass,(null===(t=j(this.hacs.language,this.route))||void 0===t?void 0:t.categories)||[])}},{kind:"method",key:"_renderNoResultsFound",value:function(){return r`<ha-card class="no-repositories">
