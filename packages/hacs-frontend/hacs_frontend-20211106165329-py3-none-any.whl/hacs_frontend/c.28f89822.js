import{_ as i,H as t,e as s,p as e,r as a,aq as o,at as r,au as l,n}from"./main-5345dc77.js";import"./c.b40ebb03.js";import"./c.0be06691.js";import"./c.9f27b448.js";import"./c.0a038163.js";let c=i([n("hacs-removed-dialog")],(function(i,t){return{F:class extends t{constructor(...t){super(...t),i(this)}},d:[{kind:"field",decorators:[s({attribute:!1})],key:"repository",value:void 0},{kind:"field",decorators:[s({type:Boolean})],key:"_updating",value:()=>!1},{kind:"method",key:"render",value:function(){if(!this.active)return e``;const i=this.hacs.removed.find(i=>i.repository===this.repository.full_name);return e`
      <hacs-dialog
        .active=${this.active}
        .hass=${this.hass}
