import{_ as e,g as a,e as s,i,p as t,av as o,o as n,K as r,r as l,n as d,H as c,m as h,C as p,D as m,aw as u,ax as v,an as g,ao as y,aj as _,c as f}from"./main-5345dc77.js";import{a as x}from"./c.0a038163.js";import"./c.6d176023.js";import{s as b}from"./c.04b7893a.js";import{m as k}from"./c.1e5c960c.js";import{u as $}from"./c.a0510e6b.js";import"./c.0447beb9.js";import"./c.b40ebb03.js";import"./c.0be06691.js";import"./c.9f27b448.js";const w=()=>new Promise(e=>{var a;a=e,requestAnimationFrame(()=>setTimeout(a,0))});e([d("ha-expansion-panel")],(function(e,a){return{F:class extends a{constructor(...a){super(...a),e(this)}},d:[{kind:"field",decorators:[s({type:Boolean,reflect:!0})],key:"expanded",value:()=>!1},{kind:"field",decorators:[s({type:Boolean,reflect:!0})],key:"outlined",value:()=>!1},{kind:"field",decorators:[s()],key:"header",value:void 0},{kind:"field",decorators:[s()],key:"secondary",value:void 0},{kind:"field",decorators:[i(".container")],key:"_container",value:void 0},{kind:"method",key:"render",value:function(){return t`
      ...
      >
        <div class=${n({content:!0,narrow:this.narrow})}>
          ...
          ${this._releaseNotes.length>0?this._releaseNotes.map(e=>t`
                    ...
                    >
                      ${e.body?k.html(e.body,a):this.hacs.localize("dialog_update.no_info")}
                    </ha-expansion-panel>
                  `):""}
          ${a.can_install?"":t`<ha-alert alert-type="error" .rtl=${x(this.hass)}>
          ...
          ${null!==(e=this._error)&&void 0!==e&&e.message?t`<ha-alert alert-type="error" .rtl=${x(this.hass)}>
                  ${this._error.message}
                </ha-alert>`:""}
        </div>
        <mwc-button
    ...
    `:t``}},{kind:"method",key:"_updateRepository",value:async function(){this._updating=!0;const e=this._getRepository(this.repositories,this.repository);e&&("commit"!==e.version_or_commit?await g(this.hass,e.id,e.available_version):await y(this.hass,e.id),"plugin"===e.category&&"storage"===this.hacs.status.lovelace_mode&&await $(this.hass,e,e.available_version),this._updating=!1,this.dispatchEvent(new Event("hacs-dialog-closed",{bubbles:!0,composed:!0})),"plugin"===e.category&&b(this,{title:this.hacs.localize("common.reload"),text:t`${this.hacs.localize("dialog.reload.description")}</br>${this.hacs.localize("dialog.reload.confirm")}`,dismissText:this.hacs.localize("common.cancel"),confirmText:this.hacs.localize("common.reload"),confirm:()=>{_.location.href=_.location.href}}))}},{kind:"method",key:"_getChanglogURL",value:function(){const e=this._getRepository(this.repositories,this.repository);if(e)return"commit"===e.version_or_commit?`https://github.com/${e.full_name}/compare/${e.installed_version}...${e.available_version}`:`https://github.com/${e.full_name}/releases`}},{kind:"get",static:!0,key:"styles",value:function(){return[f,l`
      ...
      `]}}]}}),c);export{z as HacsUpdateDialog};
