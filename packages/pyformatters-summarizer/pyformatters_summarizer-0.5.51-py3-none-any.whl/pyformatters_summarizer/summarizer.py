...
class SummarizerParameters(FormatterParameters):
    as_metadata: bool = Field(False, description="""If `true` generate the summary as a metadata of the input document,
    if `false` replace the text of the inout document and remove all existing annotations and sentences.""")
