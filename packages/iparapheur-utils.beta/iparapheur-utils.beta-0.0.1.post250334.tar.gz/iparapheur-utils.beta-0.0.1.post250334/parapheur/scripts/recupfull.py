        ...
        try:
            ...
            if download:
                ...
                if not is_already_downloaded:
                    ...
                    if dossier['original'] == "true":
                        ...
                        if dossier['isXemEnabled']:
                            ...
                            if dossier_distant_original_name.endswith(".pdf.zip"):
                                multidoc = True
                                dossier_distant_original_name = dossier_distant_original_name.replace(".pdf.zip",".zip")
                    ...
                    if multidoc:
                        multidoc_path = download_folder_path + "/multidoc"
                        os.system("cd " + multidoc_path + " & mkdir multidoc")
                        # print("unzip " + download_folder_path + "/" + dossier_local_original_name + " " + multidoc_path)
                        os.system("unzip " + download_folder_path + "/" + dossier_local_original_name + " -d " + multidoc_path)
