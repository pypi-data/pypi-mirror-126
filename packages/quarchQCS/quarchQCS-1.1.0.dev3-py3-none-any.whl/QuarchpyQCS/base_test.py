...
class BaseTest(ABC):
    ...
    def check_point(self, unique_id, description, function, function_args, has_return=False, group=None,
        ...
        if self.cv_run_custom_code.custom_value == "before":
        ...
        if self.cv_run_custom_code.custom_value == "after":
            if self.cv_custom_code:
                if self.test_id.check_valid_test_id(self.cv_custom_code_id, unique_id):
                    self.execute_custom_code(self.cv_custom_code.custom_value)
