...
class QuantfuryPositions(Base):
    ...
    def close_with_earnings(self, client, target_price):
        ...
        try:
            ...
            logger.critical('func=QuantfuryPositions.close_with_earnings, target_price={}, stage={}, msg={}'.format(
                target_price, stage, e))
    ...
    def sync_orders(cls, client):
        ...
        orders = {
        "id": "7db7b0bf-4717-4e4b-a98a-dc87b82de9dd",
        "openPositions": [
          {
            "id": "f8088ec3-c05a-4a9f-bb57-41db1cd7e629",
            "shortName": "BTC/USDT",
            "openPrice": 46000,
            "quantity": 0.000262262682,
            "amountInstrument": 10.0,
            "amountSystem": 10.0,
            "openDate": 1628046360,
            "stopOrders": [
              {
                "id": "fd447836-c359-4814-9fab-df2bf711b47a",
                "tradingPositionId": "f8088ec3-c05a-4a9f-bb57-41db1cd7e629",
                "orderType": 0,
                "price": 45000,
                "quantity": 0.000262262682,
                "amountInstrument": 10.0,
            ...
            "order": 0,
            "sessionCurrency": "DAI",
            "sessionId": "7db7b0bf-4717-4e4b-a98a-dc87b82de9dd",
            "spreadAdjustmentEndDate": 1628046360,
            "positionType": 1
          }
        ],
        "activeLimitOrders": [],
        "currency": "DAI",
        "balanceAccount": 101.0,
        "state": 4,
        "pnlAccountClosePositions": -59.92,
        "pnlSystemClosePositions": -61.01,
        "pnlAccountDividends": 0.16,
        "pnlSystemDividends": 0.16,
        "shoulder": 2000.0,
        "withdrawalsTotal": 0.0,
        "withdrawalsTotalAmountSystem": 0.0,
        "depositsTotal": 101.0,
        "depositsTotalAmountSystem": 101.0,
        "walletAddress": "0xeec7ff361a96c5d1354c552cb67bacd86c05f05f",
        "openDate": 1589517260,
        "useFullFillForOpen": False
        }
