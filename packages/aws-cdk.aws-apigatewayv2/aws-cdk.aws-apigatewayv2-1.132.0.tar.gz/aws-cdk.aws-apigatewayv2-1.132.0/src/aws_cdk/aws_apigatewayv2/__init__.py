...
web_socket_api = apigwv2.WebSocketApi(self, "mywsapi",
    connect_route_options=WebSocketRouteOptions(integration=LambdaWebSocketIntegration(handler=connect_handler)),
    disconnect_route_options=WebSocketRouteOptions(integration=LambdaWebSocketIntegration(handler=disconnect_handler)),
    default_route_options=WebSocketRouteOptions(integration=LambdaWebSocketIntegration(handler=default_handler))
)
