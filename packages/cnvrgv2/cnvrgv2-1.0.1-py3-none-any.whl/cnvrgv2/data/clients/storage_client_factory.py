...
storage_clients_imports = [
    "from cnvrgp.data.clients.s3.client import S3Storage",
    "from cnvrgp.data.clients.azure.client import AzureStorage",
    "from cnvrgp.data.clients.minio.client import MinioStorage",
    "from cnvrgp.data.clients.gcp.client import GCPStorage"
]
