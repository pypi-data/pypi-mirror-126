...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".wipp-pluginCreatorSidebar {\n    background: var(--jp-layout-color1);\n    color: var(--jp-ui-font-color1);\n    font-size: var(--jp-ui-font-size1);\n    overflow: auto;\n  }\n\n.wipp-pluginCreatorSidebar button.run\n{\n    color: #000000;\n    background-color: var(--jp-brand-color2);\n    border: 1px solid var(--jp-brand-color2);\n    text-transform: uppercase;\n}", "",{"version":3,"sources":["webpack://./style/base.css"],"names":[],"mappings":"AAAA;IACI,mCAAmC;IACnC,+BAA+B;IAC/B,kCAAkC;IAClC,cAAc;EAChB;;AAEF;;IAEI,cAAc;IACd,wCAAwC;IACxC,wCAAwC;IACxC,yBAAyB;AAC7B","sourcesContent":[".wipp-pluginCreatorSidebar {\n    background: var(--jp-layout-color1);\n    color: var(--jp-ui-font-color1);\n    font-size: var(--jp-ui-font-size1);\n    overflow: auto;\n  }\n\n.wipp-pluginCreatorSidebar button.run\n{\n    color: #000000;\n    background-color: var(--jp-brand-color2);\n    border: 1px solid var(--jp-brand-color2);\n    text-transform: uppercase;\n}"],"sourceRoot":""}]);
// Exports
...
//# sourceMappingURL=style_index_js.5582c7331781b6c0885e.js.map