/*! For license information please see bf9a9b1e.js.LICENSE.txt */
...
`;n.setAttribute("style","display: none;"),document.head.appendChild(n.content)},33760:(t,e,i)=>{i.d(e,{U:()=>o});i(94604);var n=i(51644),a=i(26110);const o=[n.P,a.a,{hostAttributes:{role:"option",tabindex:"0"}}]},97968:(t,e,i)=>{i(65660),i(15495),i(1656),i(47686);const n=document.createElement("template");n.setAttribute("style","display: none;"),n.innerHTML="<dom-module id=\"paper-item-shared-styles\">\n  <template>\n    <style>\n      :host, .paper-item {\n        display: block;\n        position: relative;\n        min-height: var(--paper-item-min-height, 48px);\n        padding: 0px 16px;\n      }\n\n      .paper-item {\n        @apply --paper-font-subhead;\n        border:none;\n        outline: none;\n        background: white;\n        width: 100%;\n        text-align: left;\n      }\n\n      :host([hidden]), .paper-item[hidden] {\n        display: none !important;\n      }\n\n      :host(.iron-selected), .paper-item.iron-selected {\n        font-weight: var(--paper-item-selected-weight, bold);\n\n        @apply --paper-item-selected;\n      }\n\n      :host([disabled]), .paper-item[disabled] {\n        color: var(--paper-item-disabled-color, var(--disabled-text-color));\n\n        @apply --paper-item-disabled;\n      }\n\n      :host(:focus), .paper-item:focus {\n        position: relative;\n        outline: 0;\n\n        @apply --paper-item-focused;\n      }\n\n      :host(:focus):before, .paper-item:focus:before {\n        @apply --layout-fit;\n\n        background: currentColor;\n        content: '';\n        opacity: var(--dark-divider-opacity);\n        pointer-events: none;\n\n        @apply --paper-item-focused-before;\n      }\n    </style>\n  </template>\n</dom-module>",document.head.appendChild(n.content)},53973:(t,e,i)=>{i(94604),i(65660),i(97968);var n=i(9672),a=i(50856),o=i(33760);(0,n.k)({_template:a.d`
    ...
    <slot></slot>
`,is:"paper-item",behaviors:[o.U]})},51095:(t,e,i)=>{i(94604),i(1656);var n=i(78161),a=i(9672),o=i(50856);(0,a.k)({_template:o.d`
    <style>
      :host {
        display: block;
        padding: 8px 0;
...
//# sourceMappingURL=bf9a9b1e.js.map