...
def create_kube_cluster(
    ...
    with cluster_utils.KubeClusterContext(cluster, creds, kube_cluster_name=kube_cluster_name, namespace="serving"):
        if support_runs:
...
def update_kube_cluster(
    ...
    with cluster_utils.KubeClusterContext(cluster, creds, namespace="serving"):
