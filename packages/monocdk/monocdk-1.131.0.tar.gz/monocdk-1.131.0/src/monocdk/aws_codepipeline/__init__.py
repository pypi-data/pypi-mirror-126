...
codepipeline.CustomActionRegistration(self, "GenericGitSourceProviderResource",
    ...
    artifact_bounds=ActionArtifactBounds(min_inputs=0, max_inputs=0, min_outputs=1, max_outputs=1),
    ...
    action_properties=[CustomActionProperty(
        name="Branch",
        required=True,
        key=False,
        secret=False,
...
class CustomActionRegistration(
    ...
    def __init__(
        ...
        *,
        ...
        :param provider: (experimental) The provider of the Action.
