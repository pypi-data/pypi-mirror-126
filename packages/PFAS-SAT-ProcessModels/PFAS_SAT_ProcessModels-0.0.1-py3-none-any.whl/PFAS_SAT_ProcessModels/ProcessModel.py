...
class ProcessModel(ABC):
    ...
    def plot_sankey(self, **kwargs):
        ...
        Sankey(flows=flows, labels=labels, orientations=orientations,
    ...
    def plot_sankey_report(self, **kwargs):
        ...
        ax1 = fig.add_subplot(1, 2, 1, xticks=[], yticks=[],
                              title="Total Incoming PFOA: " + format(Total, '.2E') + " μg")
        Sankey(ax=ax1, flows=flows, labels=labels, orientations=orientations,
               pathlengths=pathlengths, gap=gap, offset=offset, margin=margin).finish()
        ...
        ax2 = fig.add_subplot(1, 2, 2, xticks=[], yticks=[],
                              title="Total Incoming PFOS: " + format(Total, '.2E') + " μg")
        Sankey(ax=ax2, flows=flows, labels=labels, orientations=orientations,
               pathlengths=pathlengths, gap=gap, offset=offset, margin=margin).finish()
