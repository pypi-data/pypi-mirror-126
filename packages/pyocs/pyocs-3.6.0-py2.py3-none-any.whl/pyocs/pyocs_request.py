...
class PyocsRequest:
    ...
    @pyocs_analysis.PyocsAnalysis.print_run_time
    def pyocs_request_post_json_with_headers(self, url, json, headers, allow_redirects=False):
        return requests.post(url, json=json, cookies=self._cookies, allow_redirects=allow_redirects, headers=headers)
